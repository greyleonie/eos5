...
<autoGraphics>
    <graphic name="menutext" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>Menu_next.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/internet/Menu_next.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">menutext</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Sat Nov 04 12:24:54 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="84" width="206" x="297" y="198" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-11-4 下午1:00</value>
                    </property>
                    <property name="text" type="0">
                        <value>description 得到指定的二级菜单&#13;
author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
