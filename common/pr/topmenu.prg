...
<autoGraphics>
    <graphic name="topmenu" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">topmenu</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Sat Nov 04 11:39:15 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/internet/Menu.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="68" width="213" x="104" y="178" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-11-4 上午11:39</value>
                    </property>
