...
<autoGraphics>
    <graphic name="orgselect" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">orgselect</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>orgselect</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 15 14:14:30 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>orgselect.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/common/page/orgselect/orgselect.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>orgSingleselect.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/common/page/orgselect/orgSingleselect.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="206" x="334" y="287" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-15 下午2:15</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 部门选择&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
