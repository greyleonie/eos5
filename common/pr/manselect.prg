...
<autoGraphics>
    <graphic name="manselect" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="416" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="206" x="657" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@description 人员选择，根据条件，进行单个选择，还是多个选择&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">common.biz.manselect</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
