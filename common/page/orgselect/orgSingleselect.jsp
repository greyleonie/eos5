...
function User(identify,id,name,dept,job,firstChar,workType,orgType,sex){
...
//标识，帐号，姓名，部门，岗位，首字母，教工类型，部部门类型，性别
	var userArray = new Array()
	 <logic:iterate id="resultset" property="list[@type='teacherorg']">
	   userArray[userArray.length] = new User('<bean:write id="resultset" property="EOSORG_T_Organization/orgID" />','<bean:write id="resultset" property="EOSORG_T_Organization/orgID" />','<bean:write id="resultset" property="EOSORG_T_Organization/orgName" />','-1','-1','-1','-1','<bean:write id="resultset" property="EOSORG_T_Organization/orgTypeID" />','-1');
	 </logic:iterate>
	  ...
	  <tr>
		<td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            ...
            <td height="30" align="center" class="text">单个部门选择 </td>
		  </tr>
				...
				<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
					...
					<tr class="td1" > 
					  <td height="25" align="center">
						...
						&nbsp;
						部门名搜索：<input type="text" name="search" style="width:150;" class="input" onkeyup="javascript:query();" oldValue="">
						</td>
					</tr>
					...
					<tr class="td1" >
                      ...
                      <tr align=center > 
                        <td> <fieldset>
                          <legend align="center" class="text_red">可选部门</legend>
                        ...
                        <td> <fieldset>
                          <legend align="center" class="text">已选部门</legend>
                          <div id="selContainer" > 
