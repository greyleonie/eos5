...
<autoGraphics>
    <graphic name="loginAndoutDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">loginAndoutDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>loginAndoutDelete</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 29 13:43:27 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.loginAndOutDelete</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/login/VO_fail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>loginAndOutReturn.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/login/loginAndOutReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="206" x="216" y="306" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-29 下午1:46</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 删除系统用户登录日志&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
