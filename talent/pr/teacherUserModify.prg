...
<autoGraphics>
    <graphic name="teacherUserModify" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherUserModify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherUserModify</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 23 17:41:46 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.teacherUserModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="206" x="486" y="253" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-23 下午5:50</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 进入教师修改页面&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
