...
<autoGraphics>
    <graphic name="deptSelectUsersToSave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptSelectUsersToSave</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptSelectUsersToSave</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 11 13:28:09 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.deptSelectUsersToSave</column>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">SysDeptUser</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.pr.deptlist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="206" x="522" y="397" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-11 下午1:31</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 部门选择人员保存，并更新Teacher表中&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
