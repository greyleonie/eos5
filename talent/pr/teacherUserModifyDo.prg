...
<autoGraphics>
    <graphic name="teacherUserModifyDo" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherUserModifyDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherUserModifyDo</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 24 09:40:08 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="856" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">TeacherTEMP/userID</column>
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">TEMP/userID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="4" typeName="setField" height="48" width="48" x="336" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="616" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>判断该帐号已存在</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.useronly</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">TEMP/userID</column>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="736" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/user/teacherUserModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="616" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>更新教师用户</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.teacherUserModifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">TeacherTEMP</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="736" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>失败页面</value>
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="496" y="416" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="10" typeName="removeEntity" height="48" width="48" x="616" y="416" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="736" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>教师返回页面</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/user/tearchUserReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="206" x="170" y="384" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-24 上午9:47</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 更新教师用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">userIDModify</column>
                            <column num="1" name="compType">EQ</column>
                            <column num="2" name="rightValue">yes</column>
                        </row>
                    </property>
                    <property name="expression" type="0">
                        <value/>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.10</from>
                <to>Shape.view.11</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
