...
<autoGraphics>
    <graphic name="teacherUserDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherUserDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherUserDelete</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 24 13:50:06 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.teacherUserDelete</column>
            ...
            <state color="16777215" id="5" typeName="removeEntity" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>返回教师列表页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="206" x="474" y="352" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-24 下午2:12</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 删除教师用户及相关连的数据&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
