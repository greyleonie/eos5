        ...
        <states>
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.userlist</column>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">sysTUser/fcc</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/user/userlist.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="220" x="182" y="257" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-26 上午11:04</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 查询系统用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
