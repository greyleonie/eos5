...
<autoGraphics>
    <graphic name="roleRightSave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">roleRightSave</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>roleRightSave</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 18 15:03:44 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.roleRightSave</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="206" x="145" y="196" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-18 下午3:06</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 保存角色权限&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
