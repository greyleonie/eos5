...
<autoGraphics>
    <graphic name="rolemodify" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">rolemodify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>rolemodify</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Dec 31 15:19:55 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.rolemodify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="removeEntity" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="199" x="345" y="250" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-5 下午4:31</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 角色修改&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
