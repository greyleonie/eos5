...
<autoGraphics>
    <graphic name="deptAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="736" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="14" typeName="setField" height="48" width="48" x="616" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">parentOrgID</column>
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">EOSORG_T_Organization/parentOrgID/criteria/value</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="936" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="496" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>判断确定部门名是否存在</value>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">EOSORG_T_Organization/orgName</column>
            ...
            <state color="16777215" id="15" typeName="setField" height="48" width="48" x="616" y="416" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="736" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>失败页面</value>
            ...
            <state color="16777215" id="13" typeName="removeEntity" height="48" width="48" x="376" y="136" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">EOSORG_T_Organization/parentOrgID/criteria</column>
                        </row>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="496" y="416" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">removeEntity</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据移除</value>
            ...
            <state color="16777215" id="12" typeName="setField" height="48" width="48" x="256" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="616" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>新增部门</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.deptAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptAddDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptAddDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 08 15:50:29 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="199" x="861" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-8 下午3:57</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 新增部门&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.13</from>
