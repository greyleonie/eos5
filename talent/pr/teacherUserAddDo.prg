...
<autoGraphics>
    <graphic name="teacherUserAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="576" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">Teacher/userID</column>
            ...
            <state color="16777215" id="10" typeName="Start" height="48" width="48" x="136" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="220" x="490" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-27 上午10:11</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 新增教师用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.teacherUserAddDO</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="376" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>教师返回列表页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
