...
<autoGraphics>
    <graphic name="complexUserModifyDo" type="prg" router="0">
        <states>
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="696" y="416" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="sub" height="48" width="48" x="496" y="656" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.pr.guestUserlist</column>
            ...
            <state color="16777215" id="10" typeName="sub" height="48" width="48" x="496" y="536" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>教师列表</value>
            ...
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="496" y="416" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>学生列表</value>
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="376" y="536" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="496" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="496" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>用户修改页面</value>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="376" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.complexUserModifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="256" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">complexUserModifyDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>complexUserModifyDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 17:09:25 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="213" x="614" y="150" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-27 下午5:30</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 更新学员、教师、宾客用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">sysTUser/isModifed</column>
