...
<autoGraphics>
    <graphic name="deptframe" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptframe</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptframe</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 08 09:52:31 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/department/deptframe.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="199" x="157" y="228" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-8 上午9:52</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 部门管理&#13;
&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
