...
<autoGraphics>
    <graphic name="userRightSave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">userRightSave</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>userRightSave</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 18 13:50:22 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="456" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="656" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="336" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">sysTUser/operatorType/criteria/value</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.userRightSave</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">usermark</column>
            ...
            <state color="16777215" id="4" typeName="setField" height="48" width="48" x="336" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="6" typeName="sub" height="48" width="48" x="456" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>学员列表</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.pr.studenUserlist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>教师列表</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.pr.teacherUserlist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="206" x="577" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-18 下午2:16</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 保存用户权限&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">mode</column>
                            <column num="1" name="compType">EQ</column>
