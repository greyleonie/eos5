...
<autoGraphics>
    <graphic name="complexUserModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>进入用户修改页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/user/complexUserModify.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.complexUserModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">complexUserModify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>complexUserModify</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 16:09:10 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="213" x="414" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-27 下午4:17</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 学员、教师、宾客用户修改&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
