...
<autoGraphics>
    <graphic name="deptToSelectManager" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptToSelectManager</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptToSelectManager</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 11 15:11:28 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/department/deptToSelectManager.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="417" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-11 下午3:12</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 为部门选择负责人&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
