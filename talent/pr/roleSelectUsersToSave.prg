...
<autoGraphics>
    <graphic name="roleSelectUsersToSave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">roleSelectUsersToSave</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>roleSelectUsersToSave</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Dec 31 13:53:52 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.roleSelectUsersToSave</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">SysRoleUser</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="213" x="356" y="276" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-31 下午2:39</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 保存角色用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
