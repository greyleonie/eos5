...
<autoGraphics>
    <graphic name="usermodifyDo" type="prg" router="0">
        <states>
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="456" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.pr.userlist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/isLocal</column>
                        </row>
                        <row num="2">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/cardID</column>
                        </row>
                        <row num="3">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/userTypeID</column>
                        </row>
                        <row num="4">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/userID</column>
                        </row>
                        <row num="5">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/status</column>
                        </row>
                        <row num="6">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/password</column>
                        </row>
                        <row num="7">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">sysTUser/operatorName</column>
                        </row>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.usermodifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">baseTUser</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">usermodifyDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>usermodifyDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 11:20:17 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="220" x="105" y="282" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-27 下午12:40</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 修改更新用户&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
