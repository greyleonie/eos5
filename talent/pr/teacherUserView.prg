...
<autoGraphics>
    <graphic name="teacherUserView" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherUserView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherUserView</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 24 11:22:32 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/user/teacherUserView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="213" x="654" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-24 上午11:23</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 查看单个教师信息&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
