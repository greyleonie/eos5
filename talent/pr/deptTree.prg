...
<autoGraphics>
    <graphic name="deptTree" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptTree</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptTree</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 08 09:55:07 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/powermanage/department/deptTree.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="199" x="421" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-8 上午9:55</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 部门树&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
