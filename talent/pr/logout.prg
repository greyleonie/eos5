...
<autoGraphics>
    <graphic name="logout" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">logout</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 29 13:52:04 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">http://www.gzswdx.gov.cn</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="417" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-29 下午1:52</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 退出系统&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.biz.logout</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
