...
<autoGraphics>
    <graphic name="eosMenuDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">eosMenuDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>eosMenuDelete</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jan 19 15:19:16 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="removeEntity" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="456" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="206" x="358" y="383" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 下午3:27</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 删除菜单及相应的操作&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
