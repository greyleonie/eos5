...
<autoGraphics>
    <graphic name="eosMenuOperatorList" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">eosMenuOperatorList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>eosMenuOperatorList</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 22 10:09:14 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>菜单操作列表页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/eosMenu/eosMenuOperatorList.jsp</column>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">SYSRESOPERATION/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="213" x="654" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-22 上午10:10</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 菜单操作列表管理&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuOperatorList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">SYSRESOPERATION</column>
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="176" y="56" lookAndFeel="classic">
