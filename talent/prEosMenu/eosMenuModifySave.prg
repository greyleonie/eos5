...
<autoGraphics>
    <graphic name="eosMenuModifySave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="48" y="117" lookAndFeel="classic">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="638" y="116" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="255" y="116" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuModifySave</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="485" y="287" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="255" y="289" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="355" y="288" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="206" x="497" y="424" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 上午9:41</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 修改并保存菜单资源&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="472" y="117" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>失败页面</value>
