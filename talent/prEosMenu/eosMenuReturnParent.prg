...
<autoGraphics>
    <graphic name="eosMenuReturnParent" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">eosMenuReturnParent</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>eosMenuReturnParent</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 22 14:25:37 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="removeEntity" height="48" width="48" x="176" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.prEosMenu.eosMenulist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="206" x="179" y="202" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-22 下午2:26</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 返回菜单资源管理&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
