...
<autoGraphics>
    <graphic name="eosMenuAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">eosMenuAddDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>eosMenuAddDo</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jan 19 10:56:58 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuOnly</column>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">TEOSMenuTEMP/menuID</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="496" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/eosMenu/eosMenuAdd.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="376" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">TEOSMenuTEMP</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="256" y="416" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="496" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/eosMenu/eosMenuReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="213" x="513" y="416" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 上午11:04</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 新增保存菜单资源&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
