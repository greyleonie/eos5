...
<autoGraphics>
    <graphic name="eosMenuOperatorDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="57" y="140" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="667" y="139" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="216" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="336" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="449" y="140" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="206" x="557" y="378" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@description 删除菜单资源相应的操作&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="259" y="141" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value> 删除菜单资源操作</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuOperatorDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="479" y="297" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>eosMenuOperatorReturn.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
