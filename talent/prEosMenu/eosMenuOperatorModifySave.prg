...
<autoGraphics>
    <graphic name="eosMenuOperatorModifySave" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="58" y="127" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="648" y="126" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="265" y="299" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="removeEntity" height="48" width="48" x="365" y="298" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="206" x="507" y="434" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@description 修改并保存菜单资源操作&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="482" y="127" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="266" y="126" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>修改保存菜单资源操作</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizEosMenu.eosMenuOperatorModifySave</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="486" y="297" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>菜单资源操作返回页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/eosMenu/eosMenuOperatorReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
