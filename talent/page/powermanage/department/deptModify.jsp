...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">系统管理—&gt;部门管理—&gt;部门修改</td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr> 
            ...
            <td width="35%" class="td1"><html:text property="EOSORG_T_OrganizationTEMP/orgName" maxlength="32" attributesText='class="input" size="30" ValidateType="notempty" Msg="部门名称不能为空"'/> 
          ...
          <tr> 
            ...
            <td class="td1"><html:text property="EOSORG_T_OrganizationTEMP/managerName" maxlength="9" attributesText='class="input" size="30" readOnly="fcc"'/>
			<html:hidden property="EOSORG_T_OrganizationTEMP/managerID"/><input name="Button" type="button" class="button_02" value="选 择" elname="EOSORG_T_OrganizationTEMP/managerID,EOSORG_T_OrganizationTEMP/managerName" onClick="selectManagerFromUser()">  
            </td>
            <td align="right" nowrap class="td2">副负责人：</td>
            <td class="td1"><html:text property="EOSORG_T_OrganizationTEMP/auxiliaryManagerName" maxlength="9" attributesText='class="input" size="30" readOnly="fcc"'/> 
			<html:hidden property="EOSORG_T_OrganizationTEMP/auxiliaryManagerID"/> <input name="Button" type="button" class="button_02" value="选 择" elname="EOSORG_T_OrganizationTEMP/auxiliaryManagerID,EOSORG_T_OrganizationTEMP/auxiliaryManagerName" onClick="selectManagerFromUser()">  
            </td>
          </tr>
          <tr> 
            <td align="right" nowrap class="td2">部门类别： </td>
            <td class="td1"> <html:select property="EOSORG_T_OrganizationTEMP/orgTypeID" > 
            ...
            <td class="td1"> <html:text property="EOSORG_T_OrganizationTEMP/orgCode" maxlength="12" attributesText='class="input" size="30"'/> 
            </td>
          </tr>
          <tr> 
            <td align="right" nowrap class="td2">是否教学情况统计： </td>
            <td colspan="3" class="td1"><html:radio property="EOSORG_T_OrganizationTEMP/Teaching" value="1" />是&nbsp;<html:radio property="EOSORG_T_OrganizationTEMP/Teaching" value="0"/>否 
              </td>
          </tr>
          <tr> 
            <td align="right" nowrap class="td2">是否工作量统计： </td>
            <td colspan="3" class="td1"><html:radio property="EOSORG_T_OrganizationTEMP/IsWork" value="1" />是&nbsp;<html:radio property="EOSORG_T_OrganizationTEMP/IsWork" value="0"/>否 
              </td>
          </tr>
          <tr> 
            <td height="22" align="right" nowrap class="td2">部门简介： </td>
            <td colspan="3" class="td1"> <html:textarea property="EOSORG_T_OrganizationTEMP/memo" attributesText='cols="70" rows="4"'/> 
            </td>
          </tr>
        </table>
