	...
	<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		<tr> 
		  ...
		  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
			  <tr> 
				<td width="15"> </td>
				<td class="text_wirte">系统管理—&gt;部门管理—&gt;部门用户分配</td>
			  </tr>
			</table></td>
		</tr>
		<tr>
		  <td height="5">
			...
			<html:hidden property="EOSORG_T_EmpOrgRef/orgID" />
			<html:hidden property="SysDeptUser/operatorIDs" />
			<html:hidden name="SysDeptUser/orgID" property="EOSORG_T_EmpOrgRef/orgID"/>
	...
	<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
	  <tr>
		<td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
				<td height="30" align="center" class="text"> 当前分配人员的部门是：<bean:write property="EOSORG_T_OrganizationTEMP/orgName"/>
...
var tempArray = [];
var deptManager = '<bean:write  property="EOSORG_T_OrganizationTEMP/managerID"/>'
var deptOtherManager = '<bean:write  property="EOSORG_T_OrganizationTEMP/auxiliaryManagerID"/>'
<logic:iterate id="result" property="list[@type='distributed']">
	tempArray[tempArray.length] = '<bean:write id="result" property="EOSORG_T_EmpOrgRef/operatorID" />'
</logic:iterate>

if(!isHasManager(deptManager,tempArray)) tempArray[tempArray.length] = deptManager;
if(!isHasManager(deptOtherManager,tempArray)) tempArray[tempArray.length] = deptOtherManager;
...
function isHasManager(tempId,tempIds) {
	var result = false;
	if(tempId=="") return true;
	for(var i = 0; i < tempIds.length; i++) {
		if(tempId == tempIds[i]) return true;
	}
	return result;
}
</script>
...
function save() {
	...
	if(validater(frm)) {
		...
		frm.elements["SysDeptUser/operatorIDs"].value = operatorIDs;
