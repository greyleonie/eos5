...
<script language="JavaScript">
	var userArray = new Array()
	 <logic:iterate id="resultset" property="list[@type='Student']">
	   userArray[userArray.length] = new User('<bean:write id="resultset" property="Student/userID" />','<bean:write id="resultset" property="Student/operatorID" />','<bean:write id="resultset" property="Student/operatorName" />','<bean:write id="resultset" property="Student/ClassID" />','-1','<bean:write id="resultset" property="Student/Firstchar" />');
	 </logic:iterate>
