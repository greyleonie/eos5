...
<body onload="initFcc()">
<form method="post" action="talent.pr.useraddDo.do">
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr> 
            ...
            <td class="td1"><html:password  property="sysTUser/password" maxlength="50" attributesText='class="input" size="30" ValidateType="notempty" Msg="密码不能为空"'/>
			<span class="text_red">*</span>
            </td>
            <td align="right" nowrap class="td2">确认密码：</td>
            <td class="td1"><html:text  property="sysTUser/password0" maxlength="50" attributesText='class="input" size="30" ValidateType="notempty" Msg="确认密码不能为空"'/> 
              <span class="text_red">*</span></td>
          </tr>
          <tr> 
            ...
            <td class="td1">
            <html:radio property="sysTUser/status" value="1" attributesText='checked'/>是&nbsp;<html:radio property="sysTUser/status" value="0"/>否
            </td>
          </tr>
          <tr> 
            ...
            <td class="td1"><dict:radio businTypeId="BNDICT_gender" property="baseTUser/gender" modifiable="true" value="1"/></td>
          </tr>
          <tr> 
