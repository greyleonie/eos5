...
<%
String test = request.getParameter("usermark");
 ...
 String rightlist = reqContext.getEntityValue("usermark"); 
...
<body>
<form method="post" action="talent.pr.userRightSave.do" >
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">系统管理—&gt;用户管理—&gt;<logic:equal property="mode" value="-1">EOS</logic:equal><logic:equal property="mode" value="0">学员</logic:equal><logic:equal property="mode" value="1">教师</logic:equal>用户分配权限—&gt;当前被分配权限用户为：<bean:write property="tempuserid" formatClass="username" formatType="userid"/></td>
          </tr>
        </table></td>
    </tr>
    <tr>
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
  <tr>
    <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="8">
		<input name="usermark" type="hidden" value="<%=test%>">
