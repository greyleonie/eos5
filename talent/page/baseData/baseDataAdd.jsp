...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">系统管理—&gt;基础数据管理—&gt;<bean:write property="BNDICT_T_Dictionary/baseName"/>新增</td>
          </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr> 
            ...
            <td width="77%" class="td1"><html:text property="BNDICT_T_DictionaryTEMP/businName" maxlength="32" attributesText='class="input" size="70" ValidateType="notempty" Msg="名称不能为空"'/> 
              <span class="text_red">*</span>
            </td>
          </tr>
          <tr> 
            <td width="23%" align="right" nowrap class="td2"><bean:write property="BNDICT_T_Dictionary/baseName"/>代码： </td>
            <td class="td1"><html:text property="BNDICT_T_DictionaryTEMP/businID" maxlength="8" attributesText='class="input" size="70" ValidateType="notempty" Msg="代码不能为空"'/>
			<span class="text_red">*</span>
            </td>
          </tr>
		  <tr> 
            <td width="23%" align="right" nowrap class="td2"><bean:write property="BNDICT_T_Dictionary/baseName"/>备注： </td>
            <td class="td1"><html:text property="BNDICT_T_DictionaryTEMP/remark" maxlength="32" attributesText='class="input" size="70" '/>
