...
<autoGraphics>
    <graphic name="baseDataDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="6" typeName="Start" height="48" width="48" x="56" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">roledelete</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Sat Dec 30 11:34:49 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="End" height="48" width="48" x="656" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="removeEntity" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="220" x="570" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-30 上午11:44</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 删除基础数据&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="456" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizBaseData.baseDataDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="13" typeName="sub" height="48" width="48" x="456" y="56" lookAndFeel="classic">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.9</from>
                <to>Shape.sub.13</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
