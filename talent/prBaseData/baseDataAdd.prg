...
<autoGraphics>
    <graphic name="baseDataAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">baseDataAdd</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>baseDataAdd</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 17 15:50:29 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="131" y="147" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-17 下午3:50</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 新增基础数据页面&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
