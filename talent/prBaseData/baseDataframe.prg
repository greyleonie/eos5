...
<autoGraphics>
    <graphic name="baseDataframe" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">baseDataframe</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>baseDataframe</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 17 11:06:01 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/baseData/baseDataframe.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="213" x="106" y="146" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-17 上午11:06</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 基础数据维护框架&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
