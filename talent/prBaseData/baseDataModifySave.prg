...
<autoGraphics>
    <graphic name="baseDataModifySave" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="57" y="71" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">baseDataModifySave</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>baseDataModifySave</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 17 16:49:18 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="631" y="128" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="207" y="70" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.bizBaseData.baseDataModifySave</column>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="value" type="0">BNDICT_T_Dictionary/businTypeID/criteria/value</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="207" y="216" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="340" y="217" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="206" x="577" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-17 下午4:53</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 修改保存基础数据&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="448" y="218" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>baseDatalist</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">talent.prBaseData.baseDatalist</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="440" y="71" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>VO_fail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/talent/page/baseData/VO_fail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.6</from>
                <to>Shape.sub.9</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
