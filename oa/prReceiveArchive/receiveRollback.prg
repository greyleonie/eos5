...
<autoGraphics>
    <graphic name="receiveRollback" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="sub" height="48" width="48" x="416" y="536" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prReceiveArchive.receiveList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="296" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizReceiveArchive.receiveRollbackprocess</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
