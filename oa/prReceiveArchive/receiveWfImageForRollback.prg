...
<autoGraphics>
    <graphic name="receiveWfImageForRollback" type="prg" router="0">
        <states>
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>receiveWfImageForRollback.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/receiveArchive/receiveWfImageForRollback.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">getWfImageForRollback</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>getWfImageForRollback</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 28 16:41:03 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="297" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-3-28 下午4:41</value>
                    </property>
