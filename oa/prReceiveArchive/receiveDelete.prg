...
<autoGraphics>
    <graphic name="receiveDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="Start" height="48" width="48" x="56" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="336" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="216" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="199" x="581" y="230" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizReceiveArchive.receiveDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>receiveReturn.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/receiveArchive/receiveReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/receiveArchive/VO_fail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
