...
<autoGraphics>
    <graphic name="receiveSpace" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">receiveSpace</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>receiveSpace</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 16 17:39:31 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>receiveSpace.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/receiveArchive/receiveSpace.jsp</column>
