...
<autoGraphics>
    <graphic name="sendAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="256" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>执行发文录入操作</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizSendArchive.sendAddDo</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="213" x="494" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-3-23 上午10:34</value>
                    </property>
            ...
            <state color="16777215" id="11" typeName="setField" height="48" width="48" x="256" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
