...
<autoGraphics>
    <graphic name="showWFImage" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">showWFImage</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>showWFImage</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Mar 20 17:30:05 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>showWFImage.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/wfcommon/showWFImage.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="103" y="236" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-3-20 下午5:32</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 显示流程的当前状态图，仅有图像页面&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
