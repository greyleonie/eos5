...
<autoGraphics>
    <graphic name="getWfImageForRollback" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>getWfImageForRollback.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/wfcommon/getWfImageForRollback.jsp</column>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>getRollBackType</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.biz.getRollBackType</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="206" x="457" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-3-28 下午4:41</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 流程图查看&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
