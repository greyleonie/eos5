...
<autoGraphics>
    <graphic name="getAllWorkItemByInstID" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">getAllWorkItemByInstID</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>getAllWorkItemByInstID</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 28 14:24:17 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.biz.getAllWorkItemByInstID</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>getAllWorkItemByInstID.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/wfcommon/getAllWorkItemByInstID.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="206" x="537" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-3-28 下午2:26</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 通过流程实例ID得到该所有活动项&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
