...
<autoGraphics>
    <graphic name="wfrollback" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="616" y="216" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="216" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="296" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>rollbackprocessbiz</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.biz.rollbackprocessbiz</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="296" y="416" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="206" x="537" y="350" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-3-28 下午5:56</value>
                    </property>
                    <property name="text" type="0">
                        <value>@description 执行回退&#13;
@author 冯长春</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="468" y="417" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
