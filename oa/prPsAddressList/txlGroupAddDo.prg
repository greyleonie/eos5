...
<autoGraphics>
    <graphic name="txlGroupAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPsAddressList.txlGroupAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">txlGroupAddDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>txlGroupAddDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 11 11:37:42 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="422" y="230" lookAndFeel="classic">
