        ...
        <states>
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>个人通讯录查看页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/AddressList/pubAddressLiseView.jsp</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPsAddressList.txlGroupView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
