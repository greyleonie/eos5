...
<autoGraphics>
    <graphic name="breakRuleDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizCarManage.breakRuleDelete</column>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="302" y="284" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-7-24 下午1:39</value>
                    </property>
