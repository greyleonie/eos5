...
<autoGraphics>
    <graphic name="outmailwrite" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">outmailwrite</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>outmailwrite</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Sep 20 12:47:45 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>发送外部邮件页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/EmailManager/faSongWeiBuYouJian.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="227" x="527" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午4:33</value>
                    </property>
