...
<autoGraphics>
    <graphic name="pr_ToUpdateCalendarArrange" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pr_ToUpdateCalendarArrange</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pr_ToUpdateCalendarArrange</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jul 20 09:56:31 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="539" y="162" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>日程安排修改页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/DayPlan/CalendarUpdate.jsp</column>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>获取修改日程安排实例</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.biz_ToUpdateCalendar</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>日程安排修改页面</value>
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="227" x="647" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午5:52</value>
                    </property>
