...
<autoGraphics>
    <graphic name="pr_ToViewCalendarArrange" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pr_ToViewCalandarArrange</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pr_ToViewCalandarArrange</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 18 10:28:47 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="setField" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">Schedule/ScheduleID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="227" x="767" y="190" lookAndFeel="classic">
