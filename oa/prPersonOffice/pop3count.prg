...
<autoGraphics>
    <graphic name="pop3count" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pop3count</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pop3count</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Sep 15 15:35:31 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.pop3Tocount</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
