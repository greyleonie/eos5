...
<autoGraphics>
    <graphic name="prDoInsertCalendar" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prDoInsertCalendar</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prDoInsertCalendar</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 18 17:01:24 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="22" typeName="view" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="227" x="567" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午6:24</value>
                    </property>
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.IsOut</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="21" typeName="sub" height="48" width="48" x="456" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prPersonOffice.pr_ToAddCalendarArrange</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
