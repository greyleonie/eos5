...
<autoGraphics>
    <graphic name="deleteFolder" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deleteFolder</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 04 14:14:58 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.deleteFolder</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="227" x="407" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-24 下午1:48</value>
                    </property>
