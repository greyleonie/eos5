...
<autoGraphics>
    <graphic name="readNote" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="416" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>refresh.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/Message/refresh.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="227" x="647" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午6:33</value>
                    </property>
