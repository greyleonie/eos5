...
<autoGraphics>
    <graphic name="addInnerNotePage" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>发送内部短信页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/Message/faSongDuanXiaoXi.jsp</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.getPubLemma</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jun 30 14:00:29 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="234" x="403" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-24 上午11:22</value>
                    </property>
