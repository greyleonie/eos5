...
<autoGraphics>
    <graphic name="mailPutOne" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailPutOne</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailPutOne</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Jul 10 13:06:58 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.mailPutOne</column>
