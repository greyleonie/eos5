...
<autoGraphics>
    <graphic name="pr_IsCalendar" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pr_IsCalendar</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pr_IsCalendar</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jul 19 17:04:44 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prPersonOffice.prQueryCalendarArrange</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">is</column>
                            <column num="1" name="compType">EQ</column>
