...
<autoGraphics>
    <graphic name="queryInnerNote" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">innerNote_all</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>innerNote_all</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jun 29 14:56:19 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/Message/queryPage.jsp</column>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="227" x="527" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午6:31</value>
                    </property>
