...
<autoGraphics>
    <graphic name="pop3deletetrue" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pop3deletetrue</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pop3deletetrue</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Sep 19 15:52:19 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="removeEntity" height="48" width="48" x="216" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>返回接收外部邮件页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prPersonOffice.pop3server</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="1" name="value" type="0">marked</column>
                        </row>
                        <row num="1">
                            <column num="0" name="paraType" type="1">appArea</column>
                            <column num="1" name="value" type="0">Order</column>
                        </row>
                        <row num="2">
                            <column num="0" name="paraType" type="1">appArea</column>
                            <column num="1" name="value" type="0">PageCond</column>
                        </row>
                    </property>
                </propertyList>
                <description/>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.pop3deletetrue</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="227" x="447" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午4:38</value>
                    </property>
