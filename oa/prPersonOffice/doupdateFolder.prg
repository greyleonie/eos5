...
<autoGraphics>
    <graphic name="doupdateFolder" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">doupdateFolder</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>doupdateFolder</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 04 18:03:39 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.isotherone</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="216" y="216" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>更新邮件夹</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.doupdateFolder</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="8" typeName="sub" height="48" width="48" x="336" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="227" x="447" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-24 下午2:23</value>
                    </property>
