...
<autoGraphics>
    <graphic name="mailtoDraftFW" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailtoDraftFW</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailtoDraftFW</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Jul 24 18:18:07 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="536" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.mailtoDraftFW</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="428" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.outmailToDraftFW</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="234" x="883" y="190" lookAndFeel="classic">
