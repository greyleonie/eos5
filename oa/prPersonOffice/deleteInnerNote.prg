...
<autoGraphics>
    <graphic name="deleteInnerNote" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deleteInnerNote</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deleteInnerNote</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jun 30 11:16:00 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.deleteInnerNote</column>
            ...
            <state color="16777215" id="10" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>返回内部短消息列表</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prPersonOffice.queryInnerNote</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">mark</column>
                        </row>
                        <row num="2">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="227" x="447" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-24 下午1:57</value>
                    </property>
