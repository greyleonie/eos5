...
<autoGraphics>
    <graphic name="mailMove" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailMove</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailMove</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jul 08 15:40:13 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.mailMove</column>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">field</column>
                            <column num="2" name="value" type="0">tofid</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="removeEntity" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">PageCond/begin</column>
                        </row>
                        <row num="1">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prPersonOffice.mailreceive</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="1" name="value" type="0">SessionEntity</column>
                        </row>
                        <row num="1">
                            <column num="0" name="paraType" type="1">appArea</column>
                            <column num="1" name="value" type="0">fid</column>
                        </row>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="227" x="447" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-7-24 下午4:39</value>
                    </property>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.4</from>
                <to>Shape.sub.5</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
