...
<autoGraphics>
    <graphic name="mailToFW" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailToFW</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailToFW</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jul 22 11:25:01 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="896" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.mailToFW</column>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="456" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>获取邮箱参数</value>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="696" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/EmailManager/mailFW.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="336" y="216" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>获取用户的邮件服务器设置</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="696" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>转发外部邮件</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/EmailManager/outmailFW.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="11" typeName="setField" height="48" width="48" x="576" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="227" x="807" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午3:51</value>
                    </property>
