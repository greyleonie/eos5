...
<autoGraphics>
    <graphic name="mailPutAll" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailPutAll</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailPutAll</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Jul 10 09:16:06 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.mailPutAll</column>
