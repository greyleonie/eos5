...
<autoGraphics>
    <graphic name="mailwrite" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mailwrite</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mailwrite</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 11 10:29:08 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/guoRenBanGong/EmailManager/faSongNeiBuYouJian.jsp</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="227" x="407" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-25 下午4:26</value>
                    </property>
