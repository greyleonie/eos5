...
<autoGraphics>
    <graphic name="uploadfileoutDR" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">uploadfileoutDR</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>uploadfileoutDR</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Sep 21 17:58:17 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="1056" y="216" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="936" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="816" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>取得接收人长度</value>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="936" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>成功页面</value>
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="576" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="696" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>删除附件</value>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="816" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>发送外部邮件</value>
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="816" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>删除原草稿箱邮件</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
            ...
            <state color="16777215" id="14" typeName="useCase" height="48" width="48" x="576" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPersonOffice.outmailtoPostFolderFW</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="696" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>获取附件路径</value>
