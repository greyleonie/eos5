        ...
        <states>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/infoAdd.jsp</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="132" y="180" lookAndFeel="classic">
