...
<autoGraphics>
    <graphic name="officeFundManage" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="197" x="422" y="190" lookAndFeel="classic">
            ...
            <state color="16777215" id="17" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.officeFundModify</column>
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/officeFundManage.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
