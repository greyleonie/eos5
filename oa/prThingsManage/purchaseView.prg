...
<autoGraphics>
    <graphic name="purchaseView" type="prg" router="0">
        <states>
            <state color="16777215" id="10" typeName="End" height="48" width="48" x="496" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">receiveView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>receiveView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Mar 29 10:51:09 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="291" y="152" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/purchaseView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
