...
<autoGraphics>
    <graphic name="checkAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.checkAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">checksSaveDatabase</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>checksSaveDatabase</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Nov 10 13:53:56 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="197" x="462" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	07-4-28 上午9:35</value>
                    </property>
                    <property name="text" type="0">
                        <value>用品盘点新增完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="20" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prThingsManage.checkManage</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
