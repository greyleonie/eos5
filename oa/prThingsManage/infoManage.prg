...
<autoGraphics>
    <graphic name="infoManage" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="203" x="220" y="177" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/infoManage.jsp</column>
