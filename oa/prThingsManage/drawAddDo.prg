...
<autoGraphics>
    <graphic name="drawAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="17" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prThingsManage.drawList</column>
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="656" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="setField" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.drawAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">COMM_DRAW</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
            ...
            <state color="16777215" id="19" typeName="setField" height="48" width="48" x="336" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="18" typeName="useCase" height="48" width="48" x="216" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>重复插入</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.drawCheck</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">COMM_DRAW/DRAWCODE</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="96" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">yprkSaveDatabase</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>yprkSaveDatabase</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Oct 14 14:39:24 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="203" x="579" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	07-4-27 上午11:17</value>
                    </property>
                    <property name="text" type="0">
                        <value>增加用品出库完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
