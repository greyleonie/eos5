...
<autoGraphics>
    <graphic name="storeInDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.storeInDelete</column>
            ...
            <state color="16777215" id="5" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">deptDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>deptDelete</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 08 17:23:30 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="462" y="230" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="23" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="21" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="2">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">删除成功</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="3">
                            <column num="0" name="passing" type="1">out</column>
