...
<autoGraphics>
    <graphic name="officeFundBalanceDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="29" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prThingsManage.officeFundManage</column>
            ...
            <state color="16777215" id="28" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="31" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="33" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.officeFundBalanceDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="32" typeName="annotate" height="100" width="191" x="465" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	07-7-3 下午2:41</value>
                    </property>
                    <property name="text" type="0">
                        <value>对办公经费进行修改保存</value>
                    </property>
                </propertyList>
                <description/>
            </state>
