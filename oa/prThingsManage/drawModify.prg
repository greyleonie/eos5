...
<autoGraphics>
    <graphic name="drawModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="203" x="413" y="178" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.drawModify</column>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/drawModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
