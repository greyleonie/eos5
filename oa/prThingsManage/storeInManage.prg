...
<autoGraphics>
    <graphic name="storeInManage" type="prg" router="0">
        <states>
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/storeInManage.jsp</column>
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.selectPurchase</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
