...
<autoGraphics>
    <graphic name="saveAgent" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">saveAgent</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>saveAgent</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Apr 19 10:26:23 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="178" x="671" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-19 上午10:26</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAgent.saveAgent</column>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="value" type="0">WFAgent</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/wfAgent/refreshPage.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置 -1</value>
            ...
            <state color="16777215" id="8" typeName="removeEntity" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">WFAgent/_order</column>
                        </row>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
