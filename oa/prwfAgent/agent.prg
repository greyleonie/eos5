...
<autoGraphics>
    <graphic name="agent" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">agent</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Wed Apr 18 14:57:33 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAgent.agentList</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="172" x="434" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-18 下午3:29</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>agent.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/wfAgent/agent.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
