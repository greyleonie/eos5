...
<autoGraphics>
    <graphic name="leftFrame" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/myDesk/leftFrame.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">leftFrame</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 04 11:05:21 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="398" y="323" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-7-18 下午5:44</value>
                    </property>
                    <property name="text" type="0">
                        <value>联接后的左边页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
