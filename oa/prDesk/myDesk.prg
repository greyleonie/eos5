...
<autoGraphics>
    <graphic name="myDesk" type="prg" router="0">
        <states>
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>myDesk.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/myDesk/myDesk.jsp</column>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="376" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">myDesk</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 04 09:56:39 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="197" x="302" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-7-18 下午5:49</value>
                    </property>
                    <property name="text" type="0">
                        <value>桌面功能实现及显示</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="15" typeName="setField" height="48" width="48" x="160" y="199" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">just do it wst</column>
