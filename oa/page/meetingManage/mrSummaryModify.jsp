    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;会议管理—&gt;会议纪要修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
          ...
          <table width="100%" height="30"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <br>
                ...
                <input name="Submit2" type="button" class="button_02" value="返 回" onClick="location.href='oa.prMeetingManage.mrSummaryList.do'">
              </td>
            </tr>
        </table></td>
    </tr>
