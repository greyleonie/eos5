...
<form method="post" enctype="multipart/form-data" action="oa.prAssetsManage.prAssetsImportDo.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;资产管理—&gt;资产导入</td>
          </tr>
      </table></td>
    </tr>
  </table>
