...
<form method="post" enctype="multipart/form-data" action="oa.prMeetingManage.meetingRoomAddDO.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;会议管理—&gt;会议室新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="35%" class="td1">&nbsp;<html:text property="MR_REGISTER/MRNAME" attributesText='class="input" size="30" ValidateType="notempty" Msg="名称不能为空"'/>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td colspan="3" class="td1">&nbsp;<html:text property="EMCEE_NAME"  readonly="readonly" attributesText='class="input" size="30" ' />
            	<html:hidden property="MR_REGISTER/ManagerID"  attributesText=' ValidateType="notempty" Msg="请选择管理员"' />
      
              <input type="button" name="receiver" class="button_02"  value="选择" elname="MR_REGISTER/ManagerID,EMCEE_NAME" onClick="selectSysUser('yes')">
			  <span class="text_red">*</span>
            </td>
          </tr>
          <!--郑灿丹修改
