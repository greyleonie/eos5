...
document.getElementById('organizer').value='<bean:write property="entity/operatorname"/>';
document.getElementById("MR_APPLY/APPLYDATE[@pattern='yyyy-MM-dd']").value='<bean:write property="MR_APPLY/APPLYDATE"/>';
document.getElementById("MR_APPLY/STARTDATE[@pattern='yyyy-MM-dd HH:mm']").value='<bean:write property="MR_APPLY/STARTDATE"/>';
document.getElementById("MR_APPLY/ENDDATE[@pattern='yyyy-MM-dd HH:mm']").value='<bean:write property="MR_APPLY/ENDDATE"/>';
</script>