...
<form method="post" enctype="multipart/form-data" action="oa.prResearchFunds.officeFundsShenheDo.do">		
	  ...
	  <td class="text">    
	    <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <script>
           ...
           yinshuafei += '<bean:write id="resultset" property="KetiBz/laowufei"/>'* 1.0; 
           jiandingfei += '<bean:write id="resultset" property="KetiBz/qitafei"/>'* 1.0; 
          </script>
          <tr>
        ...
        <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr>
            ...
            <td width="21%"  class="td_title">&nbsp;金额(元)</td>
            <td width="21%"  class="td_title">&nbsp;预算(元)</td>
			<td width="21%"  class="td_title">&nbsp;合计(元)</td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;管理费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/guanlifei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/guanlifei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="guanlifei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;资料费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/ziliaofei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/ziliaofei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="ziliaofei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;调研差旅费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/chailvfei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/chailvfei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="chailvfei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;小型会议费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/huiyifei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/huiyifei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="huiyifei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;计算机及其辅助设备购置和使用费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/shiyongfei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/shiyongfei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="shiyongfei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;咨询费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/zixunfei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/zixunfei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="zixunfei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;印刷费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/yinshuafei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/yinshuafei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="yinshuafei"></span></td>
          </tr>
		  <tr>
          	<td width="33%"  class="td2">&nbsp;成果鉴定费</td>
            <td width="21%"  class="td1">&nbsp;<html:text property="KetiBz/jiandingfei" maxlength="10" attributesText='class="input" size="15"' readonly="true"/></td>
            <td width="21%"  class="td1">&nbsp;<bean:write property="KetiLx/jiandingfei"/></td>
			<td width="21%"  class="td1">&nbsp;<span id="jiandingfei"></span></td>
          </tr>
		  <tr>
        ...
        <logic:equal property="KetiBz/cwcbaoxiao" value="2">
        <br>
        <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
		  <tr>
          	<td width="17%"  class="td2" align="right">财务处意见&nbsp;</td>
            <td width="83%"  class="td1">
			  &nbsp;<bean:write property="KetiBz/cwcbaoxiaoyj"/>
            </td>
          </tr>
        </table>
        </logic:equal>
        ...
        <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr>
          	<td width="17%"  class="td2" align="right">科研处审核&nbsp;</td>
            <td width="83%"  class="td1">
              &nbsp;<input type="radio" name="KetiBz/kycshenhe" id="kycshenhe1" value="1" checked onclick ="setDisplayYijian('yijian','kycshenhe1')"/>审核通过,进入财务处报销
            &nbsp;<input type="radio" name="KetiBz/kycshenhe" id="kycshenhe2" value="2"  onclick ="setDisplayYijian('yijian','kycshenhe2')"/>审核不通过，返回科研组重新报帐</td>
          </tr>
		  <tr id='yijian' style="display:none">
          	<td width="17%"  class="td2" align="right">科研处审核意见&nbsp;</td>
            <td width="83%"  class="td1">
			  &nbsp;&nbsp;<textarea name="KetiBz/kycshenheyj" cols="80" rows="4"></textarea>
            </td>
          </tr>
        </table>
  ...
  document.getElementById("laowufei").innerHTML=yinshuafei + '<bean:write property="KetiBz/laowufei"/>'* 1.0;
  document.getElementById("qitafei").innerHTML=jiandingfei + '<bean:write property="KetiBz/qitafei"/>'* 1.0;
