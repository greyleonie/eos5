    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;科研管理—&gt;科研组经费管理</td>
          </tr>
      </table></td>
    </tr>
  </table>
	...
	<tr>
	  <td class="text">    
	    <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
		  ...
		  <tr>
            <td width="17%"  class="room1" align="center"><html:text name="KetiBz/shiyongriqi" property="curDate" attributesText='class="input" size="15"' readonly="true"/>
            ...
            <td width="17%"  class="td1" align="center"><input type="text" name="KetiBz/jine" maxlength="10" class="input" size="15" 
            onblur="getcount(this,'heji')"
			...
			<td width="17%"  class="room1" align="center"><input type="text" name="KetiBz/baozhangren" value='<bean:write property="SessionEntity/userID" formatClass="username" formatType="userid"/>' class="input" size="15" readonly="true"/></td>
