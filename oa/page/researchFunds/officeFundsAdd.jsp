...
<form method="post" enctype="multipart/form-data" action="oa.prResearchFunds.officeFundsAddDo.do">		
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;科研管理—&gt;科研处经费管理—&gt;立项登记</td>
          </tr>
      </table></td>
    </tr>
  </table>
	  ...
	  <td class="text">    
	    <table width="96%" align="center"  border="0"  cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr> 
            ...
            <html:select property="KetiLx/ketiSbID" style="width:190px">
              <html:option value="-1">------请选择申报课题------</html:option> <html:options property="list[@type='SbKetiList']/KetiSb/KetiSbID" labelProperty="list[@type='SbKetiList']/KetiSb/KetiName"/> 
              </html:select>
		  ...
		  <tr>
            ...
            <td width="17%" class="td1" align="center">
            <input type="text" name="KetiLx/jine1" maxlength="10" class="input" size="15" value="0"  
            onkeypress="var   k=event.keyCode;   return   (k>=48&&k<=57||k==46)"   
            onkeyup="return   value=value.replace(/^(\d+\.\d{1,2})(.*)?$/,'$1')"   
            onpaste="return   !clipboardData.getData('text').match(/\D/)"   
            ondragenter="return   false"  style="ime-mode:Disabled" />
            ...
            <td width="17%" class="td1" align="center">
            <input type="text" name="KetiLx/jine2" maxlength="10" class="input" size="15" value="0" 
            onkeypress="var   k=event.keyCode;   return   (k>=48&&k<=57||k==46)"   
            onkeyup="return   value=value.replace(/^(\d+\.\d{1,2})(.*)?$/,'$1')"   
            onpaste="return   !clipboardData.getData('text').match(/\D/)"   
            ondragenter="return   false"  style="ime-mode:Disabled" />
            ...
            <td width="17%" class="td1" align="center">
            <input type="text" name="KetiLx/jine3" maxlength="10" class="input" size="15" value="0"  
            onkeypress="var   k=event.keyCode;   return   (k>=48&&k<=57||k==46)"   
            onkeyup="return   value=value.replace(/^(\d+\.\d{1,2})(.*)?$/,'$1')"   
            onpaste="return   !clipboardData.getData('text').match(/\D/)"   
            ondragenter="return   false"  style="ime-mode:Disabled" />
		  ...
		  <tr>
			...
			<td width="17%"  class="td1" align="center">&nbsp;</td>
			<td width="17%"  class="td1">&nbsp;</td>
          </tr>
  ...
  function checks() {
			...
			var ok = true;
			var frm = document.forms[0];
			if(frm.elements["KetiLx/ketiSbID"].options[frm.elements["KetiLx/ketiSbID"].selectedIndex].value == "") {
				msg += "--课题名称不能为空！\n";
				ok = false;
			}
