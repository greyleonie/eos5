...
<body>
<form method="post" action="oa.prWatch.sendArchiveList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;流程监控—&gt;发文管理</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prWatch.sendArchiveList.do">
      ...
      <tr>
		...
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="SendArchive/sendID"/>','true')">  
                ...
                <td nowrap title=<bean:write id="resultset" property="SendArchive/archiveTitle"/>>&nbsp;<bean:write id="resultset" property="SendArchive/archiveTitle" maxLength="20" maxLengthString="..."/></td>
                <td nowrap>&nbsp;
                ...
                <td nowrap>&nbsp;
                <logic:present id="resultset"  property="SendArchive/currentState">
                <logic:notEqual id="resultset"  property="SendArchive/currentState" value="">
                <a href="javascript:toWfSupervise('<bean:write id="resultset" property="SendArchive/workItemID"/>','<bean:write id="resultset" property="SendArchive/participant"/>')">督办</a>
				</logic:notEqual>
                </logic:present>
				...
				<logic:present id="resultset"  property="SendArchive/activityDefID">
				    <logic:equal id="resultset"  property="SendArchive/activityDefID" value="EndActivity">
				    <%
				   try{
				     String isEnd= base.util.TalentContext.getValue(pageContext,"resultset","SendArchive/isEnd");				   
				 if(isEnd==null)isEnd="";
				 if(!isEnd.equals("1")){
				    %>
				      <a href="javascript:guiDang('<bean:write id="resultset" property="SendArchive/sendID"/>','<bean:write id="resultset" property="SendArchive/RecordID"/>')">归档</a>
				   <%
...
function guiDang(archiveId,RecordID){
	if(confirm("确实要归档吗？")==true){
	 var loc="oa.prWatch.gd.do?RecordID="+RecordID+"&fid="+archiveId+"&userId="+document.forms[0].elements["SessionEntity/operatorID"].value+"&EmpowerIDs=&gdType=1";
