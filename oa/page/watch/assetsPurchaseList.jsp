...
<body>
<form method="post" action="oa.prWatch.assetsPurchaseList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;流程监控—&gt;<span id="printTable">资产采购申请</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prWatch.assetsPurchaseList.do">
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  <td width="3%" align="center" > <input type="checkbox" name="checkbox" value="checkbox" onClick="eosCheckAll(document.forms[0],this)" marked="">                  </td>
               	  <td width="10%" align="center" nowrap id="CAPT_PURCHASEVIEW.PURCHASECODE" onClick="talentsort()">申请单编号</td>
                  ...
                  <td width="20%" align="center" nowrap id="CAPT_PURCHASEVIEW.ZCNC" onClick="talentsort()">用品名称</td>
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="CAPT_PURCHASEVIEW/PURCHASEID"/>','true')">  
				...
				<td nowrap title="<bean:write id="resultset" property="CAPT_PURCHASEVIEW/ZCNC"/>">&nbsp;<bean:write id="resultset" property="CAPT_PURCHASEVIEW/ZCNC" maxLength="10"/></td>
                
                <td nowrap align="center">
				<fcc:toname dom="resultset" path="CAPT_PURCHASEVIEW/participant"/>				</td>
                <td nowrap align="center"><bean:write id="resultset" property="CAPT_PURCHASEVIEW/workItemName"/></td>
                <td nowrap>&nbsp;
                <logic:present id="resultset"  property="CAPT_PURCHASEVIEW/currentState">
               <logic:notEqual id="resultset"  property="CAPT_PURCHASEVIEW/currentState" value="">
                <a href="javascript:toWfSupervise('<bean:write id="resultset" property="CAPT_PURCHASEVIEW/workItemID"/>','<bean:write id="resultset" property="CAPT_PURCHASEVIEW/participant"/>')">督办</a>
				</logic:notEqual>
                </logic:present>
				<a href="#" onmousedown="getWfLog('<bean:write id="resultset" property="CAPT_PURCHASEVIEW/processInstID"/>','<bean:write id="resultset" property="CAPT_PURCHASEVIEW/archiveTitle"/>')">流程日志</a>				</td>
              </tr>
                </logic:iterate> 
              </table>
