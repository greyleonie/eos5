...
<%
	...
	boolean duban = RP.parse("DX_OASYS_WATCH_TRAVEL.DX_OASYS_WATCH_TRAVEL_DB",session) ;
 
 %>
<body>
<form method="post" action="oa.prWatch.travelCostClaimList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;流程监控—&gt;差旅费报销</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prWatch.travelCostClaimList.do">
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	  	<td class="text">
              	...
              	<qx:talentButton property="delete" type="button" styleClass="button_02" value="删 除" onclick="talentdelete()" operation="DX_OASYS_WATCH_TRAVEL.DX_OASYS_WATCH_TRAVEL_DEL" />
      ...
      <tr>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="TravelCostClaim/RequestID"/>','true')">  
                ...
                <td nowrap>&nbsp;
                <%if(duban){ %>
				<logic:present id="resultset"  property="TravelCostClaim/currentState">
               <logic:notEqual id="resultset"  property="TravelCostClaim/currentState" value="">
                <a href="javascript:toWfSupervise('<bean:write id="resultset" property="TravelCostClaim/workItemID"/>','<bean:write id="resultset" property="TravelCostClaim/participant"/>')">督办</a>
				</logic:notEqual>
                </logic:present>
                <%} %>
                <a href="#" onmousedown="getWfLog('<bean:write id="resultset" property="TravelCostClaim/processInstID"/>','差旅费报销')">流程日志</a>				</td>
              </tr>
                </logic:iterate> 
              </table>
