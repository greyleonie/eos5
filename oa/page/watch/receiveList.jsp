  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;流程监控—&gt;收文管理</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      ...
      <tr>
		...
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  ...
                  <td width="18%" align="center" nowrap id="ReceiveArchive.operatorName" onClick="talentsort()">标题</td>
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="ReceiveArchive/receiveID"/>','true')">  
                ...
                <a href="javascript:toWfSupervise('<bean:write id="resultset" property="ReceiveArchive/workItemID"/>','<bean:write id="resultset" property="ReceiveArchive/participant"/>')">督办</a>
				</logic:notEqual>
                </logic:present>
				...
				<logic:present id="resultset"  property="ReceiveArchive/activityDefID">
				 ...
				 if(!isEnd.equals("1")){
				    %>
				      <a href="javascript:guiDang('<bean:write id="resultset" property="ReceiveArchive/receiveID"/>')">归档</a>
				   <%
