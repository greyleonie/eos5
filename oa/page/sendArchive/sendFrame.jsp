...
<frameset cols="170,6,*" frameborder="NO" border="0" framespacing="0" name="contentFrameSet">
  <frame src="oa.prSendArchive.sendMenu.do" name="leftFrame" scrolling="NO" noresize>
  <frame src="oa.prSendArchive.sendSpace.do" name="spaceFrame" scrolling="NO" noresize>
