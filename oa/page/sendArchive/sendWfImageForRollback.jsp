...
<body>
<form method="post" action="oa.prSendArchive.sendRollback.do">
  ...
  <tr>
    ...
    <table height="100%" width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
		...
		<iframe src='oa.pr.showWFImage.do?Flow/processInstID=<bean:write property="WFWorkItem/processInstID"/>' height="100%" width="100%" frameborder="0" id="graphID"></iframe>
		 </td>
      </tr>
      
      <tr>
          <td height="10%" align="center" valign="bottom" class="text">
