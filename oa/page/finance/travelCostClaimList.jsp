  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;财务管理—&gt;差旅费报销—&gt;<logic:equal property="temptype" value="0">所有差旅费报销</logic:equal><logic:equal property="temptype" value="1">待办差旅费报销</logic:equal><logic:equal property="temptype" value="2">已办差旅费报销</logic:equal></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      ...
      <tr>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  ...
                  <td width="14%" align="center"  id="TravelCostClaim.UserID" onClick="talentsort()">报销人</td>
                  <td width="13%" align="center"  id="TravelCostClaim.ClaimDate" onClick="talentsort()">时间</td>
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="TravelCostClaim/RequestID"/>','true')">  
                ...
                <SCRIPT>
                	...
                	if(tmp==1)
                		document.write("<a  href='javascript:doProcess(\"<bean:write id="resultset" property="TravelCostClaim/actionURL"/>\",<bean:write id="resultset" property="TravelCostClaim/RequestID"/>,<bean:write id="resultset" property="TravelCostClaim/workItemID"/>,<bean:write id="resultset" property="TravelCostClaim/processInstID"/>,<bean:write id="resultset" property="TravelCostClaim/currentState"/>,\"<bean:write id="resultset" property="TravelCostClaim/WFparticipant"/>\",\"<fcc:toname dom="resultset" path="TravelCostClaim/WFparticipant"/>\")'  ><SPAN class=\"linkOA\">办理</SPAN></a>");
                </SCRIPT>
                
				<fcc:wfoperator pageDom="resultset" pagePath="TravelCostClaim/participantExt">
									</fcc:wfoperator>
				<a href="#" onmousedown="getWfImage('<bean:write id="resultset" property="TravelCostClaim/processInstID"/>','差旅费报销','TravelCostClaim')">流程监控</a>
				<a href="javascript:getWfLog('<bean:write id="resultset" property="TravelCostClaim/processInstID"/>','差旅费报销')">流程日志</a>				</td>
              </tr>
                </logic:iterate> 
              </table>
