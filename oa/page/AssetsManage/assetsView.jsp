...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
 			<td class="text_wirte">首页—&gt;办公系统—&gt;资产管理—&gt;<span id="printTable">资产入库</span>查看</td>
          </tr>
        </table></td>
    </tr>
    <tr>
        ...
        <td valign="top" class="text" >
		     <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC"  id="listdetail">
              ...
              <bean:write   property="CAPT_CAPITALINFO/HQDATE" formatClass="com.primeton.eos.webtag.bean.BeanWriteDateFormatImpl" formatType="yyyy-MM-dd"/>
                  ...
                  <td  nowrap="nowrap"   class="td1" >
            <bean:write   property="CAPT_CAPITALINFO/QLDATE" /> 年
          ...
          <table width="98%" height="30"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td align="center"><input name="ieprint" type="button" class="button_02" value="打 印" onClick="iePrint()">
               ...
               <input name="Button" type="button" class="button_02" value="返 回" onClick="window.location.href='oa.prAssetsManage.assetsList.do'">
               </td>
            </tr>
 </table>
    	  </td>
