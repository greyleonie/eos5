...
<body>
<form method="post" action="oa.prAssetsManage.vindicatorModifyDo.do">
<html:hidden property="CAPT_VINDICATOR/VINDCODE"/>
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
 			<td class="text_wirte">首页—&gt;办公系统—&gt;资产管理—&gt;<span id="printTable">售后服务商信息修改</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
