 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;资产管理—&gt;<span id="printTable">资产使用新增</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
	    ...
	    <html:hidden property="pd" value="1"/>
	  </td>
    </tr>
  </table>
          ...
          <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
                ...
                <tr > 
				 ...
				 <script language="JavaScript" type="text/JavaScript">	 	
                  ...
                  <html:text property="CAPT_BORROW/BORROWDATE[@pattern='yyyy-MM-dd']" value="<%=curdate%>" attributesText='class="input" size="12" ValidateType="notempty" Msg="借用日期不能为空"' readonly="true"/>
     ...
     <tr class="td2"> 
                  ...
                  <td  class="td1"><textarea name="CAPT_BORROW/REMARK" rows="3" cols="80"></textarea> 
                  </td>
...
function insertDetail() {
	...
	function removeRowFromTable(objTable, rowId) {
		...
		if (confirm("确定删除该记录吗")==true){ objTable.outerHTML = beforeHTML + latterHTML;}
	}
