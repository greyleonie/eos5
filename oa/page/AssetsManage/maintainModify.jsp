...
<body>
<form method="post" action="oa.prAssetsManage.maintainModifyDo.do">
 ...
 <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;资产管理—&gt;<span id="printTable">资产维修修改</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		...
		<html:hidden name="CAPT_MAINTAIN/MAINTAINID" property="CAPT_MAINTAINVIEW/MAINTAINID" />
                ...
                <tr > 
                  ...
                  <td class="td1" width="30%"> 
                   <richclient:selectText textId="text2" buttonId="bt2"  nameField="VINDNAME" filterField="VINDNAME" >
				       ...
				       <input type='text' name="CAPT_MAINTAIN/VINDNAME"  value='<bean:write  property="CAPT_MAINTAINVIEW/VINDNAME"/>'   id="text2"  size="38" class="input"  />
				       
				       &nbsp;<input class="button_02" type="button" id="bt2" value="选择"/>
				</richclient:selectText>
				<html:hidden name="CAPT_MAINTAIN/VINDCODE"  property="CAPT_MAINTAINVIEW/VINDCODE"/>
                  
                  </td>
                  <td align="right" class="td2" width="10%">维修人：</td>
                  <td class="td1" width="10%"><html:text name="CAPT_MAINTAIN/MAINTAINER" property="CAPT_MAINTAINVIEW/MAINTAINER" attributesText='size="20" class="input"'/>
                  </td>
				 <td width="10%" align="right" class="td2">维修日期：</td>
                  <td width="10%" class="td1" >
                  <html:text   name="CAPT_MAINTAIN/MAINTAINDATE[@pattern='yyyy-MM-dd']"   property="CAPT_MAINTAINVIEW/MAINTAINDATE"  attributesText='class="input" size="12" ValidateType="notempty" Msg="维修日期不能为空"' readonly="true"/>
				  ...
				  <td width="10%" align="right" class="td2">归还日期：</td>
                  <td width="10%" class="td1" >
                  <html:text   name="CAPT_MAINTAIN/RETURNDATE[@pattern='yyyy-MM-dd']"   property="CAPT_MAINTAINVIEW/RETURNDATE"  attributesText='class="input" size="12"' readonly="true"/>
            ...
            <td>
              <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CBCBCB" id="listdetail">
                ...
                <logic:iterate id="resultset" property="list[@type=CAPT_MAINTAINDETAILVIEW']"> 
                	...
                	<html:hidden name="listOld/CAPT_MAINTAINDETAIL/DETAILID" id="resultset" property="CAPT_MAINTAINDETAILVIEW/DETAILID" indexed="true"/>
               		<html:hidden name="listOld/CAPT_MAINTAINDETAIL/CAPTID" id="resultset" property="CAPT_MAINTAINDETAILVIEW/CAPTID" indexed="true"/>
               ...
               <tr class="td1" onClick="changeTRBgColor(this)" id="row_<%=count %>">
                <td nowrap><input type="text" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/CAPTNAME" value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/CAPTNAME'/>" style="width:100%"  readonly="readonly"  class="inputOA" />
               				<input type="hidden" id="goodID" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/CAPTID"  value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/CaptID'/>"   />
               				<input type="hidden" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/GOODNAME"  value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/GOODNAME'/>"   />
               				</td> 
                <td nowrap> <input type="text" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/CAPTCODE"  value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/CAPTCODE'/>"  style="width:100%" readonly="readonly" class="inputOA" /></td>
                <td nowrap><input type="text" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/SPECIA"  value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/SPECIA' />" style="width:100%"  readonly="readonly" class="inputOA"/></td>
                <td nowrap><input type="text" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/PRICE"  value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/PRICE'/>"  style="width:100%" class="inputOA"/></td>
                <td nowrap> <input type="text" name="listInsert/CAPT_MAINTAINDETAIL[@hciTagIndex='<%=count%>']/REMARK" value="<bean:write id="resultset" property='CAPT_MAINTAINDETAILVIEW/REMARK'/>"   maxlength="50" style="width:100%" class="inputOA"/></td>
		     ...
		     <tr class="td2"> 
		                  ...
		                  <td  class="td1">
		                  <html:textarea name="CAPT_MAINTAIN/REMARK" property="CAPT_MAINTAINVIEW/REMARK" attributesText='class="input" cols="80" rows="3"'/>  
		                  </td>
