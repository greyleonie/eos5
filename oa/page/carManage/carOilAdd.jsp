...
<form method="post" enctype="multipart/form-data" action="oa.prCarManage.carOilAddDO.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;车辆用油记录新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1">&nbsp;<html:text property="CAR_OIL/OPERATOR"  styleClass="input"  size="30"  maxlength="20" readonly="true"/>
