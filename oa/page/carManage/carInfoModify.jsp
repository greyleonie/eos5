...
<form method="post" enctype="multipart/form-data" action="oa.prCarManage.carInfoModifyDO.do">
  <html:hidden property="CAR_CARINFO/CarID"/> 
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;车辆修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="34%" class="td1">&nbsp;<html:text property="CAR_CARINFO/CARNO" attributesText='class="input" size="30" ValidateType="notempty" Msg="车牌号不能为空"' maxlength="20"/></td>
            <td width="16%" align="right" class="td2">厂牌型号：</td>
            <td width="34%" class="td1">&nbsp;<html:text property="CAR_CARINFO/MANUNO" attributesText='class="input" size="30" ValidateType="notempty" Msg="厂牌型号不能为空"' maxlength="20"/></td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1">&nbsp;<html:text property="CAR_CARINFO/PRICE" attributesText='class="input" size="30"  ValidateType="isNumeric" Msg="价格必须为数字"'/> 元(人民币)</td>
