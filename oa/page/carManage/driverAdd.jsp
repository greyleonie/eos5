...
<form method="post" enctype="multipart/form-data" action="oa.prCarManage.driverAddDO.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;司机新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="80%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="70%" class="td1">&nbsp;<html:text property="DriverInfo/DriverName" attributesText='class="input" size="30" ValidateType="notempty" Msg="姓名不能为空"'/>
