...
<form method="post" enctype="multipart/form-data" action="oa.prCarManage.motModifyDO.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;车辆保险年检修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
      ...
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
			...
			&nbsp;<html:text property="MOT/Charger"  styleClass="input"  size="30"  maxlength="20"/>
              ...
              <input name="Submit2232" elname="MOT/ChargerID,MOT/Charger" type="button" class="button_02" value="选择" onclick="selectSysUser('yes')">			</td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
