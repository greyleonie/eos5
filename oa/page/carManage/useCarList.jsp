  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;车辆管理—&gt;用车申请—&gt;<logic:equal property="temptype" value="0">所有用车申请</logic:equal><logic:equal property="temptype" value="1">待办用车申请</logic:equal><logic:equal property="temptype" value="2">已办用车申请</logic:equal></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prCarManage.useCarList.do">
		<input type="hidden" name="addaction" value="oa.prCarManage.useCarAdd.do">
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	  	<td class="text">
				<qx:talentButton property="add" type="button" styleClass="button_02" value="新 增" onclick="talentadd()" operation="DX_OASYS_CARD_USE.DX_OASYS_CARD_USE_ADD" />
				<qx:talentButton property="delete" type="button" styleClass="button_02" value="删 除" onclick="talentdelete()" operation="DX_OASYS_CARD_USE.DX_OASYS_CARD_USE_DEL" />
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="UseCarRequest/RequestID"/>','true')">  
                ...
                <SCRIPT>
                	...
                	if(tmp==1)
                		document.write("<a  href='javascript:doProcess(\"<bean:write id="resultset" property="UseCarRequest/actionURL"/>\",<bean:write id="resultset" property="UseCarRequest/RequestID"/>,<bean:write id="resultset" property="UseCarRequest/workItemID"/>,<bean:write id="resultset" property="UseCarRequest/processInstID"/>,<bean:write id="resultset" property="UseCarRequest/currentState"/>,\"<bean:write id="resultset" property="UseCarRequest/WFparticipant"/>\",\"<fcc:toname dom="resultset" path="UseCarRequest/WFparticipant"/>\")'  ><SPAN class=\"linkOA\">办理</SPAN></a>");
                </SCRIPT>
                
                
                
				<fcc:wfoperator pageDom="resultset" pagePath="UseCarRequest/participantExt">
									</fcc:wfoperator>
				<a href="#" onmousedown="getWfImage('<bean:write id="resultset" property="UseCarRequest/processInstID"/>','用车申请','UseCarRequest')">流程监控</a>
				<a href="#" onmousedown="getWfLog('<bean:write id="resultset" property="UseCarRequest/processInstID"/>','用车申请')">流程日志</a>				</td>
              </tr>
                </logic:iterate> 
              </table>
