  ...
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;车辆年检记录 </td>
          </tr>
        </table></td>
    </tr>
    <tr>
...
<qx:talentButton property="add" type="button" styleClass="button_02" value="新 增" onclick="talentadd()" operation="DX_OASYS_CARD_MOT.DX_OASYS_CARD_MOT_ADD" />
<qx:talentButton property="modify" type="button" styleClass="button_02" value="修 改" onclick="talentmodify()" operation="DX_OASYS_CARD_MOT.DX_OASYS_CARD_MOT_MODIFY" />
<qx:talentButton property="delete" type="button" styleClass="button_02" value="删 除" onclick="talentdelete()" operation="DX_OASYS_CARD_MOT.DX_OASYS_CARD_MOT_DEL" />
      ...
      <tr>
        <td valign="top" class="text"><table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
          <tr class="td_title">
            ...
            <td width="20%" align="center" nowrap id="MOT.CarNO" onClick="talentsort()">车牌号</td>
            <td width="20%" align="center" nowrap id="MOT.Charger" onClick="talentsort()">责任人</td>
            <td width="20%" align="center" nowrap id="MOT.MOTType" onClick="talentsort()">保险年检类型</td>
            <td width="20%" align="center" nowrap id="MOT.MOTTime" onClick="talentsort()">保险年检时间</td>
            <td width="16%" align="center" nowrap id="MOT.Cost" onClick="talentsort()">费用</td>
          </tr>
          <%
		             int count=0;
