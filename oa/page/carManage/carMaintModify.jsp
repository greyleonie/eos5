...
<form method="post" enctype="multipart/form-data" action="oa.prCarManage.carMaintModifyDO.do">
  <html:hidden property="CarMaint/MaintID"/> 
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;车辆管理—&gt;车辆维修(护)记录修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
			...
			&nbsp;<html:text property="CarMaint/Charger"  styleClass="input"  size="30"  maxlength="20"/>
              ...
              <input name="Submit2232" elname="CarMaint/ChargerID,CarMaint/Charger" type="button" class="button_02" value="选择" onclick="selectSysUser('yes')">			</td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
	...
	　　　　			<html:option value="洗车">洗车</html:option>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1">&nbsp;<html:text property="CarMaint/MaintCost" attributesText='class="input" size="30"  ValidateType="isNumeric" Msg="费用必须为数字"' maxlength="20"/>
              </td>
          </tr>
