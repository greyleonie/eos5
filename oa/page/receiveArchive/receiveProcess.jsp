...
tabbox1.add("basedata","基础数据",0,"document.getElementById('tail').style.display = 'inline'");
tabbox1.add("attachment","正 文",1,"document.getElementById('tail').style.display = 'none';exFullImgZoom();");
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;收文管理—&gt;收文流程</td>
          </tr>
        </table></td>
    </tr>
    <tr>
	...
	<tr>
		<td height="100%" valign="top" nowrap bgcolor="#FFFFFF" style="border:1px #000000 solid;border-top:none">
			...
			<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="basedata">
			  <tr> 
				...
				&nbsp;<html:text property="ReceiveArchive/archiveUnit" styleClass="inputOA" maxlength="25" attributesText='style="width:96%;" ValidateType="notempty" Msg="来文单位不能为空"' onmousedown="menuControl('archiveUnits',1)" onmouseout="menuControl('archiveUnits',0)"/> 
				</logic:equal>
				...
				&nbsp;<html:text property="ReceiveArchive/archiveNum" styleClass="inputOA" attributesText='style="width:86%;" ValidateType="notempty,int" Msg="份数为空;份数必须是整型"'/> 
				</logic:equal>
			  ...
			  <tr> 
				...
				<logic:equal property="WFWorkItem/activityDefID" value="DX1">
				&nbsp;<html:text property="ReceiveArchive/archiveCode" styleClass="inputOA" maxlength="25" attributesText='width:96%;" ValidateType="notempty" Msg="办文编号不能为空"' onmousedown="menuControl('prefixs',1)" onmouseout="menuControl('prefixs',0)"/> 
				</logic:equal>
				<logic:notEqual property="WFWorkItem/activityDefID" value="DX1">
				...
				<td nowrap class="td1">
				<logic:equal property="WFWorkItem/activityDefID" value="DX1">
				&nbsp;<html:text property="ReceiveArchive/chenPiMan" styleClass="inputOA" maxlength="25" attributesText='style="width:88%;" ValidateType="notempty" Msg="呈批人不能为空"'/> 
				</logic:equal>
				<logic:notEqual property="WFWorkItem/activityDefID" value="DX1">
			  ...
			  <tr> 
				...
				<logic:equal property="WFWorkItem/activityDefID" value="DX1">
				&nbsp;<html:text property="ReceiveArchive/archiveTitle" styleClass="inputOA" maxlength="200" attributesText='ValidateType="notempty" Msg="文件标题不能为空"' />
				</logic:equal>
				<logic:notEqual property="WFWorkItem/activityDefID" value="DX1">
      ...
      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" id="participant">
        ...
        <logic:iterate id="resultset" property="list[@type='nextnodes']">
		  ...
		  <input name="select" type="button" class="button_02" value="选 择" onClick="selectParticipantById('<bean:write id="resultset" property="Activity/actDefID"/>','<bean:write property="WFWorkItem/processInstID"/>','<bean:write property="WFWorkItem/processDefID"/>','10000','pn<%=z %>','p<%=z %>')">
		  </td>
        </tr>
        <%z++; %>
		</logic:iterate>
		...
		<tr id="trDisplay"> 
		  ...
		  <html:hidden property="ReceiveArchive/nextParticipantId"/>
		  <input name="select" type="button" class="button_02" value="选 择" style="display:none;" onClick="selectParticipant('<bean:write property="WFWorkItem/processInstID"/>','<bean:write property="WFWorkItem/processDefID"/>','10000','ReceiveArchive/nextParticipantName','ReceiveArchive/nextParticipantId')">
		  <%} %>
		  </td>
        </tr>
      </table>
			  ...
			  <tr valign="top"> 
                ...
                <logic:equal property="WFWorkItem/activityDefID" value="DX6">
                	<script>
                		document.getElementById('wfsend').value='结束流程';
                	</script>
                </logic:equal>
				  <%
			...
			<!------------------------------  编辑正文  ----------------------------->
			  ...
			  <logic:equal property="WFWorkItem/activityDefID" value="DX1">
				...
				<div style="height:600px;overflow:auto"><img id="fullImage" src="/internet/image/smy.gif" style="cursor:hand;" title="单击可放大！" onclick="viewAllImg(this)" ></div>
				</td>
...
function viewAllImg(img) {
   ...
   var html = "<body><img id='fullImage' title='单击关闭窗口！' src='/internet/image/smy.gif' border='0' onClick='window.close();'></body>";
