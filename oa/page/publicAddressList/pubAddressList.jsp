...
<body>
<form method="post" action="oa.prPubAddressList.pubAddressList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;公共事务—&gt;公共通讯录</td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prPubAddressList.pubAddressList.do">
		<input type="hidden" name="addaction" value="oa.prPubAddressList.pubAddressListAdd.do">
		<input type="hidden" name="modifyaction" value="oa.prPubAddressList.pubAddressListModify.do">
		<input type="hidden" name="deleteaction" value="oa.prPubAddressList.pubAddressListDelete.do">
		<input type="hidden" name="viewaction" value="oa.prPubAddressList.pubAddressListView.do">
		<input type="hidden" name="groupaction" value="oa.prPubAddressList.txlGroupList.do">
  ...
  <tr>
    <td><table width="99%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <html:hidden property="AddressList/SearchGroup" value=""/>
       &nbsp;<input name="B3" type="button" class="button_02" value="部门管理" onClick="groupManage()">
      </td>
	  </tr>
      <tr>
        <td height="8"> </td>
	  ...
	  <tr>
	  	<td class="text">
			...
			<qx:talentButton property="add_button" type="button" styleClass="button_02" value="新增"  onclick="talentadd()"    operation="DX_OASYS_AFFAIR_PUBADDRESSLIST.DX_OASYS_AFFAIR_PUBADDRESSLIST_Add"/>
			<qx:talentButton property="rew_button" type="button" styleClass="button_02" value="修改"  onclick="talentmodify()" operation="DX_OASYS_AFFAIR_PUBADDRESSLIST.DX_OASYS_AFFAIR_PUBADDRESSLIST_rew"/>
			<qx:talentButton property="sel_button" type="button" styleClass="button_02" value="删除"  onclick="talentdelete()" operation="DX_OASYS_AFFAIR_PUBADDRESSLIST.DX_OASYS_AFFAIR_PUBADDRESSLIST_del"/>
