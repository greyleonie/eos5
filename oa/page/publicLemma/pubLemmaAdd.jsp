...
<form method="post" enctype="multipart/form-data" action="oa.prPubLemma.pubLemmaAddDo.do">	
<html:hidden property="PubLemma/CYYTYPE" value="0"/>
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;公文管理—&gt;公用词条新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
