...
<body>
<form method="post" action="oa.prPubLemma.pubLemmaList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;公文管理—&gt;公用词条</td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="oa.prPubLemma.pubLemmaList.do">
		<input type="hidden" name="addaction" value="oa.prPubLemma.pubLemmaAdd.do">
		<input type="hidden" name="modifyaction" value="oa.prPubLemma.pubLemmaModify.do">
		<input type="hidden" name="deleteaction" value="oa.prPubLemma.pubLemmaDelete.do">
		<input type="hidden" name="viewaction" value="oa.prPubLemma.pubLemmaView.do">
