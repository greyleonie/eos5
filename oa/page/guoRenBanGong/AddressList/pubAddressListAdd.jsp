...
<form method="post" enctype="multipart/form-data" action="oa.prPsAddressList.pubAddressListAddDo.do">		
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;个人办公—&gt;个人通讯录—&gt;个人通讯录新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
		  ...
		  <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="36%" class="td1">&nbsp;
            <html:text property="AddressList/COMPANY" maxlength="50" attributesText='class="input" size="30"'/>
            </td>
            <td width="14%" align="right" class="td2">单位地址：</td>
            <td width="36%" class="td1">&nbsp;
            <html:text property="AddressList/ADDRESS" maxlength="50" attributesText='class="input" size="30"'/>
            </td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td width="14%" align="right" class="td2">部门：</td>
            <td width="36%" class="td1">&nbsp;
            <html:text property="AddressList/Department" maxlength="20" attributesText='class="input" size="30"'/>
            </td>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="36%" class="td1">&nbsp;
            <html:text property="AddressList/POST_CODE" maxlength="6" attributesText='class="input" size="30" ValidateType="postalcode" Msg="邮编不正确"'/>
            </td>
            <td width="14%" align="right" class="td2">电子邮箱：</td>
            <td width="36%" class="td1">&nbsp;
            <html:text property="AddressList/E_MAIL" maxlength="20" attributesText='class="input" size="30" ValidateType="email" Msg="E-mail不正确"'/>
            </td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
