...
%>
<body>
<form name="form1" action="oa.prPersonOffice.uploadfiletest.do" method="post" enctype="multipart/form-data">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td height="24" background="/internet/image/lz_bg.gif"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15" height="12"></td>
        <td class="text_wirte">首页—&gt;办公系统—&gt;个人办公—&gt;发送内邮</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
  ...
  <tr align="left">
    <td align="center" colspan="2"><iframe height="350" width="100%" name="planinfo" id="textid" src="/internet/scripts/noticeRte.htm"></iframe></td>
  </tr>
</table>
...
function selectMailMan(type){
	...
	var height = 510;
	if(type==0||type==null){
		url = "oa.prPersonOffice.manselect.do?fccargs=" + fccargs;
	}else if(type==1){
		url = "oa.prPersonOffice.outmanselect.do?fccargs=" + fccargs;
	}
	var name = btn.elname;
...
function sendmail(){
	...
	if(frm.elements["TOOL_Mail/RECEIVEADDRESS"].value==""){
		alert("收件人不能为空");
		return;
