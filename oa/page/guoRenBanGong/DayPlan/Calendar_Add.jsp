 ...
 <input type="hidden" name="USERID" value="<%=request.getParameter("USERID")%>"/>
  ...
  <tr>
    <td>
          ...
          <table width="46%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CBCBCB">
            <tr>
              <td width="10%" align="right" class="td1" nowrap>日 &nbsp; &nbsp;期：</td>
			...
			<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["date"],"yyyy-MM-dd")> 
              ...
              <td align="right" class="td1">是否提醒：</td>
              <td class="td2">&nbsp;
                <input id="Schedule/ISREMIND" name="Schedule/ISREMIND" type="checkbox" class="" checked="true">
                </td>
            </tr>
            <tr>  
            <td width="15%" align="right" class="td1" nowrap>开始时间：</td>
              ...
              <td class="td2">&nbsp;
               <html:text id="Schedule/AWOKETIME[@pattern='yyyy-MM-dd HH:mm:ss']" property="Schedule/AWOKETIME[@pattern='yyyy-MM-dd HH:mm:ss']" value="<%=request.getParameter("date")+" 09:00:00"%>" attributesText='class="input" size="15"' readonly="true"/>
            ...
            <tr>
              ...
              <td class="td2">&nbsp;
                <input name="Schedule/TASKSUM" type="text" class="" maxlength="60" isNeed>*
                </td>
            ...
            <td class="td2"></td>
              ...
              <td colspan="3" class="td2">&nbsp;
                <html:textarea  name="Schedule/TASKCONTENT" attributesText='isneed="true" msg="事务详细不能为空" cols="70" rows="7" size="40"'/>

                </td>
            </tr>
            <tr>
            <td align="right" class="td1">是否外出：</td>
            <td class="td2">&nbsp;
            <input id="Schedule/IsOut" name="Schedule/IsOut" type="checkbox" onclick="getOut()" value="0"></td>
            <td align="right" class="td1"><span id="endDateTitle"></span></td>
            <td class="td2"><span id="endDate"></span>
              </td>
            </tr>
            <tr id="IsWt" style="display:none"><td align="right" class="td1">是否委托：</td><td class="td2">&nbsp; <input id="Schedule/IsWt" name="Schedule/IsWt" type="button" value="委 托" class="button_02" onclick="WeiTuo()">&nbsp;
            <a href="javascript:WeituoView()">(查看委托)</a></td><td align="right" class="td1"></td><td class="td2"></td></tr>
   ...
   var oper='<%=oper%>';
	...
	function getOut(){
		if(document.all("Schedule/IsOut").checked){
			...
			document.getElementById("endDateTitle").innerHTML = "外出结束时间：";
			document.getElementById("endDate").innerHTML = '&nbsp; <html:text property="Schedule/endDate[@pattern='yyyy-MM-dd']"  readonly="true" attributesText='class="input" size="15"' /> <img src="image/date.gif" width="13" height="20" align="absmiddle" onClick="selDate()"> <span class="text_red">*</span>';
			document.getElementById("IsWt").style.display = '';
		}
		else {
			document.all("Schedule/IsOut").value="0";
			document.getElementById("endDateTitle").innerHTML = "";
