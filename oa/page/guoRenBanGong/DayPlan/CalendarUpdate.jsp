    ...
    <td>
          ...
          <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CBCBCB">
            <tr>
              ...
              <td width="5%" align="right" class="td1" nowrap>开始时间</td>
           ...
           <tr>
            <td align="right" class="td1" >事务概要</td>
              <td class="td2"  colspan="3">
               <html:text property="Schedule/TASKSUM" maxlength="60"size="37.5"/>
                </td>
           </tr>
            <tr>
              <td align="right" class="td1">事务详细</td>
              <td class="td2"  colspan="3"  >
               <textarea name="Schedule/TASKCONTENT"  cols="37" rows="4" size="40"><bean:write property="Schedule/TASKCONTENT" /></textarea> 
                </td>
            </tr>
           <tr>
      ...
      <table width="47%" height="20"  border="0" align="center" cellpadding="0" cellspacing="0" class="text">
        <tr>
          <td align="center">   
