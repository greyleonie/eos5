 ...
 //.......................................
   ...
   function next(){
    ...
    function prepareInsert(obj,id){
    	...
    	%>
    	document.all.calendarFrame.src="oa.prPersonOffice.pr_ToAddCalendarArrange.do?date=<%if(date==null)out.print(date1);else out.print(date);%>&year=<%=year1 %>&month=<%=month1 %>&USERID=<%=USERID %>&rightUsers=<%=rightUsers %>";
    	}
    	else if(obj=="xg"){
