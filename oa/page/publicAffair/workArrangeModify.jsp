...
<form method="post" enctype="multipart/form-data" action="oa.prAffair.workArrangeModifyDo.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;公共事务—&gt;工作安排—&gt;分派工作安排—&gt;工作安排修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="86%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
		  ...
		  <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="87%" class="td1">&nbsp;
            <html:text name="WorkArrange/CALENDAR[@pattern='yyyy-MM-dd']" property="WorkArrange/CALENDAR" attributesText='class="input" size="30"'/>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="87%" class="td1">&nbsp;
            <html:radio property="WorkArrange/ISREMIND" value='Y' onclick="setDisplay()"/>是&nbsp;
            <html:radio property="WorkArrange/ISREMIND" value='N' onclick="setDisplay()"/>否
            </td>
          </tr>
          <tr  onClick="changeTRBgColor(this)" id="time">
            <td width="13%" align="right" height="30" class="td2">提醒时间：</td>
            <td width="87%" class="td1">&nbsp;
            <html:text name="WorkArrange/AWOKETIME[@pattern='yyyy-MM-dd']" property="WorkArrange/AWOKETIME" attributesText='class="input" size="30"'/>
