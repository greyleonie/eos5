...
<form method="post" enctype="multipart/form-data" action="oa.prAffair.noticeAddDo.do">
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;办公系统—&gt;公共事务—&gt;公告通知—&gt;新增通知公告</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="90%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="87%" class="td1">&nbsp;
			<html:text property="Notice/ValidTime[@pattern='yyyy-MM-dd']" attributesText='class="input" size="30" ValidateType="notempty" Msg="生效时间不能为空"'/>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="87%" class="td1">&nbsp;
            <html:text property="Notice/InValidTime[@pattern='yyyy-MM-dd']" attributesText='class="input" size="30" ValidateType="notempty" Msg="终止时间不能为空"'/>
