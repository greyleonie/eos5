...
<body>
<form method="post" action="oa.prThingsManage.infoModifyDo.do" name="opeForm">
...
<!--
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
 			<td class="text_wirte">首页—&gt;办公系统—&gt;用品管理—&gt;<span id="printTable">用品信息修改</span></td>
          </tr>
        </table></td>
    </tr>
    ...
    <tr>
      <td height="5">
		...
		<html:hidden property="COMM_COMMODITYINFO/COMMID" />
	  </td>
    </tr>
  </table>
        ...
        <td valign="top" class="text" >
		  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
            ...
            <tr>
                ...
                <td class="td1" ><html:text property="COMM_COMMODITYINFO/PRICE" maxlength="100"  attributesText="size='10' class='input' ValidateType='money' Msg='价格应为数字'"/>元&nbsp; </td>
                <td align="right" class="td2">是否有效：</td>              
                <td class="td1" ><html:radio property="COMM_COMMODITYINFO/ENABLE" value="1"/>是 
                <html:radio property="COMM_COMMODITYINFO/ENABLE" value="0"/>否</td>
            </tr>
            <tr class="td2">
