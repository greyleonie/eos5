...
<body>
<form method="post" action="oa.prThingsManage.storeInModifyDo.do">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
 			<td class="text_wirte">首页—&gt;办公系统—&gt;用品管理—&gt;<span id="printTable">用品入库修改</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
	  ...
	  <tr>
            ...
            <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1"  bgcolor="#A2C4DC">
                <tr> 
                  ...
                  <td  width="30%" class="td1"><bean:write  property="COMM_STOREIN/operatorName"/></td>
                </tr>
              </table>
      ...
      <tr>
		...
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  ...
                  <td width="5%" align="center" nowrap id="COMM_COMMODITYINFO.UNIT" onClick="talentsort()">单位</td>
                ...
                <logic:iterate id="resultset" property="list[@type=COMM_STOREINDETAILVIEW']"> 
                	...
                	<html:hidden name="listOld/COMM_STOREINDETAIL/DETAILID" id="resultset" property="COMM_STOREINDETAILVIEW/DETAILID" indexed="true"/>
               		<html:hidden name="listOld/COMM_STOREINDETAIL/COMMID" id="resultset" property="COMM_STOREINDETAILVIEW/COMMID" indexed="true"/>
               		<html:hidden name="listOld/COMM_STOREINDETAIL/QUANTITY" id="resultset"  property="COMM_STOREINDETAILVIEW/QUANTITY" indexed="true"/>
                <%
               ...
               <tr class="td1" onClick="changeTRBgColor(this)" id="row_<%=count %>">  
                <td nowrap><input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/COMMNAME" value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/COMMNAME'/>"   style="width:100%"  readonly="readonly"  class="inputOA" />
               				<input type="hidden" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/COMMID"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/COMMID'/>"   /></td> 
                <td nowrap><input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/SPECIA"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/SPECIA' />" style="width:100%"  readonly="readonly" class="inputOA"/></td>
                <td nowrap><input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/PRICE"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/PRICE'/>"  style="width:100%" class="inputOA"/></td>
                <td nowrap> <input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/QUANTITY"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/QUANTITY'/>" style="width:100%" class="inputOA"  onkeyup="sumFee(<%=count %>)"/></td>
                <td nowrap> <input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/UNIINAME"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/UNITNAME'/>"  style="width:100%" readonly="readonly" class="inputOA" /></td>
                <td nowrap> <input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/AMOUNT"  value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/AMOUNT'/>"style="width:100%"  readonly="readonly" class="inputOA"/></td>
                <td nowrap> <input type="text" name="listInsert/COMM_STOREINDETAIL[@hciTagIndex='<%=count%>']/REMARK" value="<bean:write id="resultset" property='COMM_STOREINDETAILVIEW/REMARK'/>"   maxlength="50" style="width:100%" class="inputOA"/></td>
