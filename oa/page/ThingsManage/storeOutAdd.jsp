...
<form method="post" action="oa.prThingsManage.storeOutAddDo.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" background="/internet/image/lz_bg.gif"> <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">办公系统—&gt;用品领用管理—&gt;<span id="printTable">领用申请新增</span></td>
          </tr>
        </table></td>
    </tr>
    <tr> 
      <td height="5"> <html:hidden  property="COMM_STOREOUT/_order/col1/field"/> 
        <html:hidden  property="COMM_STOREOUT/_order/col1/asc" /> <html:hidden property="PageCond/begin"/> 
        <html:hidden property="PageCond/count"/> <html:hidden property="PageCond/length" /> 
        <html:hidden property="temptype" /> <html:hidden property="WFWorkItem/submitType" /> 
        <html:hidden property="WFWorkItem/workItemID" /> <html:hidden property="WFWorkItem/processInstID" /> 
        <html:hidden property="WFWorkItem/processDefID" /> <html:hidden property="WFWorkItem/processDefName" /> 
        <html:hidden property="WFWorkItem/activityDefID" /> <html:hidden property="WFWorkItem/activityInstID" /> 
        <html:hidden property="selectedGoodId" /> <html:hidden  property="COMM_STOREOUT/FLAG" value="0" /> 
        <!--传递给选择用品层的参数-->
        <html:hidden property="detailName"/> <html:hidden property="index"/> <html:hidden property="goodIDs" /> 
      </td>
    </tr>
  </table>
  <table width="98%" height="10"  border="0" cellpadding="0" cellspacing="0" class="table">
      <tr>
      <td height="8"></td>
      </tr>
        <tr>
...
<!------------------------------  表单意见  ----------------------------->
          <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
                <tr> 
                  ...
                  <td width="15%" class="td1">&nbsp;<bean:write property="COMM_STOREOUT/STOREOUTCODE"/> 
                  <html:hidden property="COMM_STOREOUT/STOREOUTCODE"/> </td>
                  <td width="10%" align="right" class="td2">申请日期：</td>
                  <td width="15%" class="td1">&nbsp;<%=curdate%> <input type="hidden" name="COMM_STOREOUT/PURCHASEDATE[@pattern='yyyy-MM-dd']" value="<%=curdate%>"></td>
                  <td width="10%" align="right" class="td2">申请部门：</td>
                  <td width="15%" class="td1">&nbsp; <bean:write property="SessionEntity/orgName"/><html:hidden name="COMM_STOREOUT/BRANCH" property="SessionEntity/orgID"/> </td>
                  ...
                  <html:hidden name="COMM_STOREOUT/PROPOSER"  property="SessionEntity/operatorID" /> 
                  </td>
                </tr>
            </table>
              ...
              <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" id="sum">
				...
				<td align="right" class="td1">合计：<input name="TotalAccount" onchange="" size="8"  value="0"  class="input" readonly="readonly"/>元</td>
				</tr>
		      </table>  
