...
<form method="post" enctype="multipart/form-data" action="oa.prResearchManage.rsMemberAddDo.do">
<html:hidden name="Group/CourseType" property="coursetype"/>
<html:hidden property="Group/ProjectID"/>
<html:hidden name="Group/ProjectType" value="1"/>
<html:hidden name="Group/MemberType"/>
...
<html:hidden name="Group/WordNum"/>
	...
	<TBODY>
		<TR>
			<TD align="middle">
			<logic:equal property="isLocal" value="1">
			<SPAN class="label" id="KeTi1_Label20" style="FONT-WEIGHT: bold; FONT-SIZE: small">请填写本单位作者信息</SPAN>&nbsp;
			</logic:equal>
			<logic:equal property="isLocal" value="0">
			<SPAN class="label" id="KeTi1_Label20" style="FONT-WEIGHT: bold; FONT-SIZE: small">请填写外单位作者信息</SPAN>&nbsp;
			</logic:equal>
			</TD>
		</TR>
		<TR>
		...
		<TR>
			<TD vAlign="center">
				<TABLE width="98%" cellPadding="0" border="0" cellSpacing="0">
					<TBODY>
						<TR>
							<TD width="40%"><FONT color="blue">*</FONT>
							<SPAN class="label_smaller" id="KeTi1_Label21" style="FONT-WEIGHT: bold; WIDTH: 52px; HEIGHT: 14px">姓名：</SPAN> 
							<html:text property="Group/memberName" maxlength="100" attributesText='size="10" ValidateType="notempty" Msg="姓名不能为空"'/>
							...
							<TD width="60%" align="right" style="FONT-WEIGHT: bold;">
<TABLE class="small" style="FONT-SIZE: smaller; WIDTH: 95%; BORDER-TOP-STYLE: dotted; BORDER-RIGHT-STYLE: dotted; BORDER-LEFT-STYLE: dotted; HEIGHT: 30px; BORDER-BOTTOM-STYLE: dotted" border="0" id="KeTi1_Roles_Ben_Radiobuttonlist">
									<TBODY>
										<TR>
											<TD align="center">
											<html:radio property="Group/AuthorNo" value="1"/>第一作者
											<html:radio property="Group/AuthorNo" value="2"/>第二作者
											<html:radio property="Group/AuthorNo" value="3"/>第三作者
											<html:radio property="Group/AuthorNo" value="4"/>其他作者
											</TD>
										</TR>
									</TBODY>
								</TABLE>
		...
		<TR>
			<TD style="FONT-WEIGHT: bold;">&nbsp;
			作者本人完成字数：<html:text style="WIDTH: 88px" property="Group/WordNum"/>千字 (请输入数字)</TD>
		</TR>
		</logic:equal>
		<TR>
			<TD align="middle">
...
function save() {
  	...
  	var obj = window.parent.document.forms[0].elements["ReportedResult/CourseType"];
  	
  	if (obj[0].checked) {
  	    //alert(window.parent.document.forms[0].elements["ReportedResult/CourseType"][0].value);
        frm.elements["Group/CourseType"].value = 0;
    }
    else {
        //alert(window.parent.document.forms[0].elements["ReportedResult/CourseType"][1].value);
        frm.elements["Group/CourseType"].value = 1;
    }
