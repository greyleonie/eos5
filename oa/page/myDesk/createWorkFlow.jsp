        ...
        <tr>
          <td width="50%" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table8">
            <tr>
              ...
              <td background="/internet/images/index_pic_tcbg.gif" class="cn6"><img src="/internet/images/spacer.gif" width="15" height="8">流程申请</td>
              <td width="80" align="right" background="/internet/images/index_pic_tcbg.gif" class="cn8"><a href="javascript:toWorkFlowMoreLink('DX_OASYS_DOWORK','DX_OASYS_DOWORK_APPLY','oa.prDoWork.applyList.do')"><img src="images/index_button_more-24.gif" alt="" width="36" height="11" hspace="10" border="0"></a>
                </td>
              ...
              <tr>
                <td align="center" valign="top">
                	...
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prReceiveArchive.receiveAdd.do?temptype=0')">收文流程</a></td>
	                    </tr>
                  	</table>
                
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prSendArchive.sendAdd.do?temptype=0')">发文流程</a></td>
	                    </tr>
                  	</table>
                
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prMeetingManage.mrApplyAdd.do?temptype=0')">会议申请</a></td>
	                    </tr>
                  	</table>
                
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prCarManage.useCarAdd.do?temptype=0')">用车申请</a></td>
	                    </tr>
                  	</table>
                
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prFinance.costClaimAdd.do?temptype=0')">费用报销</a></td>
	                    </tr>
                  	</table>
