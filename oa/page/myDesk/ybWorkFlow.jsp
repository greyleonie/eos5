...
tools.util.DeskInfo.queryDeskInfo(request,userId,username,"ybWorkFlow");
...
ArrayList dbWorkFlowList = (ArrayList)request.getAttribute("ybWorkFlowList");
String dbWorkFlowRecords = "0";
dbWorkFlowRecords=(String)request.getAttribute("ybWorkFlowRecords");
        ...
        <tr>
          <td width="50%" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table8">
            <tr>
              ...
              <td background="/internet/images/index_pic_tcbg.gif" class="cn6"><img src="/internet/images/spacer.gif" width="15" height="8">已办事宜</td>
              <td width="80" align="right" background="/internet/images/index_pic_tcbg.gif" class="cn8"><a href="javascript:toWorkFlowMoreLink('DX_OASYS_DOWORK','DX_OASYS_DOWORK_DB','oa.prDoWork.workFlowAll.do?worktype=2')"><img src="images/index_button_more-24.gif" alt="" width="36" height="11" hspace="10" border="0"></a>
                </td>
                ...
                %>
                 <%i++; %>
                	...
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toFlowLink('<%=dbWorkFlowData.getType() %>','yb')"><%=title %>
