...
tools.util.DeskInfo.queryDeskInfo(request,userId,username,"dpmtNotice");
...
<table width="489" align="center"  bgcolor="white">
	<tr>
		<td align="center" valign="top"><table width="100%"  border="0" cellpadding="0" style="border-spacing:10px 0px; ">
        <tr>
          <td width="50%" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table8">
            <tr>
              ...
              <td background="/internet/images/index_pic_tcbg.gif" class="cn6"><img src="/internet/images/spacer.gif" width="15" height="8">部门公告</td>
              <td width="80" align="right" background="/internet/images/index_pic_tcbg.gif" class="cn8"><a href="javascript:toWorkFlowMoreLink('DX_OASYS_INFO','DX_OASYS_INFO_DEP','oa.prNews.noticeList.do?NewsOrg/Columns/criteria/value=部门公告')"><img src="images/index_button_more-24.gif" alt="" width="36" height="11" hspace="10" border="0"></a>
                </td>
                ...
                %>
                 ...
                 <%i++; %>
                	...
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toWorkFlowMoreLink('DX_OASYS_INFO','DX_OASYS_INFO_DEP','oa.prNews.noticeView.do?pageID=2&fid=<%=notice.getNoticeID()%>')"><%=notice.getTitle()%>
