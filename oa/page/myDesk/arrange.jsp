...
tools.util.DeskInfo.queryDeskInfo(request,userId,username,"arrange");
            ...
            <td width="48%"><table height="27" cellspacing="0" cellpadding="0" width="100%" border="0">
                <tbody>
                  <tr>
                    ...
                    <td class="text_red" width="108" bgcolor="#ebebeb" title='当前有<%=arrangeRecords%>条工作安排'>工作安排&nbsp;(<%=arrangeRecords%>)</td>
        ...
        <tr>
          <td width="50%" valign="top"><table width="100%"  border="0" cellpadding="0" cellspacing="0" class="table8">
            <tr>
              ...
              <td background="/internet/images/index_pic_tcbg.gif" class="cn6"><img src="/internet/images/spacer.gif" width="15" height="8">工作安排</td>
              <td width="80" align="right" background="/internet/images/index_pic_tcbg.gif" class="cn8"><a href="javascript:toMoreLink('DX_OASYS_AFFAIR','DX_OASYS_AFFAIR_WORKARRANGE','DX_OASYS_AFFAIR_WORKARRANGE_ACCEPT','oa.prAffair.acceptArrangeList.do',1)"><img src="images/index_button_more-24.gif" alt="" width="36" height="11" hspace="10" border="0"></a>
                </td>
              ...
              <tr>
                ...
                <%i++; %>
                	...
                	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
	                      <td height="24" bgcolor="white" ><img src="/internet/images/index_meun02.gif" alt="" width="3" height="3" hspace="8" align="absmiddle"><a href="javascript:toopenwin('oa.prAffair.acceptArrangeView.do?fid=<%=arrange.getArrangeId()%>&flag=desk')"><%=arrange.getTaskSum()%>
                    &nbsp;(<%=arrange.getCalendar()%>)</a></td>
	                    </tr>
                  	</table>
                  	<%}%>
                  	<%if(countArrange<5){ 
                  		for(int z=0;z<5-countArrange;z++){%>
                  	<table width="95%"  border="0" cellspacing="0" cellpadding="0">
	                    <tr>
