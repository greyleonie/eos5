  ...
  <tr>
	...
	for(int i=0;i<list.size();i++){
		...
		if(rightMap.get(menuID)!=null&&!"".equals(rightMap.get(menuID))){
	    	...
	    	if(leftid!=null&&menuID!=null&&menuID.equals(leftid)){
	    		j = i;
	    		//menuAction += "&subid=" + subid + "&subaction=" + subaction;
	    	}

 %>
		        <td width="21%" ><img src="/internet/image/leftMenu_<%=i+1 %>.gif" width="22" height="17" hspace="4" align="absmiddle"></td>
		        <a href='<%=menuAction %>' target="mainFrame"   onMouseOver="overAction(this)" onMouseOut="outAction(this)" onClick="clickAction(this)">
					<td width="79%" class="menu31" onMouseOver="this.className='menu33'"><%= eosMenu.getMenuName() %></td>
		        </a>      
	        </tr>
	      	<tr bgcolor="#A2A2A2" class="menu_line">
	        	<td height="1" colspan="2" > </td>
