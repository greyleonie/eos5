...
<autoGraphics>
    <graphic name="noticeDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="376" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="sub" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizNews.noticeDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">noticeDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>noticeDelete</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu May 31 17:41:15 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="removeEntity" height="48" width="48" x="256" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="136" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="502" y="310" lookAndFeel="classic">
