...
<autoGraphics>
    <graphic name="borrowRequestProcessDo" type="prg" router="0">
        <states>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">oa.prFinance.borrowRequestList.do</column>
                        ...
                        <row num="2">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">借款保存失败！</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="3">
                            <column num="0" name="passing" type="1">out</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="376" y="216" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFinance.borrowRequestProcessDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
