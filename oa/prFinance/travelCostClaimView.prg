...
<autoGraphics>
    <graphic name="travelCostClaimView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="529" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFinance.travelCostClaimView</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="362" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>travelCostClaimView.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/finance/travelCostClaimView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="162" y="206" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-4-28 下午5:33</value>
                    </property>
