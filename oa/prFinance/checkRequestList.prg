...
<autoGraphics>
    <graphic name="checkRequestList" type="prg" router="0">
        <states>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">CheckRequest/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFinance.checkRequestList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>checkRequestList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/finance/checkRequestList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="200" y="217" lookAndFeel="classic">
