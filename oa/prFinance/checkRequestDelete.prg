...
<autoGraphics>
    <graphic name="checkRequestDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="589" y="69" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="Start" height="48" width="48" x="146" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="385" y="194" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="269" y="195" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="270" y="67" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFinance.checkRequestDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="529" y="195" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="383" y="68" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>操作失败页面</value>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="253" y="355" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-4-28 下午5:23</value>
                    </property>
