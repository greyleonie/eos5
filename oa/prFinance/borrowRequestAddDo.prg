...
<autoGraphics>
    <graphic name="borrowRequestAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="256" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFinance.borrowRequestAddDo</column>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/finance/borrowRequestFail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/finance/borrowRequestReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
