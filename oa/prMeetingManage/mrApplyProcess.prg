...
<autoGraphics>
    <graphic name="mrApplyProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.mrApplyProcess</column>
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="713" y="213" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="568" y="55" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="569" y="213" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>mrApplyProcess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/meetingManage/mrApplyProcess.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>获得后继活动</value>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="906" y="249" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="462" y="212" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="11" typeName="setField" height="48" width="48" x="337" y="294" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="575" y="347" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>mrApplyProcessForDX1.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/meetingManage/mrApplyProcessForDX1.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="14" typeName="useCase" height="48" width="48" x="457" y="348" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizGetOrganizer</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.bizGetOrganizer</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
