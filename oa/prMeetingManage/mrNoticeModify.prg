...
<autoGraphics>
    <graphic name="mrNoticeModify" type="prg" router="0">
        <states>
            <state color="16777215" id="12" typeName="End" height="48" width="48" x="496" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>mrNoticeModify.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/meetingManage/mrNoticeModify.jsp</column>
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.mrNoticeView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="13" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="203" x="419" y="190" lookAndFeel="classic">
