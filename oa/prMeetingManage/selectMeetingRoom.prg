...
<autoGraphics>
    <graphic name="selectMeetingRoom" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="325" y="55" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>selectMeetingRoom.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/meetingManage/selectMeetingRoom.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.meetingRoomListNoPage</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="506" y="55" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">selectMeetingRoom</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>selectMeetingRoom</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Apr 18 15:04:38 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="279" y="293" lookAndFeel="classic">
