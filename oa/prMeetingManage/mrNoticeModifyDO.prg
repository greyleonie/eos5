...
<autoGraphics>
    <graphic name="mrNoticeModifyDO" type="prg" router="0">
        <states>
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prMeetingManage.mrNoticeList</column>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.mrNoticeModifyDO</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
