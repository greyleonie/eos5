...
<autoGraphics>
    <graphic name="prMeetingList" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prMeetingList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prMeetingList</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sat Nov 06 09:06:33 CST 2010</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>MeetingList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/meetingManage/MeetingList.jsp</column>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizMeetingManage.bizMeetingList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
