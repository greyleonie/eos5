...
<autoGraphics>
    <graphic name="pubAddressListView" type="prg" router="0">
        <states>
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>公共通讯录查看页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/publicAddressList/pubAddressLiseView.jsp</column>
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">AddressList/GroupID</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPubAddressList.txlGroupView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPubAddressList.pubAddressListView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pubAddressListView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pubAddressListView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 11 14:43:24 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="529" y="372" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>公共通讯录查看，需要查询指定工通讯录信息和组别信息</value>
                    </property>
                </propertyList>
                <description/>
            </state>
