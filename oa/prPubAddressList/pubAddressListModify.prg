...
<autoGraphics>
    <graphic name="pubAddressListModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>进入公共通讯录修改页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/publicAddressList/pubAddressListModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">pubAddressListModify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>pubAddressListModify</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 11 14:42:47 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="529" y="372" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>取得公共通讯录信息和组别列表，进入公共通讯录修改页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
