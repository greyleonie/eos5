        ...
        <states>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizPubAddressList.pubAddressListAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="529" y="372" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>公共通讯录新增，并返回到公共通讯录列表页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
