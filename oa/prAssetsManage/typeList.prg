...
<autoGraphics>
    <graphic name="typeList" type="prg" router="0">
        <states>
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="546" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/ThingsManage/infoList.jsp</column>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="426" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.infoList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">COMM_COMMODITYINFO</column>
                            <column num="3" name="inPath" type="0"/>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="306" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.selectType</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="186" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">sql</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">COMM_COMMODITYINFO/where</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="12" typeName="End" height="48" width="48" x="746" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prBasicInfoQuery</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prBasicInfoQuery</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Feb 28 17:32:54 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="203" x="669" y="200" lookAndFeel="classic">
