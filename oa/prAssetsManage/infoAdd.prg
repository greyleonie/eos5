...
<autoGraphics>
    <graphic name="infoAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/infoAdd.jsp</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="287" y="165" lookAndFeel="classic">
