...
<autoGraphics>
    <graphic name="writeOffAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="37" typeName="End" height="48" width="48" x="696" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="39" typeName="sub" height="48" width="48" x="496" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="26" typeName="annotate" height="100" width="197" x="622" y="270" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>报废申请增加完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="45" typeName="useCase" height="48" width="48" x="376" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="40" typeName="view" height="48" width="48" x="496" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="42" typeName="useCase" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>插入</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.writeOffAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="43" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>是否重复插入</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.writeOffCheck</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">CAPT_WRITEOFF/WRITEOFFCODE</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="44" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
