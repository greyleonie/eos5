...
<autoGraphics>
    <graphic name="reportMaintainList" type="prg" router="0">
        <states>
            <state color="16777215" id="22" typeName="view" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/reportMaintainList.jsp</column>
            ...
            <state color="16777215" id="21" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.reportMaintainList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">CAPT_MAINTAINDETAILVIEW</column>
            ...
            <state color="16777215" id="17" typeName="setField" height="48" width="48" x="256" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">CAPT_MAINTAINDETAILVIEW/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="14" typeName="Start" height="48" width="48" x="136" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prRepairReportList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prRepairReportList</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Feb 07 18:01:50 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="15" typeName="End" height="48" width="48" x="576" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="annotate" height="100" width="197" x="437" y="165" lookAndFeel="classic">
