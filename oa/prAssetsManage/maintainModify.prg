...
<autoGraphics>
    <graphic name="maintainModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="268" y="158" lookAndFeel="classic">
            ...
            <state color="16777215" id="17" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.maintainModify</column>
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/maintainModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
