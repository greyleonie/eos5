...
<autoGraphics>
    <graphic name="assetsDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="548" y="193" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prAssetsManage.assetsList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
