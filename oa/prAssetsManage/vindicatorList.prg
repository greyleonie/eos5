...
<autoGraphics>
    <graphic name="vindicatorList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="17" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/vindicatorList.jsp</column>
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.vindicatorList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">CAPT_VINDICATOR/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="203" x="220" y="157" lookAndFeel="classic">
