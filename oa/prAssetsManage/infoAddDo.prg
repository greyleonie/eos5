...
<autoGraphics>
    <graphic name="infoAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/infoAddSuccess.jsp</column>
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.infoAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
