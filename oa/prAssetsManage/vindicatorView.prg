...
<autoGraphics>
    <graphic name="vindicatorView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/vindicatorView.jsp</column>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="331" y="128" lookAndFeel="classic">
