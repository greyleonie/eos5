...
<autoGraphics>
    <graphic name="borrowDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.borrowDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="216" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prBasicInfoDel</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prBasicInfoDel</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sat Mar 04 11:18:52 CST 2006</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>删除资产借用记录（永久删除）。删除CAPT_BORROW,CAPT_BORROWDETAIL 表中对应的记录</value>
                    </property>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="582" y="230" lookAndFeel="classic">
