...
<autoGraphics>
    <graphic name="writeOffDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prAssetsManage.writeOffList</column>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.writeOffDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="166" y="177" lookAndFeel="classic">
