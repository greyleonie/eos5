...
<autoGraphics>
    <graphic name="typeDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizThingsManage.infoDelete</column>
            ...
            <state color="16777215" id="6" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prThingsManage.infoList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="176" y="221" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>类别删除。将属于此类别的资产转到未分类中</value>
                    </property>
                </propertyList>
                <description/>
            </state>
