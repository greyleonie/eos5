...
<autoGraphics>
    <graphic name="maintainAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="28" typeName="End" height="48" width="48" x="656" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="37" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="30" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="31" typeName="setField" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="32" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.maintainAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">CAPT_MAINTAIN</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="33" typeName="setField" height="48" width="48" x="336" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="34" typeName="useCase" height="48" width="48" x="216" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>重复插入</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.maintainOnly</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">CAPT_MAINTAIN/MAINTAINCODE</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="35" typeName="Start" height="48" width="48" x="96" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="36" typeName="annotate" height="100" width="197" x="582" y="230" lookAndFeel="classic">
