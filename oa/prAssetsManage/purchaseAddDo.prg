...
<autoGraphics>
    <graphic name="purchaseAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="34" typeName="End" height="48" width="48" x="696" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="38" typeName="setField" height="48" width="48" x="376" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="32" typeName="sub" height="48" width="48" x="496" y="296" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prAssetsManage.purchaseList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="paraType" type="1">appArea</column>
                            <column num="1" name="value" type="0">Msg</column>
                        </row>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="35" typeName="view" height="48" width="48" x="496" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>voFail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/voFail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="41" typeName="setField" height="48" width="48" x="376" y="416" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">请不要重复保存</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
                            <column num="0" name="passing" type="1">out</column>
            ...
            <state color="16777215" id="33" typeName="useCase" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.purchaseAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="40" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>是否重复插入</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.purchaseCheck</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">CAPT_PURCHASE/PURCHASECODE</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="36" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">purchaseSaveDatabase</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>purchaseSaveDatabase</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Oct 09 17:20:11 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="39" typeName="useCase" height="48" width="48" x="376" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>处理流程</value>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="622" y="270" lookAndFeel="classic">
        ...
        <connectors>
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.setField.38</from>
                <to>Shape.useCase.39</to>
                <propertyList>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.useCase.33</from>
                <to>Shape.setField.38</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.useCase.40</from>
                <to>Shape.useCase.33</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.Start.36</from>
                <to>Shape.useCase.40</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
