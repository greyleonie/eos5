...
<autoGraphics>
    <graphic name="infoTypeManage" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/infoTypeManage.jsp</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="191" x="110" y="162" lookAndFeel="classic">
