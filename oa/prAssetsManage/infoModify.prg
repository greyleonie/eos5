...
<autoGraphics>
    <graphic name="infoModify" type="prg" router="0">
        <states>
            <state color="16777215" id="19" typeName="useCase" height="48" width="48" x="306" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="14" typeName="End" height="48" width="48" x="746" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="186" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>选择类别</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.selectType</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="546" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/infoModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="17" typeName="useCase" height="48" width="48" x="426" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询</value>
            ...
            <state color="16777215" id="18" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="annotate" height="100" width="197" x="249" y="153" lookAndFeel="classic">
