...
<autoGraphics>
    <graphic name="gmList" type="prg" router="0">
        <states>
            <state color="16777215" id="14" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">gmList</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jul 31 11:40:56 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.gmList</column>
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/gmList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="23" typeName="annotate" height="100" width="197" x="266" y="137" lookAndFeel="classic">
