...
<autoGraphics>
    <graphic name="commit" type="prg" router="0">
        <states>
            <state color="16777215" id="14" typeName="End" height="48" width="48" x="506" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="306" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/commit.jsp</column>
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="186" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.borrowModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="17" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="annotate" height="100" width="197" x="299" y="175" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>郑灿丹	08-6-25 </value>
                    </property>
                    <property name="text" type="0">
                        <value>显示资产调拨页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
