...
<autoGraphics>
    <graphic name="purchaseProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAssetsManage.purchaseProcess</column>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="212" y="167" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>所有计量单位</value>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="655" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="656" y="174" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>处理页面</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/AssetsManage/purchaseProcess.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="578" y="370" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="461" y="175" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
