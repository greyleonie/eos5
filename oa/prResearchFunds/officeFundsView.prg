...
<autoGraphics>
    <graphic name="officeFundsView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>课题经费查看页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/researchFunds/officeFundsView.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">officeFundsView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>officeFundsView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Apr 25 11:10:31 CST 2007</value>
                    </property>
