...
<autoGraphics>
    <graphic name="groupFundsList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>科研组经费列表页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/researchFunds/groupFundsList.jsp</column>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchFunds.groupFundsList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">groupFundsList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>groupFundsList</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Apr 26 09:59:59 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="478" y="304" lookAndFeel="classic">
