...
<autoGraphics>
    <graphic name="rename" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/shareFolder/rename.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">rename</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jun 06 18:43:25 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="203" x="348" y="339" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-7-19 上午10:56</value>
                    </property>
                    <property name="text" type="0">
                        <value>弹出窗口，对文件或文件夹重命名．</value>
                    </property>
                </propertyList>
                <description/>
            </state>
