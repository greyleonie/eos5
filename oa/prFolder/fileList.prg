...
<autoGraphics>
    <graphic name="fileList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>文件列表显示页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/shareFolder/fileList.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizFolder.fileList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">fileList</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jun 05 14:35:57 CST 2007</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>共享文件管理，列出共享文件夹下的所有文件列表</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="203" x="455" y="310" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥　07-7-19 上午10:36</value>
                    </property>
