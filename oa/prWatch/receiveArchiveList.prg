...
<autoGraphics>
    <graphic name="receiveArchiveList" type="prg" router="0">
        <states>
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="306" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>receiveArchiveList</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizWatch.receiveArchiveList</column>
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="186" y="66" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">ReceiveArchive/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCarList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>useCarList</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sat Apr 28 15:35:42 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="426" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>receiveList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/watch/receiveList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="546" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="284" y="267" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-4-28 下午3:42</value>
                    </property>
