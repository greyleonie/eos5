...
<autoGraphics>
    <graphic name="acceptArrangeDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizAffair.workArrangeDelete</column>
            ...
            <state color="16777215" id="4" typeName="setField" height="48" width="48" x="136" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">acceptArrangeDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>acceptArrangeDelete</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed May 30 11:39:42 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>接受工作安排列表</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prAffair.acceptArrangeList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="3" typeName="removeEntity" height="48" width="48" x="256" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="452" y="381" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-19 下午2:09</value>
                    </property>
                    <property name="text" type="0">
                        <value>删除工作安排，并返回到接受工作安排列表页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
