...
<autoGraphics>
    <graphic name="frameMain" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>公共事务结构框架页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/oa/page/publicAffair/affairFrame.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">frameMain</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Tue May 29 14:09:54 CST 2007</value>
                    </property>
