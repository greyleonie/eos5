...
<autoGraphics>
    <graphic name="ketiSbUpStatus" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchManage.ketiSbUpStatus</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">ketiSbUpDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>ketiSbUpDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Apr 19 15:49:18 CST 2007</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>修改科研申报为上报状态，并返回申报列表页面</value>
                    </property>
