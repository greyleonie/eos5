...
<autoGraphics>
    <graphic name="rsMemberAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prResearchManage.rsMemberAdd</column>
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prResearchManage.rsMemberList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchManage.rsmemberAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
