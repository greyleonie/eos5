...
<autoGraphics>
    <graphic name="modelUploadDo" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">modelUploadDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>modelUploadDo</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Apr 23 09:57:39 CST 2007</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>模板文件上传新增，设置为可用模板，并显示</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>模板文件添加，并默认为可用模板</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchManage.modelUploadDo</column>
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="392" y="175" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="388" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="553" y="267" lookAndFeel="classic">
