...
<autoGraphics>
    <graphic name="groupDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="256" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchManage.groupDelete</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">groupDelete</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Sun Apr 29 13:29:40 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="376" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>返回科研组列表页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prResearchManage.groupList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
