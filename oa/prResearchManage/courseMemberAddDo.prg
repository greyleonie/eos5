...
<autoGraphics>
    <graphic name="courseMemberAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.prResearchManage.courseMemberAdd</column>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">oa.bizResearchManage.memberAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
