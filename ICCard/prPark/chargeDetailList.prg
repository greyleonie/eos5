...
<autoGraphics>
    <graphic name="chargeDetailList" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">chargeDetailList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>chargeDetailList</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Aug 03 16:40:12 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="191" x="545" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-8-3 下午4:40</value>
                    </property>
                    <property name="text" type="0">
                        <value>停车收费明细列表</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>chargeDetailList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/park/chargeDetailList.jsp</column>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizPark.chargeDetailList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
