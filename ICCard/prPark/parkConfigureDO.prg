...
<autoGraphics>
    <graphic name="parkConfigureDO" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>parkConfigure</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.prPark.parkConfigure</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizPark.parkConfigureDO</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">parkConfigureDO</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>parkConfigureDO</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Aug 06 15:35:57 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="191" x="298" y="274" lookAndFeel="classic">
