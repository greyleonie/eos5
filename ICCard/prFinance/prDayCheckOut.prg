...
<autoGraphics>
    <graphic name="prDayCheckOut" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prDayCheckOut</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prDayCheckOut</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Apr 10 13:53:02 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizFinance.bizDayCheckOut</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="227" x="407" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-20 下午2:45</value>
                    </property>
