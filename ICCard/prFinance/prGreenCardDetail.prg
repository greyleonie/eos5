...
<autoGraphics>
    <graphic name="prGreenCardDetail" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizFinance.bizGreenCardDetail</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="9" typeName="removeEntity" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="name" type="0"/>
                            <column num="1" name="paraType" type="1">appArea</column>
                            <column num="2" name="value" type="0">QueryBizLogsByIds/userid</column>
                        </row>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="227" x="887" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-20 下午3:34</value>
                    </property>
