...
<form method="post" action="ICCard.prDeposit.depositList.do">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;一卡通—&gt;充值管理
              </td></tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="ICCard.prDeposit.depositList.do">
		<input type="hidden" name="addaction" value="ICCard.prDeposit.cardDeposit.do">
		<input type="hidden" name="cancelaction" value="ICCard.prDeposit.cancelDeposit.do">
...
<input name="B32" type="button" class="button_02" value="查 询" onclick="talentquery()">
	  ...
	  <tr>
	    <td height="30" class="text">
<qx:talentButton property="add" type="button" styleClass="button_02" value="充 值" onclick="talentadd()" operation="DX_CARD_MANAGE_DEPOSIT.DX_CARD_MANAGE_DEPOSIT_DO"/>
<qx:talentButton property="cancel" type="button" styleClass="button_02" value="撤消充值" onclick="cancelDeposit()" operation="DX_CARD_MANAGE_DEPOSIT.DX_CARD_MANAGE_DEPOSIT_CANCEL"/>
      ...
      <tr>
        <td valign="top" class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
          <tr class="td_title">
            ...
            <td width="20%" align="center" nowrap id="QueryBusinessLogs.HappeningTime" onclick="talentsort()">充值时间</td>
            <td width="14%" align="center" nowrap id="QueryBusinessLogs.BusinessMoney" onclick="talentsort()">充值金额</td>
            <td width="14%" align="center" nowrap id="QueryBusinessLogs.Balance" onclick="talentsort()">卡内余额</td>
          ...
          <logic:iterate id="resultset" property="list[@type='QueryBusinessLogs']">
            ...
            <tr class="<%=trClass%>" onclick="changeTRBgColor(this)">
			  ...
			  <html:checkbox name="list[@name='update']/BusinessLogs/BusinessLogsID" id="resultset" property="QueryBusinessLogs/BusinessLogsID" indexed="true" attributes="<%=h%>" /> </td>
	            ...
	            <td  nowrap align="center"><bean:write id="resultset" property="QueryBusinessLogs/Balance" formatClass="com.primeton.eos.webtag.bean.BeanWriteNumberFormatImpl" formatType="#,###.##"/>元</td>
