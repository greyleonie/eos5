...
<script language="javascript">
		...
		if(lastCardID!=id){//alert("id:"+id+";lastCardID:"+lastCardID);
...
<table width="98%"  border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#A2C4DC">
	...
	<tr>
		...
		<td width="88%" class="td1" align="left">
		<html:text property="Card/CardLastSum"   styleClass="input" size="30"  readonly="true"/> (人民币：元)
		</td>
	</tr>
	</form>
	<html:form action="ICCard.prDeposit.cardDepositDO.do" method="POST" name="cardForm">
		...
		<tr>
			...
			<td width="88%" class="td1" align="left"><input type="radio" name="Card/moneysource" value="1"
				onclick="HideOldCardCoverNO()" checked="true" />现金 <input
				type="radio" name="Card/moneysource" value="2"
				onclick="ShowOldCardCoverNO()" />磁卡</td>
		</tr>
		<tr style="display:none" id="cika">
			<td width="12%" class="td2" nowrap>磁卡编号</td>
			<td width="88%" class="td1"><html:text property="Card/oldCardCoverNO" styleClass="input" size="30" disabled="true" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="88%" class="td1" align="left">
			<input type="radio" name="Card/isInVoiced" value="1" checked="true"/>是&nbsp;&nbsp;
