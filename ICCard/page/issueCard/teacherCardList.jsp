...
<%
	...
	boolean issue = RP.parse("DX_CARD_MANAGE_ISSUECARD_TE.DX_CARD_MANAGE_ISSUECARD_TE_ISSUE",session) ;
 	boolean thaw = RP.parse("DX_CARD_MANAGE_ISSUECARD_TE.DX_CARD_MANAGE_ISSUECARD_TE_THAW",session) ;
 	boolean congeal = RP.parse("DX_CARD_MANAGE_ISSUECARD_TE.DX_CARD_MANAGE_ISSUECARD_TE_CONGEAL",session) ;
