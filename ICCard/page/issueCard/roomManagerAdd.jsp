...
<script language="javascript">
 ...
 {
 var i,j;
 var num=document.getElementById("getlayer").title;
 ...
 if(layeNo=='-1'||layeNo==null){HideLayerNO();}
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <td class="text">
	    ...
	    <table width="98%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#A2C4DC">
          <tr> 
            ...
            <html:text property="Card/CardID" styleClass="input" size="30" readonly="true" attributesText=' ValidateType="notempty" Msg="物理卡号不能为空"'/>
			
				<input name="query" type="button" class="button_02" value="读 卡" onClick="GetCardID()" >
			</td>
          </tr>
          <tr> 
            <td align="right" class="td2">卡 类 型： </td>
            <td class="td1"> 
            <% int layerNO=talent.core.TalentFunctions.getInt(base.util.TalentContext.getValue(pageContext,null,"RoomManager/LayerNO"),-1);
             if(layerNO<0){
             %>
            	<input type="radio" name="RoomManager/type" value="1" onclick="ShowLayerNO()"/>楼层卡 
              	<input type="radio" name="RoomManager/type" value="2" checked="true" onclick="HideLayerNO()"/>楼房总管卡 
            <%}else{ %>
            	<input type="radio" name="RoomManager/type" value="1" checked="true" onclick="ShowLayerNO()"/>楼层卡 
              	<input type="radio" name="RoomManager/type" value="2" onclick="HideLayerNO()"/>楼房总管卡 
           <%} %>
            </td>  
              </tr>
          <tr id="cardcovernorow"> 
            ...
            <td class="td1">
            <SELECT onchange="select(this.options[selectedIndex].title);" name="RoomManager/BuildingID" ID="na" >
            <logic:iterate id="Buildings" property="list[@type='Building']">
             <option value="<bean:write id="Buildings" property="Building/BuildingID"/>"  title="<bean:write id="Buildings" property="Building/LayerNum"/>" id="getlayer">
          ...
          <tr id="layernorow"> 
            ...
            <SELECT ID="oSelect" name="RoomManager/LayerNO">
          ...
          <tr> 
            ...
            <td class="td1"> 
            <html:text property="RoomManager/EndTime[@pattern='yyyy-MM-dd']" styleClass="input" size="30"  readonly="true" attributesText=' ValidateType="notempty" Msg="失效时间不能为空"'/>
            <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["RoomManager/EndTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")>
            </td>
          </tr>
          <tr> 
            <td align="right" class="td2">持 卡 人： </td>
            <td class="td1">  <html:text property="RoomManager/Cardholder" styleClass="input" size="30"  attributesText=' ValidateType="notempty" Msg="持卡人不能为空"'/>
            </td>
          </tr>
    ...
    <tr>
      <td class="text">
        <p align="center">&nbsp;<input name="query1" type="button" class="button_02" value="保 存" onClick="save()"> 
...
<OBJECT ID="Card Control" WIDTH="" HEIGHT="" CLASSID="CLSID:AEA5E7AD-4A2F-44BE-88FE-0CF9A8E648D4" codebase="/internet/ActiveX/card.cab" name="cardcontrol">
</OBJECT>
