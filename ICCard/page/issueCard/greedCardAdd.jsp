...
function is_chinese(elem){
	...
	if(!pattern.test(elem)){
     ...
     return true;
			...
			var carder = usersForm.elements["Card/UserName"].value;
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;一卡通—&gt;发卡管理—&gt;绿卡发卡 </td>
          </tr>
        </table></td>
    </tr>
    <tr>
...
<html:form action="/ICCard.prIssueCard.greedCardAddDO.do" method="POST" name="usersForm">
	...
	<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
	 ...
	 <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
		<tr>
			<td width="12%" align="right" nowrap class="td2">操作说明：</td>
			<td width="88%" class="td1">请填写持卡人姓名及充卡金额，确定无误即可发卡。</td>
		</tr>
		<tr>
			<td width="12%" align="right" nowrap class="td2">持 卡 人：</td>
			<td width="88%" align="left" class="td1"><html:text property="Card/UserName" styleClass="input" size="30" /> (请输入持卡人的中文姓名)</td>
		</tr>
		<tr>
			<td width="12%" align="right" nowrap class="td2">卡 密 码：</td>
			<td width="88%" align="left" class="td1"><input type="password" name="Card/password"
				Class="input" size="30" /> (请输入六位纯数字卡密码)</td>
		</tr>
		<tr>
			<td width="12%" align="right" nowrap class="td2">确认密码：</td>
			<td width="88%" align="left" class="td1"><input type="password" name="Card/passwordconfirm"
				Class="input" size="30" /> (请再次输入卡密码，以作确认)</td>
		</tr>
		<tr>
			<td width="12%" align="right" nowrap class="td2">充卡金额：</td>
			<td width="88%" align="left" class="td1"><html:text property="Card/CardLastSum" styleClass="input" size="30" />(人民币：元)</td>
		</tr>
		<tr>
