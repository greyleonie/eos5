...
<head>
	...
	<OBJECT ID="Card Control" WIDTH="" HEIGHT="" CLASSID="CLSID:AEA5E7AD-4A2F-44BE-88FE-0CF9A8E648D4"
		codebase="/ActiveX/card.cab" name="cardcontrol"> </OBJECT>
	<OBJECT ID="StandardCom Control" WIDTH="" HEIGHT="" CLASSID="CLSID:1538AED7-C401-4A0B-B0A8-D3A8AA53DF0B"
		codebase="/ActiveX/com.cab" name="comcontrol"> </OBJECT>
	<!-- 把发卡数据写入卡中 -->
	...
	<%
         ...
         */
        String info = base.util.TalentContext.getValue(pageContext, null,
                "info");
					...
					<tr>
						<td height="110" align="center" valign="middle" bgcolor="#FFFFFF">
							<table border=0 width="80%" align=center>
								<tr>
									<td width="23%" align="center" id="info"><img src="/internet/image/tst.jpg" width="51" height="40"
											align="middle" /></td>
									<td width="77%" align="center" class="text_legend" id="info"><b><%=info%></b></td>
								</tr>
							</table>
