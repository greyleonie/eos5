...
<script>
	...
	tabbox1.add('1','øÕ∑ø','ICCard.prField.roomEmptyList.do?RoomTypeID=2','testframe',0)
	tabbox1.add('2','øŒ “','ICCard.prField.roomEmptyList.do?RoomTypeID=1','testframe',0)
	tabbox1.add('3','Ã÷¬€ “','ICCard.prField.roomEmptyList.do?RoomTypeID=3','testframe',0)
