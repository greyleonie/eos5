...
<form method="post"  name="opeForm">
  <input  type="hidden" name="RoomID" value="<bean:write property="Room/RoomID"/>"/>
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
 ...
 <tr>   
       ...
       <font color="#FFFFFF" ></font>课室名：<font color="red"><bean:write property="Room/RoomName"/></font>
      ...
      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" style="cursor:hand">	
	 <tr class="td_title">
	...
	<logic:iterate iterateId="date" property="list[@type='Date']">
		     ...
		     <%}%>
				...
				<!--课室单元-->
				<TD    onmouseover='doMsg(this)' onmouseout='doHidePane()' onclick='doDateClick(this)' align="center">
				...
				<input type='hidden' value='<bean:write id="date" property="ENTITY/Date"/>'/>
								...
								<font  style="color: #114489;font-weight: bold;"><%=i %></font>
				...
				<TD>
				  ...
				  <TR  class="td3" >
	                  ...
	                  <TD nowrap="nowrap" width="34%"  align="center" title='<bean:write id="date" property="ENTITY/Morning"/>'   class='<logic:equal id="date" property="ENTITY/MorningType" value="1">state_empty</logic:equal><logic:equal id="date" property="ENTITY/MorningType" value="2">state_school</logic:equal><logic:equal id="date" property="ENTITY/MorningType" value="3">state_other</logic:equal>' > <logic:notEqual  property="op" value="view" ><logic:equal id="date" property="ENTITY/MorningType" value="1"><input type='checkbox' name='freeclassroom' value='<bean:write id="date" property="ENTITY/Date"/>|0|<bean:write property="Room/RoomID"/>|<bean:write property="Room/RoomName"/>'></logic:equal><logic:equal id="date" property="ENTITY/MorningType" value="2"><img src='internet/image/admin1.gif'></logic:equal><logic:equal id="date" property="ENTITY/MorningType" value="3"><input type='checkbox' name='checkclassroom' value='<bean:write id="date" property="ENTITY/MorningLogsID"/>'></logic:equal></logic:notEqual>上
		              </TD>
		              
				<!--下午的使用情况-->
	                  <TD nowrap="nowrap" width="33%"  align="center" title='<bean:write id="date" property="ENTITY/Afternoon"/>' class='<logic:equal id="date" property="ENTITY/AfternoonType" value="1">state_empty</logic:equal><logic:equal id="date" property="ENTITY/AfternoonType" value="2">state_school</logic:equal><logic:equal id="date" property="ENTITY/AfternoonType" value="3">state_other</logic:equal>'><logic:notEqual  property="op" value="view" > <logic:equal id="date" property="ENTITY/AfternoonType" value="1"><input type='checkbox' name='freeclassroom' value='<bean:write id="date" property="ENTITY/Date"/>|1|<bean:write property="Room/RoomID"/>|<bean:write property="Room/RoomName"/>'></logic:equal><logic:equal id="date" property="ENTITY/AfternoonType" value="2"><img src='internet/image/admin1.gif'></logic:equal><logic:equal id="date" property="ENTITY/AfternoonType" value="3"><input type='checkbox' name='checkclassroom' value='<bean:write id="date" property="ENTITY/AfternoonLogsID"/>'></logic:equal></logic:notEqual>下
		              </TD>
	          
				<!--晚上的使用情况-->
				 
	                  <TD nowrap="nowrap" width="33%"   align="center" title='<bean:write id="date" property="ENTITY/Night"/>' class='<logic:equal id="date" property="ENTITY/NightType" value="1">state_empty</logic:equal><logic:equal id="date" property="ENTITY/NightType" value="2">state_school</logic:equal><logic:equal id="date" property="ENTITY/NightType" value="3">state_other</logic:equal>'><logic:notEqual  property="op" value="view" ><logic:equal id="date" property="ENTITY/NightType" value="1"><input type='checkbox' name='freeclassroom' value='<bean:write id="date" property="ENTITY/Date"/>|2|<bean:write property="Room/RoomID"/>|<bean:write property="Room/RoomName"/>'></logic:equal><logic:equal id="date" property="ENTITY/NightType" value="2"><img src='internet/image/admin1.gif'></logic:equal><logic:equal id="date" property="ENTITY/NightType" value="3"><input type='checkbox' name='checkclassroom' value='<bean:write id="date" property="ENTITY/NightLogsID"/>'></logic:equal></logic:notEqual>晚
		              </TD>
	            </TR>	
          </TABLE> 
       </TD>
  ...
  <script>
	...
	function doMonthClick(id){
		...
		frameb.location.href = "ICCard.prField.classRoom4Month.do?input/RoomID="+RoomID+"&op="+op+"&input/CurrDate="+dateStr;
	}
	...
	function doDateClick(obj){
		...
		var op = "<bean:write property="op"/>";
		frame.location.href = "ICCard.prField.classRoom4Day.do?input/RoomID="+RoomID+"&op="+op+"&input/CurrDate="+CurrDate;
	}
