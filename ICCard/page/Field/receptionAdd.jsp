...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;一卡通—&gt;场地管理—&gt;交接班新增</td>
          </tr>
        </table></td>
    </tr>
    <tr>
  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="20%" align="center" bgcolor="#4A82D1" class="textb_wirte">新增交接班</td>
    ...
    <td  class="td1"><input type="hidden"  name="tblReceptionChangeRec/Author" value="<bean:write property="SessionEntity/userID" formatClass="username" formatType="userid"/>"/>
    <bean:write property="SessionEntity/userID" formatClass="username" formatType="userid"/></td>
    <td class="td2" align="right"> 班次 ：</td>
    <td class="td1" colspan="2">
    	<html:hidden  name="tblReceptionChangeRec/Range" property="Range"/>
    	<logic:equal property="Range" value="0">
    		早班
    	</logic:equal>
    	<logic:equal property="Range"value="1">
    		中班
    	</logic:equal>
    	<logic:equal property="Range"  value="2">
    		夜班
    	</logic:equal>
    </td>
    ...
    <td class="td1" >
    	<html:hidden  name="tblReceptionChangeRec/CreatedTime" property="CreatedTime"/>
    	<bean:write property="CreatedTime"  formatType="yyyy-MM-dd HH:mm" formatClass="com.primeton.eos.webtag.bean.BeanWriteDateFormatImpl"/>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td class="td1" colspan="5"><html:text property="tblReceptionChangeRec/MeetingCost"   attributesText='class="input" size="20"  ValidateType="money" Msg="会议费必须为数字"'/></td>
  </tr>
  <tr>
    <td class="td2" align="right"> 电话费、传真 ：</td>
    <td class="td1" colspan="5"><html:text property="tblReceptionChangeRec/TelecomCost"   attributesText='class="input" size="20"  ValidateType="money" Msg="电话费传真必须为数字"'/></td>
  </tr>
  <tr>
    <td class="td2" align="right"> 其他杂费 ：</td>
    <td class="td1" colspan="5"><html:text property="tblReceptionChangeRec/OtherCost"   attributesText='class="input" size="20"  ValidateType="money" Msg="其他杂费必须为数字"'/></td>
  </tr>
  <tr>
