    ...
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            ...
            <logic:equal property="RoomTypeID" value="4">娱乐场所信息</logic:equal></span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
    ...
    <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
            ...
            <td height="30" class="text">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<IMG src="image/state_empty.gif">空&nbsp;&nbsp;闲<IMG src="image/state_school.gif">校内使用<IMG src="image/state_other.gif">出&nbsp;&nbsp;租
			</td>
      </tr>
      <tr>
        <td height="8"> </td>
      ...
      <tr>
        <td align="right" class="td1">总供有&nbsp;<font color="red"><bean:write property="count"/></font>&nbsp; 
            ...
            <logic:equal property="RoomTypeID" value="4">间娱乐场所</logic:equal> </td>
      </tr>
      <tr>
		...
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
				...
				<logic:equal id="resultset" property="Room/BuildingID" valueType="variable" valueId="buildingset" value="Building/BuildingID">
			       ...
			       <tr> 
			    <%}%>
                  <td  align="center" width="10%" class="<%=trClass%>" onmouseover='doMsg(this)' onmouseout='doHidePane()' onclick='doClick(this)'   background="<logic:equal id="resultset" property="Room/State" value="1">image/state_empty.gif</logic:equal>
                  <logic:equal id="resultset" property="Room/State" value="2">image/state_school.gif</logic:equal>
                  <logic:equal id="resultset" property="Room/State" value="3">image/state_other.gif</logic:equal>">
