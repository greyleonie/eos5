...
<form method="post"  action="ICCard.prField.roomAddDo.do">
<logic:greaterThan property="count" value="0"><script> alert("名称已存在");</script> </logic:greaterThan>
    ...
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <logic:equal property="RoomTypeID" value="1">课室信息增加</logic:equal>
            <logic:equal property="RoomTypeID" value="2">客房信息增加</logic:equal>
            <logic:equal property="RoomTypeID" value="3">讨论室信息增加</logic:equal>
            <logic:equal property="RoomTypeID" value="4">其它场地信息增加</logic:equal></span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		...
		<input type="hidden" name="Room/RoomTypeID" value="<bean:write property="RoomTypeID"/>"/>
