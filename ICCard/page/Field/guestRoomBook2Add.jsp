...
<body>
<form method="post"  action="ICCard.prField.guestRoomBook2AddDo.do" name="opeForm" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页 -&gt; 场地管理 -&gt; 客房出租  -&gt; 预订登记</td>
          </tr>
        </table></td>
    </tr>
    <tr>
  ...
  <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0" class="table">
    ...
    <tr>
      ...
      <td width="20%" align="center" bgcolor="#4A82D1" class="textb_wirte">填写住宿信息</td>
