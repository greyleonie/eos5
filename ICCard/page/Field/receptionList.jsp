	  ...
	  <tr>
            ...
            <td height="30" class="text">
              ...
              <html:hidden property="tblReceptionChangeRec/Author/criteria/likeRule" value="center"/>
				...
				<qx:talentButton property="add" type="button" styleClass="button_02" value="新 增" onclick="talentaddNew()" operation="DX_CARD_MANAGE_FIELD_RECEPTION.DX_CARD_MANAGE_FIELD_RECEPTION_ADD"/>
				<qx:talentButton property="modify" type="button" styleClass="button_02" value="修 改" onclick="talentmodify()" operation="DX_CARD_MANAGE_FIELD_RECEPTION.DX_CARD_MANAGE_FIELD_RECEPTION_MODIFY"/>
				<qx:talentButton property="delete" type="button" styleClass="button_02" value="删 除" onclick="talentdelete()" operation="DX_CARD_MANAGE_FIELD_RECEPTION.DX_CARD_MANAGE_FIELD_RECEPTION_DELETE"/>
