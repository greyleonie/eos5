...
<form method="post"  action="ICCard.prField.buildingModifyDo.do">
<logic:greaterThan property="count" value="1"><script> alert("楼宇名已存在");</script> </logic:greaterThan>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;一卡通—&gt;场地管理—&gt;楼宇信息修改</td>
          </tr>
        </table></td>
    </tr>
    <tr>
  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
        <html:hidden  property="Building/BuildingID"/>
        <tr> 
        ...
        <tr> 
          ...
          <td class="td1" ><html:text property="Building/RoomNum" attributesText='class="input" size="10" ValidateType="int" Msg="房间数：必须为数字"'/></td>
        </tr>
      </table>
