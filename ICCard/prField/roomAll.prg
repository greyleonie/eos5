...
<autoGraphics>
    <graphic name="roomAll" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="203" x="469" y="189" lookAndFeel="classic">
