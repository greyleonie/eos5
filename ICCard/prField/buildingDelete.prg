...
<autoGraphics>
    <graphic name="buildingDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="24" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/voFail.jsp</column>
            ...
            <state color="16777215" id="25" typeName="sub" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.prField.buildingList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="removeEntity" height="48" width="48" x="216" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="23" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.buildingDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="9" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="22" typeName="annotate" height="100" width="197" x="437" y="215" lookAndFeel="classic">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.5</from>
                <to>Shape.sub.25</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
