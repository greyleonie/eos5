...
<autoGraphics>
    <graphic name="buildingAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/buildingAdd.jsp</column>
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="197" x="284" y="171" lookAndFeel="classic">
