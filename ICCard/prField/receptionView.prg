...
<autoGraphics>
    <graphic name="receptionView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="24" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/receptionView.jsp</column>
            ...
            <state color="16777215" id="19" typeName="annotate" height="100" width="197" x="305" y="158" lookAndFeel="classic">
