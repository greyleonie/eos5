...
<autoGraphics>
    <graphic name="classRoomCheckOut" type="prg" router="0">
        <states>
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/classRoomCheckOut.jsp</column>
            ...
            <state color="16777215" id="19" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.classRoomCheckOut</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="20" typeName="setField" height="48" width="48" x="176" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">ssadd</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Thu Dec 21 10:45:53 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="17" typeName="annotate" height="100" width="197" x="320" y="164" lookAndFeel="classic">
