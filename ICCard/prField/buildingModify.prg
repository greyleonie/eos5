...
<autoGraphics>
    <graphic name="buildingModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/buildingModify.jsp</column>
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.buildingModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="19" typeName="annotate" height="100" width="197" x="422" y="190" lookAndFeel="classic">
