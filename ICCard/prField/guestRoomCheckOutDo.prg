...
<autoGraphics>
    <graphic name="guestRoomCheckOutDo" type="prg" router="0">
        <states>
            <state color="16777215" id="59" typeName="End" height="48" width="48" x="496" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="66" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/guestRoomCheckOutSuccess.jsp</column>
            ...
            <state color="16777215" id="65" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>结帐失败</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/guestRoomCheckOutFail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="67" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.guestRoomCheckOutDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="63" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="64" typeName="annotate" height="100" width="197" x="422" y="230" lookAndFeel="classic">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.Start.63</from>
                <to>Shape.useCase.67</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
