...
<autoGraphics>
    <graphic name="receptionModifyDo" type="prg" router="0">
        <states>
            <state color="16777215" id="37" typeName="End" height="48" width="48" x="496" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="38" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="39" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.prField.receptionList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="43" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.receptionModifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="41" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="42" typeName="annotate" height="100" width="197" x="422" y="230" lookAndFeel="classic">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.Start.41</from>
                <to>Shape.useCase.43</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
