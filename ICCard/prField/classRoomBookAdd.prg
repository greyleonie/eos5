...
<autoGraphics>
    <graphic name="classRoomBookAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>classRoomBookAdd.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/classRoomBookAdd.jsp</column>
            ...
            <state color="16777215" id="17" typeName="annotate" height="100" width="197" x="209" y="214" lookAndFeel="classic">
