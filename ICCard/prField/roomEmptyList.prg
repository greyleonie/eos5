...
<autoGraphics>
    <graphic name="roomEmptyList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="32" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/Field/roomEmptyList.jsp</column>
            ...
            <state color="16777215" id="31" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizField.roomEmptyList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="23" typeName="annotate" height="100" width="203" x="548" y="205" lookAndFeel="classic">
