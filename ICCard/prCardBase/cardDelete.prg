...
<autoGraphics>
    <graphic name="cardDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/cardBase/cardReturn.jsp</column>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizCardBase.cardDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
