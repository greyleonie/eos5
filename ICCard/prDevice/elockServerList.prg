...
<autoGraphics>
    <graphic name="elockServerList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="191" x="545" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>帅文明	15-6-29 下午1:51</value>
                    </property>
                    <property name="text" type="0">
                        <value>电子门服务器锁列表</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>elockServerList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/device/elockServerList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizDevice.elockServerList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
