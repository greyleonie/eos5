...
<autoGraphics>
    <graphic name="elockServerAddDO" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">cardAddDO</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>cardAddDO</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 09 13:50:17 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="191" x="1071" y="280" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value> 帅文明	07-3-9 下午2:21</value>
                    </property>
                    <property name="text" type="0">
                        <value>执行电子门锁服务器添加</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizDevice.elockServerAddDO</column>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="319" y="159" lookAndFeel="classic">
