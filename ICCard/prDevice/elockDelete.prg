...
<autoGraphics>
    <graphic name="elockDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>elockReturn.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/device/elockReturn.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizDevice.elockDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
