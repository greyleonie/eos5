...
<autoGraphics>
    <graphic name="linkBookHead" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">linkBookHead</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>linkBookHead</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Apr 10 09:27:14 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>linkBookHead.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/msg/linkBookHead.jsp</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="178" x="242" y="207" lookAndFeel="classic">
