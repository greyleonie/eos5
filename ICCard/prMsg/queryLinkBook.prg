...
<autoGraphics>
    <graphic name="queryLinkBook" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">queryLinkBook</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>queryLinkBook</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Apr 10 15:05:31 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizMsg.queryLinkBook</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="172" x="183" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-10 下午3:05</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询一条通讯记录</value>
                    </property>
                </propertyList>
                <description/>
            </state>
