...
<autoGraphics>
    <graphic name="mobileWithChar" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">mobileWithChar</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>mobileWithChar</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Apr 12 11:13:57 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="178" x="191" y="206" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-12 上午11:14</value>
                    </property>
                    <property name="text" type="0">
                        <value>根据姓氏查询号码</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>mobileWithChar.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/ICCard/page/msg/mobileWithChar.jsp</column>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">ICCard.bizMsg.userByFirstChar</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
