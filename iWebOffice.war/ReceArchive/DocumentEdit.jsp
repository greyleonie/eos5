...
<%
  ...
  if (DbaObj.OpenConnection())
  {
	...
	//初始化值
        ...
        mTemplate=mTemplate;
        mSubject=new String("收文正文".getBytes("8859_1"));
        mAuthor=mUserName;
           ...
           <table border=0 cellspacing='0' cellpadding='0' width='100%' height='100%' >
             <tr>
                <td bgcolor=menu>
                  ...
                  <div id="DivID">
				  <object id="WebOffice" width="100%" height="100%" classid="clsid:8B23EA28-723C-402F-92C4-59BE0E063499" codebase="../iWebOffice2006.cab#version=7,5,0,0">
				  </object>
				  </div>
                </td>
             </tr>
...
<iframe src="" frameborder="0" width="100%" id="sendText" style="display:none"></iframe>
</body>
<script language="javascript">
<%
String dealstat = "";
...
%>
window.parent.document.forms[0].elements["ReceiveArchive/RecordID"].value='<%=mRecordID%>';
<% } %>
alert("收文正文保存成功！");
<% } else {%>
alert("收文正文保存失败！");
...
if (document.getElementById("WebOffice") == undefined)
   document.getElementById("sendText").src = "../InstallClient.zip";
</script>
</html>
