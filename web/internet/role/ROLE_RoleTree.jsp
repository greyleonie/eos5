...
function addNode(parentNode, recursedNodes) {
	for (var i = 0; i < nodes.length; i++) {
		...
		if (nodeValues[1] == parentNode) {
			...
			} else document.write("<img id=\"icon" + nodeValues[0] + "\" src=\"/internet/images/role.gif\" align=\"absbottom\" alt=\"Page\" />");
...
<script type="text/javascript">
	...
	var Tree =  new Array (
	<logic:iterate id="allRole" property="list[@type='EOSRole']">
		"<bean:write id="allRole" property="EOSRole/roleID"/>|0|<bean:write id="allRole" property="EOSRole/roleName"/>|ROLE.pr_automata.ROLE_P_RoleDetailFrame.do?EOSRole/roleID=<bean:write id="allRole" property="EOSRole/roleID"/>&EOSRole/roleName=<bean:write id="allRole" property="EOSRole/roleName"/>|treeMain",
	</logic:iterate>

	"end");
 	createTree(Tree,0,"0","½ÇÉ«ÁÐ±í","ROLE.pr_automata.ROLE_P_QueryRoleAll.do","treeMain");	
</script>
</div>
    </td>
    </tr>
