...
<link rel="stylesheet" href="/internet/css/oldHCIStyle.css" type="text/css">
<eos:css/>
</head>
  ...
  <tr>
    <td valign="top"> 
	  ...
	  <table width="100%" height="99%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td height="100%">
            <table width="98%" height="99%" border="0" cellspacing="0" cellpadding="0" align="right">
              <tr> 
                <td valign="top" >
	     
错误信息：<b><font color="red">无法显示指定页面，请确信有此文件存在...</font></b>
