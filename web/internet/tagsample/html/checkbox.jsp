...
<html:checkbox property="show/info" value="Banana" tabindex="1" scope="session"/>
Banana
<p>
<html:checkbox property="show/info" value="Apple" tabindex="0" scope="session"/>
Apple
<p>
<html:checkbox property="show/info" value="Orange" tabindex="2" scope="session"/>
Orange
<p>
