function atCalendarControl(){
  var calendar=this;
  this.calendarPad=null;//日历底板及阴影及日历面板
  this.prevMonth=null;//上一月
  this.nextMonth=null;//下一月
  this.prevYear=null;//上一年
  this.nextYear=null;//下一年
  this.goToday=null;//今天
  this.calendarClose=null;//关闭
  this.calendarAbout=null;//帮助
  this.head=null;
  this.body=null;
  this.today=[];
  this.currentDate=[];
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='position:absolute;top:100;left:0;width:170;height:187;display:none;'>");
   document.write("<div style='position:absolute;top:2;left:2;width:170;height:150;background-color:#336699;'></div>");
   document.write("</div>");
  ...
  this.addCalendarBoard=function(){
   ...
   divBoard.style.cssText="position:absolute;top:0;left:0;width:170;height:150;border:0 outset;background-color:buttonface;";

   var tbBoard=document.createElement("table");
   divBoard.insertAdjacentElement("beforeEnd",tbBoard);
   tbBoard.style.cssText="position:absolute;top:2;left:2;width:40;height:10;font-size:9pt;";
   tbBoard.cellPadding=0;
   tbBoard.cellSpacing=1;

   /************** 设置各功能按钮的功能 *********************/
   /*********** Calendar 帮助按钮 **************************/
   trRow = tbBoard.insertRow(0);//得到第一行
  ...
  // calendar.goToday.colspan=3;
   calendar.goToday.onclick=function(){
     if(calendar.returnTime)  
        calendar.sltDate=calendar.today[0]+"-"+calendar.formatTime(calendar.today[1])+"-"+calendar.formatTime(calendar.today[2])+" "+calendar.formatTime(calendar.today[3])+":"+calendar.formatTime(calendar.today[4])+":"+"00"
     else
   ...
   for (var i = 0; i < 7; i++) {
    ...
    tbCell.align="center";
    tbCell.width="100%";
     tbCell.style.cssText="cursor:default;border-top-color:#FFFFFF;border:10;border-right-color:#330000;background-color:rgb(222,234,224)";
   }
   ...
   tbBody.style.cssText="position:relative;top:0;left:0;width:162;height:95;font-size:9pt;"
   ...
   calendar.prevHours.onmousedown=function(){
        ...
        calendar.bottom.innerText=calendar.formatTime(calendar.currentDate[3])+":"+calendar.formatTime(calendar.currentDate[4])+":"+"00";
    }
   tbCell=trRow.insertCell(1);
...
/************** 加入功能按钮公共样式 *********************/
  this.insertTbCell=function(trRow,cellIndex,TXT,trAlign,tbColSpan){
   ...
   btnCell.style.cssText="width:100%;height:18;border-top-color:#FFFFFF;borer-right-color:#333333; outset;background-color:buttonface;";
   btnCell.onmouseover=function(){
   btnCell.style.cssText="width:100%;height:18;border-top-color:#FFFFFF;borer-right-color:#333333; outset;background-color:#F0F0F0;";
  ...
  // }
   btnCell.onmouseup=function(){
    btnCell.style.cssText="width:100%;height:18;border-top-color:#FFFFFF; outset;background-color:#F0F0F0;";
   }
  ...
  this.show=function(targetObject,returnTime,defaultDate,sourceObject){
   ...
   if((defaultDate==undefined) || (defaultDate=="")){
    ...
    calendar.bottom.innerText = calendar.formatTime(calendar.today[3])+":"+calendar.formatTime(calendar.today[4])+":"+"00";
    ...
    if(defaultDate.match(Datereg)) defaultDate=defaultDate+" "+calendar.today[3]+":"+calendar.today[4]+":"+"00";
  ...
  this.insertBodyCell=function(theRow,j,day,targetObject){
   ...
   theCell.onclick=function(){
     if(calendar.returnTime)  
     calendar.sltDate=calendar.currentDate[0]+"-"+calendar.formatTime(calendar.currentDate[1])+"-"+calendar.formatTime(day)+" "+calendar.formatTime(calendar.currentDate[3])+":"+calendar.formatTime(calendar.currentDate[4])+":"+"00";
