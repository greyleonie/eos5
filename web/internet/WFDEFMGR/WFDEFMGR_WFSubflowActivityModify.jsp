...
<html:hidden property="tab" />
	 ...
	 <eos:tab id="test"  width="100%" height="100%" imgPath="/internet/WFCOMMON/images/tab0">
	    ...
	    <eos:tabcontent  style="tabstyle">
    		<eos:contentitem><%@include file="WFDEFMGR_WFSubflowActivityModify_Tab1.jsp"%></eos:contentitem>
 		<eos:contentitem><%@include file="WFDEFMGR_WFSubflowActivityModify_Tab2.jsp"%></eos:contentitem>
 		<eos:contentitem><%@include file="WFDEFMGR_WFSubflowActivityModify_Tab3.jsp"%></eos:contentitem>
	    </eos:tabcontent>
	</eos:tab>
