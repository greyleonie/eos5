   		 ...
   		 <eos:tab id="test"  width="100%" height="100%" imgPath="/internet/WFCOMMON/images/tab0">
    		    <eos:tabtitle>
     		    ...
     		    <eos:tabcontent style="tabstyle">
            		<eos:contentitem><%@include file="WFDEFMGR_WFProcessDefineDetail_Tab1.jsp"%></eos:contentitem>
         			<eos:contentitem><%@include file="WFDEFMGR_WFProcessDefineDetail_Tab2.jsp"%> </eos:contentitem>
					<eos:contentitem><%@include file="WFDEFMGR_WFProcessDefineDetail_Tab3.jsp"%> </eos:contentitem>
       		    </eos:tabcontent>
    		</eos:tab>
<display:pageTail/>
