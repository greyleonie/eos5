...
<table width="100%"  cellpadding="0"  cellspacing="0"  class="gridtable">
  ...
  <tr id="hide_1">
      ...
      <html:hidden property="WFProcessDefineXML/Process/timeLimitStrategy"/>
      	自定义时间限制<html:radio  name="r1" property="WFProcessDefineXML/Process/timeLimitStrategy" value="limit_strategy_designate" onclick="javascript:handleFinish('r1');"/>
      </td>     
  ...
  <tr id="hide_2">
      <td class="queryLabelTD" width="30%">
        从相关数据获取时间限制<html:radio  name="r1" property="WFProcessDefineXML/Process/timeLimitStrategy" value="limit_strategy_reldata" onclick="javascript:handleFinish('r2');"/>
      </td> 
