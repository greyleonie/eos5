...
<html:hidden property="tab" />
	 ...
	 <eos:tab id="test"  width="100%" height="80%" imgPath="/internet/WFCOMMON/images/tab0">
		...
		<eos:contentitem><%@include file="WFDEFMGR_WFToolappActivityModify_Tab1.jsp"%></eos:contentitem>
		<eos:contentitem><%@include file="WFDEFMGR_WFToolappActivityModify_Tab2.jsp"%></eos:contentitem>
	    </eos:tabcontent>
	</eos:tab>
