...
function page() 
{
	...
	/*
	* 函数printPageCode1，printPageCode2，printPageCode3专为
	* eos5.1的页面控件而新增
	* 作者：陈春 2005-4-13
	*/
	function printPageCode1(currRowCount)
    {
        ...
        htmltxt += " 转到第<input type='text' name='pageno' size=2 value='"+this.current+"'>页 ";
	...
	function printPageCode2(currRowCount)
    {
        ...
        if(this.current>1){
        	htmltxt += " <input type='button' onclick='javascript:myPage.firstPage();' value='首页'/>";
        	htmltxt += " <input type='button' onclick='javascript:myPage.previousPage();' value='上页'/>";
        }
		else
		{
			htmltxt += " <input type='button' value='首页' disabled/>";
        	htmltxt += " <input type='button' value='上页' disabled/>";
		}
        ...
        if (!this.noCount){
	        ...
	        if (this.current<this.total ) {
	            htmltxt += " <input type='button' value='下页' onclick='javascript:myPage.nextPage();' />";
        		htmltxt += " <input type='button' value='尾页' onclick='javascript:myPage.lastPage();' />";
	        }
			else
			{
				htmltxt += " <input type='button' value='下页' disabled/>";
        		htmltxt += " <input type='button' value='尾页' disabled/>";
			}
    	}else{
