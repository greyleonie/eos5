...
时间		    修改人		说明
2006-10-30	冯长春		创建
2006-10-31  冯长春       增加中文字符串按拼音或者笔画排序
--------------------------------------------------------------------------- 
使用方法：
<table id="sortTable" >
<tr>
 <td onClick="talentsort()" title="点击排序" id="entity.tablefield">第1列</td>
 <td onClick="talentsort()" title="点击排序" id="entity.tablefield">第2列</td>
 <td onClick="talentsort()" title="点击排序" id="entity.tablefield">第3列</td>
 <td onClick="talentsort()" title="点击排序" id="entity.tablefield">第4列</td>
 <td onClick="talentsort()" title="点击排序" id="entity.tablefield">第5列</td>
</tr>
<tr>
......
</tr>
...
功能说明：排序,可以本页面数据排序，也可以在数据库服务器端排序

参数说明：
tablename: 要排序的table的ID
colIndex:	指定要排序的列
