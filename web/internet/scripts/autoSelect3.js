  ...
  function f_InitDivData(objInput) {
      ...
      if (!document.getElementById("dvAddListContainer")) {
        ...
        if (document.all && !g_IgnoreIE) {
          ...
          tDiv.innerHTML = '<iframe id="ifAddList" onfocus="f_SetDivDisplay(true)" onblur="f_SetDivDisplay(false)"   src="oa.prAssetsManage.prAssetsSelectTree.do" scrolling="auto" marginwidth="0" marginheight="0" frameborder="1" height="100%" width="100%" > </iframe>';
        }
