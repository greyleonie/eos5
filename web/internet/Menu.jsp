 ...
 <form name="form1" method="post" action="">
  <tr>
	...
	<table  border="0" align="left" cellpadding="0" cellspacing="0" onClick="test(this)" id="eosmenutable">
      <tr align="center"> 
      	<qx:talentModule moduleID="DX_OASYS">
	        ...
	        <td  nowrap="nowrap" width="75" class="button" id="DX_OASYS">办公系统</td>
	        </a>
        </qx:talentModule>
        
        <qx:talentModule moduleID="DX_TEACH_MANAGE">
	        <a href="common.pr.menutext.do?TEOSMENU/parentsid=DX_TEACH_MANAGE" target="bodyframe">
	        <td nowrap="nowrap" width="75" class="button" id="DX_TEACH_MANAGE">教务管理</td>
	        </a>
        </qx:talentModule>
        ...
        <qx:talentModule moduleID="DX_STUENT_MANAGE">
	        ...
	        <td nowrap="nowrap" width="75" class="button" id="DX_STUENT_MANAGE">学员管理</td>
	        </a> 
        </qx:talentModule>
      	...
      	<qx:talentModule moduleID="DX_OASYS_RESEARCHMANAGE">
	        ...
	        <td  nowrap="nowrap" width="75" class="button" id="DX_OASYS_RESEARCHMANAGE">科研管理</td>
	        </a>
        </qx:talentModule>
        
        <qx:talentModule moduleID="DX_CARD_MANAGE">
	        <a href="common.pr.menutext.do?TEOSMENU/parentsid=DX_CARD_MANAGE" target="bodyframe">
	        <td nowrap="nowrap" width="75" class="button" id="DX_CARD_MANAGE">一 卡 通</td>
			</a>
		</qx:talentModule>
		 ...
		 <qx:talentModule moduleID="DX_NETCENTER_MANAGE">
	        ...
	        <td nowrap="nowrap" width="75" class="button" id="DX_NETCENTER_MANAGE">网络中心</td>
			</a>
		</qx:talentModule>
		...
		<qx:talentModule moduleID="DX_OMMSYS">
	        ...
	        <td nowrap="nowrap" width="75" class="button" id="DX_OMMSYS">运维管理</td>
	        </a>
        </qx:talentModule>
		...
		<qx:talentModule moduleID="DX_SYSTEM_MANAGE">
	        ...
	        <td nowrap="nowrap" width="75" class="button" id="DX_SYSTEM_MANAGE">系统管理</td>
	        </a>
        </qx:talentModule>
        </tr>
    </table>
    ...
    <td align="right">      <table  border="0" align="right" cellpadding="0" cellspacing="0">
        <tr>
          <td width="100%" align="right" nowrap="nowrap"><!--<IMG src="/internet/ShareImage/37665164-small.gif" height="25px"/><a href="oa.prNews.noticeView.do?pageID=2&fid=1030" alt="自动语音故障申报系统" target="main"   >自动语音故障申报系统.Tel:37665164</a>-->&nbsp;&nbsp;<span class="text_red">当前用户：<bean:write property="SessionEntity/userName" formatClass="username" formatType="userid"/></span>&nbsp;<span class="text" id="currentTime"><script>setCalendar()</script> </span></td>
        </tr>
      </table></td>
