...
function writeIframe()
{
    ...
    "td#meizzYearHead, td#meizzYearMonth{color: "+ parent.top.main.WebCalendar.wordColor +"}"+
    ...
    "var drag=false, cx=0, cy=0, o = parent.top.main.WebCalendar.calendar; function document.onmousemove(){"+
    "if(parent.top.main.WebCalendar.drag && drag){if(o.style.left=='')o.style.left=0; if(o.style.top=='')o.style.top=0;"+
    "o.style.left = parseInt(o.style.left) + window.event.clientX-cx;"+
    "o.style.top  = parseInt(o.style.top)  + window.event.clientY-cy;}}"+
    "function document.onkeydown(){ switch(window.event.keyCode){  case 27 : parent.top.main.hiddenCalendar(); break;"+
    "case 37 : parent.top.main.prevM(); break; case 38 : parent.top.main.prevY(); break; case 39 : parent.top.main.nextM(); break; case 40 : parent.top.main.nextY(); break;"+
    "case 84 : document.forms[0].today.click(); break;} window.event.keyCode = 0; window.event.returnValue= false;}"+
    "function dragStart(){cx=window.event.clientX; cy=window.event.clientY; drag=true;}</scr"+"ipt>"}
    strIframe += "<select name=tmpYearSelect  onblur='parent.top.main.hiddenSelect(this)' style='z-index:1;position:absolute;top:3;left:18;display:none'"+
    " onchange='parent.top.main.WebCalendar.thisYear =this.value; parent.top.main.hiddenSelect(this); parent.top.main.writeCalendar();'></select>"+
    "<select name=tmpMonthSelect onblur='parent.top.main.hiddenSelect(this)' style='z-index:1; position:absolute;top:3;left:74;display:none'"+
    " onchange='parent.top.main.WebCalendar.thisMonth=this.value; parent.top.main.hiddenSelect(this); parent.top.main.writeCalendar();'></select>"+
    "<table id=tableMain class=bg border=0 cellspacing=2 cellpadding=0>"+
    "<tr><td width=140 height=19 bgcolor='"+ WebCalendar.lightColor +"'>"+
    "    <table width=140 id=tableHead border=0 cellspacing=1 cellpadding=0><tr align=center>"+
    "    <td width=15 height=19 class=bg title='向前翻 1 月&#13;快捷键：←' style='cursor: hand' onclick='parent.top.main.prevM()'><b>&lt;</b></td>"+
    "    <td width=60 id=meizzYearHead  title='点击此处选择年份' onclick='parent.top.main.funYearSelect(parseInt(this.innerText, 10))'"+
    "        onmouseover='this.bgColor=parent.top.main.WebCalendar.darkColor; this.style.color=parent.top.main.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.top.main.WebCalendar.lightColor; this.style.color=parent.top.main.WebCalendar.wordColor'></td>"+
    "    <td width=50 id=meizzYearMonth title='点击此处选择月份' onclick='parent.top.main.funMonthSelect(parseInt(this.innerText, 10))'"+
    "        onmouseover='this.bgColor=parent.top.main.WebCalendar.darkColor; this.style.color=parent.top.main.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.top.main.WebCalendar.lightColor; this.style.color=parent.top.main.WebCalendar.wordColor'></td>"+
    "    <td width=15 class=bg title='向后翻 1 月&#13;快捷键：→' onclick='parent.top.main.nextM()' style='cursor: hand'><b>&gt;</b></td></tr></table>"+
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         " type=button value='&nbsp; &nbsp; 关闭' onclick='parent.top.main.hiddenCalendar()'></td></tr></table>"+
    "</td></tr><tr><td height=20 width=140 bgcolor='"+ WebCalendar.lightColor +"'>"+
    "    <table border=0 cellpadding=1 cellspacing=0 width=140>"+
    "    <tr><td><input name=prevYear title='向前翻 1 年&#13;快捷键：↑' onclick='parent.top.main.prevY()' type=button value='&lt;&lt;'"+
    "    onfocus='this.blur()' style='meizz:expression(this.disabled=parent.top.main.WebCalendar.thisYear==1000)'><input"+
    "    onfocus='this.blur()' name=prevMonth title='向前翻 1 月&#13;快捷键：←' onclick='parent.top.main.prevM()' type=button value='&lt;&nbsp;'>"+
    "    </td><td align=center><input name=today type=button value='今天' onfocus='this.blur()' style='width: 50' title='当前日期&#13;快捷键：T'"+
    "    onclick=\"parent.top.main.returnDate(new Date().getDate() +'/'+ (new Date().getMonth() +1) +'/'+ new Date().getFullYear())\">"+
    "    </td><td align=right><input title='向后翻 1 月&#13;快捷键：→' name=nextMonth onclick='parent.top.main.nextM()' type=button value='&nbsp;&gt;'"+
    "    onfocus='this.blur()'><input name=nextYear title='向后翻 1 年&#13;快捷键：↓' onclick='parent.top.main.nextY()' type=button value='&gt;&gt;'"+
    "    onfocus='this.blur()' style='meizz:expression(this.disabled=parent.top.main.WebCalendar.thisYear==9999)'></td></tr></table>"+
