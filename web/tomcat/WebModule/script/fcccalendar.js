...
function writeIframe(parent)	//对iframe进行初始化
{
	...
	*/
    ...
    "<tr><td>"+
    "<table width=180 height=30 id=tableHead border=0 cellspacing=0 cellpadding=0 background='/image/TaskBarBG.gif' bgcolor='#255FDC'><tr align=center>"+
	"<td><image class='operate' src='/image/_calprevyr.gif' title='向前翻 1 年&#13;快捷键：↑' onclick='parent.prevY()' onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==1000)'></td>" + 
	"<td><image class='operate' src='/image/_calprevmm.gif' onfocus='this.blur()' title='向前翻 1 月&#13;快捷键：←' onclick='parent.prevM()'>"+
    "</td>"+
    "<td width=60 class='operate' id=meizzYearHead  title='点击此处选择年份' onclick='parent.funYearSelect(parseInt(this.innerText, 10))'"+
	"</td><td width=15>年</td>"+
    "<td width=60 class='operate' id=meizzYearMonth title='点击此处选择月份' onclick='parent.funMonthSelect(parseInt(this.innerText, 10))'"+
	"</td><td width=15>月</td>"+
	"<td align=right><image class='operate' src='/image/_calnextmm.gif' title='向后翻 1 月&#13;快捷键：→' onclick='parent.nextM()' onfocus='this.blur()'></td>"+
	"<td><image class='operate' src='/image/_calnextyr.gif' title='向后翻 1 年&#13;快捷键：↓' onclick='parent.nextY()' onfocus='this.blur()' style='meizz:expression(this.disabled=parent.WebCalendar.thisYear==9999)'></td></tr>"+
	"<tr><td colspan=8 width=180 height=2 background='/image/progressBar.gif'></td></tr>"+
	"</table></td></tr>"+
	...
	*/
	...
	strIframe +="<tr><td height=30 width=180>"+
		...
		"<a href='javascript:parent.returnCurDate();' id='today' onfocus='this.blur()' title='当前日期&#13;快捷键：T'>"+
		"<font color='#444444' style='font-size:12px; font-weight:bold;'>今天</font></a></td>"+
		"<td align=center><a href='javascript:parent.hiddenCalendar();' onfocus='this.blur()' title='关闭快捷键:X'>"+
		"<font color='#444444' style='font-size:12px;'>取消</font></a></td>"+ 
		"<td align=center><a href='javascript:parent.clear()'>"+
		"<font color='#444444' style='font-size:12px;'>清空</font></a></td>"+ 
