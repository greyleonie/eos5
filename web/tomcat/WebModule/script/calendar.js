...
function atCalendarControl(){
  ...
  this.addCalendarPad=function(){
   document.write("<div id='divCalendarpad' style='position:absolute;top:100;left:0;width:255;height:167;display:none;z-index:4;'>");
  ...
  /************** 设置各功能按钮的功能 *********************/
   ...
   calendar.calendarAbout=calendar.insertTbCell(trRow,0,"清空","center");
   ...
   calendar.prevMonth.onmousedown=function(){
    ...
    calendar.show(calendar.target,
        calendar.currentDate[0]+"-"+
        (parseInt(calendar.currentDate[1])>=10?parseInt(calendar.currentDate[1]):"0"+parseInt(calendar.currentDate[1]))+"-"+
        (parseInt(calendar.currentDate[2])>=10?parseInt(calendar.currentDate[2]):"0"+parseInt(calendar.currentDate[2])),
        calendar.source);
   }
   ...
   calendar.goToday.onclick=function(){
    ...
    calendar.sltDate=calendar.today[0]+"-"+
        (parseInt(calendar.today[1])>=10?parseInt(calendar.today[1]):"0"+parseInt(calendar.today[1]))+"-"+
        (parseInt(calendar.today[2])>=10?parseInt(calendar.today[2]):"0"+parseInt(calendar.today[2]));
   ...
   calendar.nextMonth.onmousedown=function(){
    ...
    calendar.show(calendar.target,calendar.currentDate[0]+"-"+
        (parseInt(calendar.currentDate[1])>=10?parseInt(calendar.currentDate[1]):"0"+parseInt(calendar.currentDate[1]))+
        "-"+(parseInt(calendar.currentDate[2])>=10?calendar.currentDate[2]:"0"+parseInt(calendar.currentDate[2])),
        calendar.source);
   }
  ...
  this.show=function(targetObject,defaultDate,sourceObject){
   ...
   if(defaultDate==undefined || defaultDate==""){
    ...
    calendar.head.innerText = calendar.today[0]+"-"+
        (parseInt(calendar.today[1])>=10?parseInt(calendar.today[1]):"0"+parseInt(calendar.today[1]))+"-"+
        (parseInt(calendar.today[2])>=10?parseInt(calendar.today[2]):"0"+parseInt(calendar.today[2]));
  ...
  this.about=function(){
   ...
   popHtml+="版本: v1.0<BR>日期: 2007-03-13";
   ...
   strAbout+=">\t: 下一月\n";
   strAbout+="<<\t: 下一年\n";
   strAbout+="\nAgetimeCalendar\nVersion:v1.0\nDesigned By:暂停打印 2007-03-16  afos_koo@hotmail.com \n";
   //alert(strAbout);
  }
