...
<%
  ...
  sql = "select a.CourseID,a.ClassID,a.CourseTitle,a.ClassDate,a.ClassTime,ISNULL(a.Teachers,'') TeacherId,"
      ...
      + "when datepart(hh,a.ClassTime)>10 and datepart(hh,a.ClassTime)<18 then "
                          ...
                          <table width="100%" border="0" cellPadding="0" cellSpacing="0" align="center">
                              ...
                              <%
                                ...
                                for (int i=0;i<levels.size();i++) {
                                     ...
                                     if (( (ctime.before(now) && !cdate.equals(sdf.format(now))) || (now.after(closeTime) && now.before(endTime)) ) && (kaoqin>0)) {
                                    
                                     if (mark != null && mark.size()>0) {
                                        out.println("<td align='center' width='5px'><INPUT type='checkbox' value='iid="+itemId+"&levid="+levId+"&tid="+tid+"' name='f"+k+"_i"+j+"_l"+i+"' id='f"+k+"_i"+j+"_l"+i+"' onclick=checkInput('f"+k+"','i"+j+"','"+i+"','"+levLen+"') checked></td>");
                                     } else {
                                        ...
                                        out.println("<td align='center' width='5px'><INPUT type='checkbox'  name='f"+k+"_i"+j+"_l"+i+"' id='f"+k+"_i"+j+"_l"+i+"' onclick=checkInput('f"+k+"','i"+j+"','"+i+"','"+levLen+"') disabled='true'></td>");
                                     }
                                } %>
                              </tr>
                          </table>
