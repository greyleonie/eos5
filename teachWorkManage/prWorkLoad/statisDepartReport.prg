...
<autoGraphics>
    <graphic name="statisDepartReport" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="354" y="170" lookAndFeel="classic">
...
@description 导出按部门统计工作量</value>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.statisDepartView</column>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>按部门统计导出页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/statisDepartReport.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
