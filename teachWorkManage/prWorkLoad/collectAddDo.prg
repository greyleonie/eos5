...
<autoGraphics>
    <graphic name="collectAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="33" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>voExist.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/voExist.jsp</column>
            ...
            <state color="16777215" id="29" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.collectAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="26" typeName="annotate" height="100" width="191" x="425" y="230" lookAndFeel="classic">
