...
<autoGraphics>
    <graphic name="statisTeacherView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="558" y="170" lookAndFeel="classic">
...
@description 按教师来统计工作量</value>
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.statisTeacherView</column>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>按教师统计工作量</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/statisTeacherView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="12" typeName="setField" height="48" width="48" x="176" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.selectTeachGroup</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
