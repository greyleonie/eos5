...
<autoGraphics>
    <graphic name="collectModifyDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="26" typeName="annotate" height="100" width="191" x="216" y="239" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-2-8 下午3:52</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 工作量修改完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="30" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prWorkLoad.collectList</column>
            ...
            <state color="16777215" id="34" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.collectModifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">NumField</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">ClassField</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="35" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/voFail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
