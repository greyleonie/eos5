...
<autoGraphics>
    <graphic name="statisWorkLoad" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">statisWorkLoad</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>statisWorkLoad</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Feb 12 11:20:00 CST 2007</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>统计上课 与批改文章，试卷等的工作量</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.statisWorkLoad</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/statisWorkLoad.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="203" x="316" y="243" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-2-12 上午11:22</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 统计上课 与批改文章，试卷等的工作量</value>
                    </property>
                </propertyList>
                <description/>
            </state>
