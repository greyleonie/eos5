...
<autoGraphics>
    <graphic name="convertAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="29" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="17" typeName="annotate" height="100" width="203" x="419" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-30 下午5:02</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 工作量标准增加</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="26" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.convertAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">WorkLoadConvert</column>
            ...
            <state color="16777215" id="28" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
