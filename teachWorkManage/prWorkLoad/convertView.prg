...
<autoGraphics>
    <graphic name="convertView" type="prg" router="0">
        <states>
...
@description 对工作量标准进行查看</value>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/convertView.jsp</column>
