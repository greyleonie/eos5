...
<autoGraphics>
    <graphic name="convertAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizWorkLoad.selectWorkType</column>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="291" y="138" lookAndFeel="classic">
...
@description 显示工作标准录入页面</value>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/WorkLoad/convertAdd.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
