...
<autoGraphics>
    <graphic name="return2CurrentClass" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">return2CurrentClass</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>return2CurrentClass</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Apr 20 11:03:25 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="178" x="551" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-20 上午11:03</value>
                    </property>
                    <property name="text" type="0">
                        <value>把班级恢复为当前班级</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizClassInfoManage.return2CurrentClass</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="172" x="100" y="305" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">annotate</name>
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 上午9:39</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询当前班级</value>
                    </property>
