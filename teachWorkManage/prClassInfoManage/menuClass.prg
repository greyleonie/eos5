...
<autoGraphics>
    <graphic name="menuClass" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>menu_banji.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/classInfo/menu_banji.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">menuClass</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>menuClass</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Dec 21 14:38:12 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="172" x="162" y="172" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 上午9:38</value>
                    </property>
                    <property name="text" type="0">
                        <value>班级管理左边的菜单</value>
                    </property>
                </propertyList>
                <description/>
            </state>
