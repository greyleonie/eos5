...
<autoGraphics>
    <graphic name="queryStudents" type="prg" router="0">
        <states>
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>studentList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/classInfo/studentList.jsp</column>
            ...
            <state color="16777215" id="16" typeName="setField" height="48" width="48" x="169" y="97" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">queryStudents</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>queryStudents</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 08 16:29:26 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="166" x="557" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-8 下午5:18</value>
                    </property>
                    <property name="text" type="0">
                        <value>在班级管理处查询学员</value>
                    </property>
                </propertyList>
                <description/>
            </state>
