    ...
    <graphic name="classInfoManage" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="19" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>classInfoManage.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/classInfo/classInfoManage.jsp</column>
            ...
            <state color="16777215" id="20" typeName="annotate" height="100" width="172" x="163" y="208" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 上午9:36</value>
                    </property>
                    <property name="text" type="0">
                        <value>进入班级管理页面 </value>
                    </property>
                </propertyList>
                <description/>
            </state>
