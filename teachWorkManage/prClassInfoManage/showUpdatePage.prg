...
<autoGraphics>
    <graphic name="showUpdatePage" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">showUpdatePage</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>showUpdatePage</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 11:34:23 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>updateStuNum.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/classInfo/updateStuNum.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="172" x="100" y="180" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 上午9:44</value>
                    </property>
                    <property name="text" type="0">
                        <value>修改学员人数的页面 </value>
                    </property>
                </propertyList>
                <description/>
            </state>
