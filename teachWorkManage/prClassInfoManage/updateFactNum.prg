...
<autoGraphics>
    <graphic name="updateFactNum" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">updateFactNum</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>updateFactNum</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 15:46:21 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizClassInfoManage.updateFactNum</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="172" x="115" y="314" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 上午9:47</value>
                    </property>
