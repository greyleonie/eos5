...
<autoGraphics>
    <graphic name="subjectBid" type="prg" router="0">
        <states>
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="176" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>课题中标显示页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SubjectDeclare/subjectBid.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="536" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>提示页面</value>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subjectBid</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>subjectBid</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jun 27 10:28:08 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="416" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSubjectDeclare.subjectBid</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="662" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>显示课题中标显示信息，如果信息不存在，作出提示</value>
                    </property>
                </propertyList>
                <description/>
            </state>
