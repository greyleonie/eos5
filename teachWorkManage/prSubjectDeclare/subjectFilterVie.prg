...
<autoGraphics>
    <graphic name="subjectFilterVie" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSubjectDeclare.subjectFilterVie</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subjectFilterVie</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>subjectFilterVie</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jun 26 13:54:35 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="357" y="304" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>定为竞课名单，将需要筛选的课题确定为竞课状态，并返回到课题筛选页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
