...
<autoGraphics>
    <graphic name="subjectFilter" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="544" y="181" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SubjectDeclare/subjectDeclareMsg.jsp</column>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>课题筛选页面</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SubjectDeclare/subjectFilter.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSubjectDeclare.subjectFilter</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">SubjectDeclare</column>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSubjectDeclare.subjectDeclareAll</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">SubjectDeclare/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">SubjectPlate/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subjectFilter</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 25 18:07:13 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="523" y="392" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-23 下午3:17</value>
                    </property>
                    <property name="text" type="0">
                        <value>课题筛选，显示所有课题申报后的课题，可以根据部门和板块显示。</value>
                    </property>
                </propertyList>
                <description/>
            </state>
