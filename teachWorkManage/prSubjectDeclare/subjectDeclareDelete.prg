...
<autoGraphics>
    <graphic name="subjectDeclareDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="sub" height="48" width="48" x="296" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>课题筛选页面</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prSubjectDeclare.subjectFilter</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="176" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSubjectDeclare.subjectDeclareDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subjectDeclareDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>subjectDeclareDelete</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jun 27 17:19:52 CST 2007</value>
                    </property>
                    ...
                    <property name="description" type="0">
                        <value>删除课题申报，根据状态来返回相应页面</value>
                    </property>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="523" y="392" lookAndFeel="classic">
