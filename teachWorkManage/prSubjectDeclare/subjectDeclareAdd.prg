...
<autoGraphics>
    <graphic name="subjectDeclareAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>新增申报以及板块页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SubjectDeclare/subjectDeclareAdd.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">SubjectDeclare/DeclareID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subjectDeclareAdd</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>subjectDeclareAdd</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jun 22 15:02:32 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="542" y="190" lookAndFeel="classic">
