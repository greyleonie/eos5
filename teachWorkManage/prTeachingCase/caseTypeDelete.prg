...
<autoGraphics>
    <graphic name="caseTypeDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.caseTypeDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="14" typeName="sub" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prTeachingCase.caseTypeList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="15" typeName="annotate" height="78" width="191" x="505" y="201" lookAndFeel="classic">
