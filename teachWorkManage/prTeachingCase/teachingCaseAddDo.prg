...
<autoGraphics>
    <graphic name="teachingCaseAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="sub" height="48" width="48" x="416" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>新增案例时初始化数据</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.teachingCaseSetInit</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="9" typeName="annotate" height="98" width="178" x="551" y="231" lookAndFeel="classic">
