...
<autoGraphics>
    <graphic name="teachingCaseDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="136" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.teachingCaseDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="14" typeName="sub" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>teachingCaseList</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prTeachingCase.teachingCaseList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">userdelete</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Wed Dec 27 13:32:43 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="256" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="203" x="499" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-31 下午5:11</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 陈绍栋&#13;
@description 删除教案</value>
                    </property>
                </propertyList>
                <description/>
            </state>
