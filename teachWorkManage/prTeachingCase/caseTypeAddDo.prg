...
<autoGraphics>
    <graphic name="caseTypeAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sub</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>caseTypeList</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.caseTypeAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">CaseType</column>
            ...
            <state color="16777215" id="13" typeName="annotate" height="87" width="191" x="425" y="237" lookAndFeel="classic">
