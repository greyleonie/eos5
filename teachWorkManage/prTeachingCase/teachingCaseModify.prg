...
<autoGraphics>
    <graphic name="teachingCaseModify" type="prg" router="0">
        <states>
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>teachingCaseModify.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachingCase/teachingCaseModify.jsp</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.teachingCaseModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="213" x="654" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-31 上午9:30</value>
                    </property>
                    <property name="text" type="0">
                        <value>author 陈绍栋&#13;
description 修改教学案例</value>
                    </property>
                </propertyList>
                <description/>
            </state>
