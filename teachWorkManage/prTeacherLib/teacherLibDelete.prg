...
<autoGraphics>
    <graphic name="teacherLibDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="576" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="136" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeacherLib.TeacherLibDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prTeacherLib.teacherLibList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="Start" height="48" width="48" x="136" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherDelete</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jun 20 10:04:34 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="502" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-18 下午3:24</value>
                    </property>
                    <property name="text" type="0">
                        <value>删除在职本校教师，列为不在职状态</value>
                    </property>
                </propertyList>
                <description/>
            </state>
