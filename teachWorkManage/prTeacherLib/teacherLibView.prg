...
<autoGraphics>
    <graphic name="teacherLibView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/TeacherLib/teacherLibView.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherLibView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherLibView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 18 15:49:08 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="375" y="259" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-18 下午4:14</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询教师信息，进入本校教师查看页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
