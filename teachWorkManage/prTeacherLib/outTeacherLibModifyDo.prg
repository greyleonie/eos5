...
<autoGraphics>
    <graphic name="outTeacherLibModifyDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeacherLib.outTeacherLibModifyDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">outTeacherLibModifyDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>outTeacherLibModifyDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jun 18 18:19:02 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="197" x="411" y="335" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-18 下午4:51</value>
                    </property>
                    <property name="text" type="0">
                        <value>对外请教师修改处理，并返回外请教师列表页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
