...
<autoGraphics>
    <graphic name="teacherLibAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>本校教师新增页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/TeacherLib/teacherLibAdd.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teacherLibAdd</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teacherLibAdd</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jun 19 09:59:20 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="197" x="466" y="280" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-7-18 下午3:15</value>
                    </property>
                    <property name="text" type="0">
                        <value>进入本校教师的新增页面，通过选择本校所有职员来选取在职教师，再对教师作相应的信息添加。</value>
                    </property>
                </propertyList>
                <description/>
            </state>
