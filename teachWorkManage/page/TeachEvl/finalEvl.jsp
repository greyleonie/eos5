...
<%
  ...
  String title="",explain="",remarks="",deadline="";
  ...
  //读取评估表信息
  String sql = "select top 1 * from Evaluation where ClassType='1' and Period='期末' order by version desc";
		  ...
		  <td><table id="allCourse" width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000000">
            ...
            <tr>
              ...
              <td width="42%" align="center" bgcolor="#FFFFFF">
                <textarea name="item<%=itemId%>_suggest" cols="42" rows="5"><%=suggest%></textarea>
              </td>
              <% } %>
            </tr>
            <% } %>
