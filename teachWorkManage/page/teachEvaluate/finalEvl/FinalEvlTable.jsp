...
var j = 0;
var evlId = "";
var path = "teachWorkManage.prTeachEvaluate.prFinalEvlModify.do?EvaluationID=";
...
var evlId = "";
var nofix = "";
var path = "teachWorkManage.prTeachEvaluate.prFinalListDel.do?Evaluation/ClassType=1&Evaluation/Period=期末";
...
function add_evl() {
   if (confirm("确认新增一个主体班期末评估表吗？"))
      window.location.href = 'teachWorkManage.prTeachEvaluate.prFinalEvlAdd.do?Evaluation/ClassType=1&Evaluation/Period=期末&status=add';
}

function dispView(evlId) {
   window.location.href = "teachWorkManage.prTeachEvaluate.prFinalEvlView.do?EvaluationID=" + evlId;
}
...
<body>
<form method="post" action="teachWorkManage.prTeachEvaluate.prFinalEvlList.do">
<input type="hidden" name="dataEntity/_order/col1/field" value="me">
<input type="hidden" name="dataEntity/_order/col1/asc" value="ASC">
<html:hidden property="Evaluation/ClassType" value="1"/>
<html:hidden property="Evaluation/Period" value="期末"/>
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td id="printTable" class="text_wirte">首页—&gt;教务管理—&gt;教学质量评估—&gt;主体班期末评估表设置</td>
          </tr>
      </table></td>
    </tr>
  </table>
	  ...
	  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" class="text">&nbsp;&nbsp;
              <qx:talentButton property="add_button" type="button" styleClass="button_02" value="新增" onclick="add_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl_Add"/>
              <qx:talentButton property="modify_button" type="button" styleClass="button_02" value="修改" onclick="modify_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl_Modify"/>
              <qx:talentButton property="del_button" type="button" styleClass="button_02" value="删除" onclick="del_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl_Del"/>
              <qx:talentButton property="del_button" type="button" styleClass="button_03" value="选择适用班级" onclick="selectClasses();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_FinalEvl_Del"/>
              <input name="print_button" type="button" class="button_02" value="打 印" onClick="iePrint()">
              <input type="hidden" name="queryaction" value="teachWorkManage.prTeachEvaluate.prFinalEvlList.do?Evaluation/ClassType=1&Evaluation/Period=期末">
