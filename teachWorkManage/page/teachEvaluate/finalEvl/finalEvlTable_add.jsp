...
<input type="hidden" id="courseItemAction" value="teachWorkManage.prTeachEvaluate.prAddFinalItem.do">
<input type="hidden" id="courseLevAction" value="teachWorkManage.prTeachEvaluate.prAddFinalLev.do">
    ...
    <tr>
      <td height="24" background="../../image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;教学质量评估—&gt;维护期末学员意见反馈表</td>
          </tr>
      </table></td>
    </tr>
  </table>
		...
		<tr>
		  ...
		  <table id="allCourse" width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000000">
            <tr id="allCourse_item0_tr">
              <td id="allCourse_lev0_td" width="20%" bgcolor="#FFFFFF"> &nbsp;&nbsp;满意程度
...
if (version==null) location.href="teachWorkManage.prTeachEvaluate.prFinalEvlList.do";
else {
   path = path + "Evaluation/EvaluationID=" + evlId + "&Evaluation/Version=" + version;
   document.getElementById("modifyframe").src = path;
   setTimeout("location.href='teachWorkManage.prTeachEvaluate.prFinalEvlList.do';",3000);
}
}
...
if (status == 'add') {
   ...
   if (confirm("确定取消新增当前主体班期末评估表吗？")) location.href = path;
} else {
   location.href='teachWorkManage.prTeachEvaluate.prFinalEvlList.do';
}
}
</script>
</body>