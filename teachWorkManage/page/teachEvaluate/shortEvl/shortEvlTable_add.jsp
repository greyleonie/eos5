    ...
    <tr>
      <td height="24" background="../../image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;教学质量评估—&gt;维护短班综合评估表</td>
          </tr>
      </table></td>
    </tr>
  </table>
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="text" valgin="top"><table width="100%" border="0" cellspacing="10" cellpadding="0">
        ...
        <tr>
          <td><span class="STYLE6">&nbsp;&nbsp;&nbsp;&nbsp;二、您对本期班各方面的评价</span>
		...
		<tr>
		  ...
		  <table id="allCourse" width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000000">
            <tr id="allCourse_item0_tr">
              <td id="allCourse_lev0_td" width="15%" bgcolor="#FFFFFF"> &nbsp;&nbsp;满意程度
...
if (status == 'add') {
   ...
   if (confirm("确定取消新增当前短班评估表吗？")) location.href = path;
} else {
