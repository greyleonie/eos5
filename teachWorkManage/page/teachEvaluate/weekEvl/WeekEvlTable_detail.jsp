...
String begin = base.util.TalentContext.getValue(pageContext,null,"begin").replace('.','-');
String end = base.util.TalentContext.getValue(pageContext,null,"end").replace('.','-');
...
<SPAN class="STYLE5"><bean:write property="Class/ClassName"/>（第<bean:write property="week"/>周：<%=formto%>）</SPAN><BR>
<div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<bean:write property="Evaluation/Remarks"/></div>
</TD>
			</TR>
			<TR>
				<TD valign="top" class="text">
					<TABLE width="100%" cellPadding="1" height="100%" border="0" cellSpacing="1" id="weekEvl" bgColor="#000000">
						<TBODY>
							<TR>
								<TD align="center" width="120" valign="middle" bgColor="#ffffff">
									教师及课题<BR>（辅导课）></TD>
										...
										<TBODY>
											<TR>
											  ...
											  <% fdkLen++; 
												...
												<TD align="center" rowspan="2" id="tutorship_suggest" bgColor="#ffffff">具体意见和建议</TD>
												</logic:equal>
											</TR>
											<TR>
											  <% fdkLen = 0; %>
							...
							<TR>
								<TD width="120" bgColor="#ffffff"><bean:write id="fdk" property="fdks/TeacherName"/>老师 ：<BR>
							...
							<TR>
								<TD align="center" width="120" valign="middle" bgColor="#ffffff">教师及课题<BR>
									（互动式教学）</TD>
								<TD width="880" valign="top" align="center" bgColor="#ffffff">
										...
										<TBODY>
											<TR>
											  ...
											  <% hdkLen++; 
												...
												<logic:equal property="Evaluation/IsNeedAdvice" value="1">
												<TD align="center" rowspan="2" id="active_suggest" bgColor="#ffffff">具体意见和建议</TD>
												</logic:equal>
											</TR>
											<TR>
											  <% hdkLen = 0; %>
							...
							<TR>
								<TD align="center" bgColor="#ffffff"><bean:write id="hdk" property="hdks/TeacherName"/>老师 ：<BR>
