...
winstr += "<tr><td align='center' background='images/xx_2.jpg'><input type='image' src='images/yyd.jpg' onClick=window.parent.document.getElementById('tmpwindow').src='oa.prPersonOffice.readNotes.do';parent.hidePopup();></td></tr>";
