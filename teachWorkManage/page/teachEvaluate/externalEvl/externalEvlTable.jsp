...
var j = 0;
var evlId = "";
var path = "teachWorkManage.prTeachEvaluate.prExtraEvlModify.do?EvaluationID=";
...
function add_evl() {
   if (confirm("确认新增一个外请课评估表吗？"))
      window.location.href = 'teachWorkManage.prTeachEvaluate.prExtraEvlAdd.do?Evaluation/ClassType=1&Evaluation/Period=外请课&status=add';
}

function dispView(evlId) {
   window.location.href = "teachWorkManage.prTeachEvaluate.prExtraEvlView.do?EvaluationID=" + evlId;
}
...
<body>
<form method="post" action="teachWorkManage.prTeachEvaluate.prExtraEvlList.do">
...
<html:hidden property="Evaluation/Period" value="外请课"/>
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td id="printTable" class="text_wirte">首页—&gt;教务管理—&gt;教学质量评估—&gt;外请课评估表设置</td>
          </tr>
      </table></td>
    </tr>
  </table>
	  ...
	  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="30" class="text">&nbsp;
              <qx:talentButton property="add_button" type="button" styleClass="button_02" value="新增" onclick="add_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl_Add"/>
              <qx:talentButton property="modify_button" type="button" styleClass="button_02" value="修改" onclick="modify_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl_Modify"/>
              <qx:talentButton property="del_button" type="button" styleClass="button_02" value="删除" onclick="del_evl();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl_Del"/>
              <qx:talentButton property="del_button" type="button" styleClass="button_03" value="选择适用班级" onclick="selectClasses();" operation="DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl.DX_TEACH_MANAGE_TeachEvl_EvlSetup_ExtraEvl_Del"/>
              <input name="print_button" type="button" class="button_02" value="打 印" onClick="iePrint()">
              <input type="hidden" name="queryaction" value="teachWorkManage.prTeachEvaluate.prExtraEvlList.do?Evaluation/ClassType=1&Evaluation/Period=外请课">
