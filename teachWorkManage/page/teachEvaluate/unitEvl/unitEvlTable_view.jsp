    ...
    <tr>
      <td height="24" background="../../image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;教学质量评估—&gt;主体班单元评估表</td>
          </tr>
      </table></td>
    </tr>
  </table>
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="20" align="center">
	    ...
	    <div align="left" class="STYLE5">各位学员：<br>&nbsp;&nbsp;&nbsp;
		...
		<tr>
		  ...
		  <table id="allCourse" width="100%" border="0" cellpadding="1" cellspacing="1" bgcolor="#000000">
            <tr id="allCourse_item0_tr">
              <td id="allCourse_lev0_td" width="28%" bgcolor="#FFFFFF"> &nbsp;&nbsp;评价等次("A"为好，"D"为差)
                <br />评<br />价<br />项
              <% int levLen = 0; %>
              ...
              <td id="allCourse_item0_suggest" width="30%" align="center" bgcolor="#FFFFFF">意 见 与 建 议</td>
			  </logic:equal>
            </tr>
            <% int itemLen = 0; %>
            ...
            <tr id="allCourse_item<%=itemLen%>_tr">
              <td id="allCourse_item<%=itemLen%>_td" width="28%" height="45" align="center" bgcolor="#FFFFFF">
              ...
              <% } %>
			  <logic:equal property="Evaluation/IsNeedAdvice" value="1">
              <td id="allCourse_item<%=itemLen%>_suggest" width="30%" align="center" bgcolor="#FFFFFF">&nbsp;</td>
			  </logic:equal>
            </tr>
            </logic:iterate>
          </table></td>
