...
<form method="post" action="teachWorkManage.prTeacherLib.outTeacherLibModifyDo.do">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">教学管理—&gt;师资库管理—&gt;外请教师—&gt;修改外请教师信息</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		...
		<html:hidden property="OutTeacher/OutTeacherID" />
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr> 
            ...
            <td width="35%" class="td1">&nbsp;<html:text property="OutTeacher/Name" maxlength="30" attributesText='class="input" size="30"  ValidateType="notempty" Msg="教师姓名不能为空" '/><span class="text_red">*</span></td>
          ...
          <tr> 
            ...
            <td width="35%" class="td1">&nbsp;<html:text property="OutTeacher/Birthday[@pattern='yyyy-MM-dd']" maxlength="50" attributesText='class="input" size="13"'/>
            <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["OutTeacher/Birthday[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")></td>
