...
<SCRIPT language="JavaScript" >
 ...
 <logic:iterate id="resultset" property="list[@type='textbook']">
  ...
  var listName = "booklist/TextbookDestroy[@hciTagIndex='"; 
...
<form method="post" action="teachWorkManage.prBookManage.destroyAddDo.do" name="opeForm">
<table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable" >
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;教材管理—&gt;教材报废</td>
          </tr>
        </table></td>
    </tr>
    <tr>
  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" >
    ...
    <tr>
      <td class="text" height="30">
    	...
    	<td class="td1">
    	 报废时间： 
            	<html:text property="TextbookDestroy/DestroyTime[@pattern='yyyy-MM-dd']" attributesText='class="input" size="10" ' readonly="true"/>
             	<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["TextbookDestroy/IssueTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")> 
           		
		 经手人：
			   <input type="text" name="TextbookDestroy/Handler"  value= "<bean:write property="SessionEntity/userID" formatClass="username" formatType="userid"/>" class="input" size="20" /><br/>
    	...
    	<tr height="20"><td class="td1" align="center"><b> 报废明细</b></td> </tr>
    	</table>
        ...
        <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC"  id="listdetail">
         <tr class="td_title"> 
                  ...
                  <td width="5%" align="center" nowrap id="TextbookOrderDetail.DestroyIDNum" onClick="talentsort()">报废数</td>
            ...
            <%
              ...
              <tr class="td1" onClick="changeTRBgColor(this)" id="row_<%=count %>">  
                ...
                <input type="hidden" name="booklist/TextbookDestroy[@hciTagIndex='<%=count%>']/TextbookID"  value="<bean:write id="resultset" property='TextbookOrderDetail/TextbookID'/>"   /></td> 
                ...
                <td nowrap><input type="text" name="booklistupdate/TextbookDestroy[@hciTagIndex='<%=count%>']/Price"  value="<bean:write id="resultset" property='TextbookOrderDetail/Price'/>"  style="width:100%" /></td>
                ...
                <td nowrap> <input type="text" name="booklist/TextbookDestroy[@hciTagIndex='<%=count%>']/DestroyIDNum"  value="<bean:write id="resultset" property='TextbookOrderDetail/OrderNum'/>"style="width:100%" /></td>
                <td nowrap> <input type="text" name="booklist/TextbookDestroy[@hciTagIndex='<%=count%>']/Remarks"  maxlength="50" style="width:100%"/></td>
              </tr>
                </logic:iterate> 
...
<script language="JavaScript" type="text/javascript">
  ...
  function save() {
	...
	function pageOnLoad() {
    	...
    	frm.elements["TextbookDestroy/DestroyTime[@pattern='yyyy-MM-dd']"].value = getCurDateValue2();
	}
    ...
    function verifyForm(frm)
    {
    	...
    	if(isEmpty(frm.elements["TextbookDestroy/DestroyTime[@pattern='yyyy-MM-dd']"].value.trim())){
    	 	alert("报废时间不能为空");
    		return false;
    	}
    	if(isEmpty(frm.elements["TextbookDestroy/Handler"].value.trim())){
    	 	alert("经手人不能为空");
    		return false;
    	}
    ...
    function verifyEachRow(rowObj, rowIndexId) {
    	var IssueNum = listName + rowIndexId + "']/DestroyIDNum";
        ...
        if (!isNumeric(rowObj.all[IssueNum].value)||isEmpty(rowObj.all[IssueNum].value)) {
        	alert("书名为'"+title+"'的教材报废数必须不为空且为数字");
        	return false;	
        }
 ...
 // 增加明细表记录
  ...
  function changeIssue(index){
	...
	var DestroyIDNum_name =  listName+ index + "']/DestroyIDNum";
	
	var StockNum_value = parseInt(frm[StockNum_name].value);
	var DestroyIDNum_value = parseInt(frm[DestroyIDNum_name].value);
	
	if(DestroyIDNum_value>StockNum_value){
		alert("报废数不能大于库存");
		return false;
	}
