...
<form name="classForm">
  ...
  <tr>
    <td><table width="100%" height="6"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr class="td2">
        <td class="td_title" align="center">选择部门（可多选）</td>
      </tr>
    </table>  
           <table  width="96%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
        <%int k=0; %>
          <logic:iterate id="departset" property="list[@type='Department']"> 
          <%if(k%5==0){ %>
          	<tr class="td1">
          <%} %>        
           <td class="selected"><input type="checkbox" name="chk" value='<bean:write id="departset" property="Department/DepartmentID"/>'>
           <html:hidden id="departset" property="Department/Department"/> 
             <bean:write id="departset" property="Department/Department"/></td>       
        <% k++;                
         if(k%5==0){ %>       
           </tr>
          <%}%>  
