...
<form method="post"  action="teachWorkManage.prNetCenter.workPlanAddDo.do" name="opeForm">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" background="image/lz_bg.gif"> 
          ...
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;网络中心教学管理—&gt;中心工作计划新增</td>
          </tr>
        </table></td>
    </tr>
    <tr>
	  ...
	  <td class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="88%" class="td1"><html:text property="CenterPlan/PlanDate[@pattern='yyyy-MM-dd']" attributesText='class="input" size="20"' readonly="true"/>
              ...
              <input onblur="doCheckClock();getNoon()" size="10"  name="CenterPlan/PlanTime"  class="input" value="8:30:00"/>

<input onclick="document.opeForm['CenterPlan/PlanTime'].value='8:30:00'"  type="radio" name="CenterPlan/PlanNoon" value="1" checked="checked">
上午
<input onclick="document.opeForm['CenterPlan/PlanTime'].value='14:30:00'" type="radio" name="CenterPlan/PlanNoon" value="2">
下午
<input onclick="document.opeForm['CenterPlan/PlanTime'].value='19:00:00'" type="radio" name="CenterPlan/PlanNoon" value="3">
晚上
</td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
   ...
   <% i++;                
       ...
       <%}%>
            ...
            <td class="td1"><html:text  property="CenterPlan/LongOvertime"   attributesText='class="input" size="10" ValidateType="numeric" Msg="加班时长必须为数字"' />小时</td>
          </tr>

                    <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">出租金额：</td>
            <td class="td1"><html:text  property="CenterPlan/Rent"   attributesText='class="input" size="10"   ValidateType="money" Msg="出租金额必须为货币格式"' />元 </td>
          </tr>
                    <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1"><html:text  property="CenterPlan/LinkTel"   attributesText='class="input" size="20"  ' /></td>
              ...
              <td class="td1">    <dict:multicheckbox name="CenterPlan/Equipments"  businTypeId="dx_equipment" modifiable="true" formName="opeForm"/></td> </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
            <td class="td1"><textarea class="finput" name="CenterPlan/Remarks"  cols="80" rows="4"></textarea></td>
          </tr>
        </table>
