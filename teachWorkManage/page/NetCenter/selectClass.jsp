      ...
      <tr class="td2">
       ...
       <table   border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
        ...
        <tr>
          ...
          <td class="td1">      
           <input type="checkbox" name="chk" value='<bean:write id="resultset" property="Class/ClassID"/>'>
           <html:hidden id="resultset" property="Class/ClassShortName"/> 
             <bean:write id="resultset" property="Class/ClassShortName"/>&nbsp;&nbsp;        
        <% i++;                
         if(i%5==0){ %>
           <tr>         
          <%}%>  
