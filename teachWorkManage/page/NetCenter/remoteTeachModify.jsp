...
<body>
<form method="post"  action="teachWorkManage.prNetCenter.remoteTeachModifyDo.do" name="opeForm">
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td height="24" background="image/lz_bg.gif"> 
          ...
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;网络中心教学管理—&gt;远程教学录制安排修改</td>
          </tr>
        </table></td>
    </tr>
    <tr>
	  ...
	  <td class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="88%" class="td1"><html:text property="DistanceTeaching/RecordDate[@pattern='yyyy-MM-dd']" attributesText='class="input" size="20"' readonly="true"/>
              ...
              <html:text onblur="doCheckClock();getNoon()"  property="DistanceTeaching/RecordTime" attributesText='class="input" size="20"' />

<html:radio onclick="document.opeForm['DistanceTeaching/RecordTime'].value='8:30:00'"  property="DistanceTeaching/RecordNoon" value="1"/>
上午
<html:radio onclick="document.opeForm['DistanceTeaching/RecordTime'].value='14:30:00'" property="DistanceTeaching/RecordNoon" value="2"/>
下午
<html:radio onclick="document.opeForm['DistanceTeaching/RecordTime'].value='19:00:00'" property="DistanceTeaching/RecordNoon" value="3"/>
晚上
</td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">频&nbsp;&nbsp;&nbsp;&nbsp;道：</td>
            <td class="td1"><dict:select businTypeId="dx_distanceType" property="DistanceTeaching/Channel" ></dict:select>          
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1"><html:text readonly="true" property="DistanceTeaching/Class"  maxlength="50"  attributesText='class="input" size="60"'  />
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1"><html:text   maxlength="10" property="DistanceTeaching/Teacher" attributesText='class="input" size="60" ' /></td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">授课教师单位：</td>
            <td class="td1"><html:text  maxlength="20" property="DistanceTeaching/TeacherOrg" attributesText='class="input" size="60" ' /></td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">授课教师职务：</td>
            <td class="td1"><html:text  maxlength="10" property="DistanceTeaching/TeacherPost" attributesText='class="input" size="60"  ' /></td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1"><html:textarea  property="DistanceTeaching/Remarks"  cols="80" rows="4"/></td>
          </tr>
        </table>
