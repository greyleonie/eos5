...
<body>
<form method="post" action="teachWorkManage.prNetCenter.statisMediaDetail.do" name="opeForm">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;网络中心教学管理—&gt;多媒体使用情况明细</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="teachWorkManage.prNetCenter.statisMediaDetail.do">
  ...
  <tr>
    <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <tr>
        <td class="td1" align="center"><span id="printTable"><b>多媒体情况明细表</b></span> </td>
      </tr>
      <tr>
