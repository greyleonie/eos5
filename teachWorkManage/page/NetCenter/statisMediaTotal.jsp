...
<body>
<form method="post" action="teachWorkManage.prNetCenter.statisMediaTotal.do" name="opeForm">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0" >
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;网络中心教学管理—&gt;多媒体使用情况汇总</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="teachWorkManage.prNetCenter.statisMediaTotal.do">
  ...
  <tr>
    <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <tr>
        <td class="td1" align="center"><span id="printTable"><b>多媒体使用情况汇总表</b></span> </td>
      </tr>
      <tr>
		...
		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  ...
                  <td width="50%" align="center"  nowrap id="TaskCount.TaskCount" onClick="talentsort()">使用次数</td>
...
function statisdetail(){
	...
	window.location.href="teachWorkManage.prNetCenter.statisMediaDetail.do?input/BeginTime="+BeginTime+"&input/EndTime="+EndTime;
...
function statistotal(){
	...
	window.location.href="teachWorkManage.prNetCenter.statisMediaTotal.do?input/BeginTime="+BeginTime+"&input/EndTime="+EndTime;
