      	...
      	<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
           ...
           <input name="B35" type="button" class="button_02" value="下周任务" onclick=" nextWeekTask()">          
            <input name="ieprint" type="button" class="button_02" value="打 印" onClick="iePrint()">
      		  <input name="B35" type="button" class="button_eight" value="导出word" onclick="export2Doc()">
...
function nextWeekTask(){
  ...
  frm.action = "teachWorkManage.prMakeTeachPlan.assintTeaching.do?input/degree=1"
   frm.submit();
}
