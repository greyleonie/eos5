 ...
 <%}else{ %> 
  ...
  <%} %>           
        ...
        <logic:equal valueType="variable" valueId="resultSet" value="TeachingPlanUnitBu/UnitID" propertyId="courseResult" property="CourseBu/UnitID">
         <tr class="td1" onClick="changeTRBgColor(this)"  onDBlClick="courseDetail('<bean:write id="courseResult" property="CourseBu/id"/>','<bean:write id="resultSet" property="TeachingPlanUnitBu/id"/>','<bean:write id="resultSet" property="TeachingPlanUnitBu/version"/>')"> 
...
function courseDetail(id,classId,version){

  frm.action="teachWorkManage.prMakeTeachPlan.courseView.do?loc=6&CourseBu/version="+version+"&TeachingPlanUnitBu/version="+version;
  frm.target="test";
  frm.submit();
}
