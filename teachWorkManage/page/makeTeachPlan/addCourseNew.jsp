...
<form name="courseForm" method="post">
  ...
  是</td>
          ...
          <tr>
            ...
            <td class="td1" colspan="4" width="333" height="27">
            <html:text maxlength="4" onblur="check(this,'无线话筒')" property="Course/WiredPhones" value="0" attributesText='class="input" size="10" '/>          
            个</td>
            <td align="right" class="td2" width="86" height="27" colspan="2">有线话筒：</td>
            <td class="td1" width="354" height="27">
             <html:text maxlength="4" onblur="check(this,'有线话筒')" property="Course/RadioPhones" value="1" attributesText='class="input" size="10" '/>
...
个</td>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <html:text maxlength="4" onblur="check(this,'主席台座位')" property="Course/PlatformSeats" value="1" attributesText='class="input" size="10" '/>
            张</td>  
          </tr>
          <tr  onClick="changeTRBgColor(this)">
