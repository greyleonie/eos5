  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" height="714">
          ...
          <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["Course/ClassDate[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")>
             <span class="text_red">*</span>
              <html:text property="ClassTime" value="" attributesText='class="input" size="20"' readonly="true"/>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td colspan="7" class="td1" width="781" height="27">
             <html:text maxlength="50" property="Course/CourseTitle" onblur="hiddenDiv()" onkeydown="javascript:actionKeyDown(this,event)" onkeyup="javascript:actionKeyUp(this,event)" attributesText='class="input" size="60" '/>
   ...
   <html:text maxlength="6" onblur="judgeValue(this)" property="Course/Credit" attributesText='class="input" size="12" '/>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <html:text maxlength="25" property="Course/OutSideOrg" attributesText='class="input" size="30" '/>
            </td>
...
function clearValue(flag){
  ...
  for(var i=0;i<4;i++){
     ...
     var onlyOne="y";
     try{
       acceptValue=window.showModalDialog(loc,onlyOne,"dialogWidth:660px;DialogHeight=480px;status:no;scroll:yes");  
       ids=acceptValue[0];
       names=acceptValue[1];
     }catch(e){}
  ...
  function save(){
    ...
    if(flag){
    frm.action="teachWorkManage.prMakeTeachPlan.saveSpecialSubjectCourse.do";
    frm.submit();
    }
  ...
  function selectTitle(){
       ...
       window.open(loc,"","width=660,height=480,top=150,left=150,status=yes");
 ...
 function   str2date(str){   
  ...
  return   d;   
   ...
   function setSelectedIndex(){
    ...
    for(var i=0;i<teachModel.length;i++){
        var optionValue=teachModel.options[i].value;
        if(optionValue==11){
          teachModel.selectedIndex=i;
        }
    }
    
   for(var i=0;i<classModel.length;i++){
        var optionValue=classModel.options[i].value;
        if(optionValue==1){
          classModel.selectedIndex=i;
        }
    }
  }
 setSelectedIndex();
