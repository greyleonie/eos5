...
<script>
	...
	tabbox1.add('1','待审批教学计划','teachWorkManage.prMakeTeachPlan.leaderCheckFramPage.do?TeachingPlan=','testframe',0)
	tabbox1.add('2','已审批教学计划','teachWorkManage.prMakeTeachPlan.framePassedInLeader.do?TeachingPlan=','testframe',0)
