      ...
      <logic:iterate id="resultSet" property="list[@type='TeachingPlanUnitTemp']">   
        <table width="100%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolordark="#FFFFFF" bordercolorlight="#A2C4DC" >
            ...
            <td colspan="13"> <table cellspacing="0" cellpadding="0" width="100%" border="0">
                <tr> 
                  ...
                  <bean:write id="resultSet" property="entity/UnitName"/>&nbsp;&nbsp; 
                    <bean:write id="resultSet" property="entity/UnitTitle"/>&nbsp;&nbsp; 开始日期:<bean:write id="resultSet" property="TeachingPlanUnit/BeginTime"  formatClass="com.primeton.eos.webtag.bean.BeanWriteDateFormatImpl" formatType="yyyy-MM-dd"/>
                     结束日期:<bean:write id="resultSet" property="entity/EndTime"  formatClass="com.primeton.eos.webtag.bean.BeanWriteDateFormatImpl" formatType="yyyy-MM-dd"/></td>
                  ...
                  <tr> 
                  <td width="71%" align="left" colspan="2" class="td">教学要求：<bean:write id="resultSet" property="entity/Demand"/>
                 </td>
          ...
          <tr class="td"> 
            ...
            <td width="9%" align="center">地　点</td>
            ...
            <td width="6%" align="center">到会教师</td>
           
          </tr>
        <logic:iterate id="courseResult" property="list[@type='Course']">
        <logic:greaterEqual valueType="variable" valueId="resultSet" value="entity/BeginTime" propertyId="courseResult" property="Course/ClassDate">
              <logic:lessEqual valueType="variable" valueId="resultSet" value="entity/EndTime" propertyId="courseResult" property="Course/ClassDate">
         ...
         <logic:notEqual id="courseResult" value="0" property="Course/ClassNoon">
          <tr class="td3"> 
            ...
            <td align="center"><bean:write id="courseResult" property="Course/weekDate"/>&nbsp;</td>
                  <td align="center">&nbsp;<bean:write id="courseResult" property="Course/CourseTitle"/>&nbsp;</td>
                  <td align="center">&nbsp;<bean:write id="courseResult" property="Course/classRoom"/>&nbsp;</td>
            <td align="center">
            ...
            <logic:equal id="courseResult" value="1" property="Course/IsUseKQJ">是</logic:equal>
                  ...
                  <td align="center">&nbsp;<bean:write id="courseResult" property="Course/TeahchingModelID"/>&nbsp;</td>
                  <td align="center">&nbsp;<bean:write id="courseResult" property="Course/ClassModelID"/>&nbsp;</td>
                  ...
                  <td align="center">&nbsp;<bean:write id="courseResult" property="Course/daoHui"/>&nbsp;</td>
