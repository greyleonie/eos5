...
function dayPopUpCalendarDlg(objId){ 
   var obj=document.getElementById(objId);
			...
			retval = window.showModalDialog("teachWorkManage.prClassInfoManage.showCalendarPage.do", "", "dialogWidth:197px; dialogHeight:220px; dialogLeft:"+showx+"px; dialogTop:"+showy+"px; status:no; directories:yes;scrollbars:no;Resizable=no; "  );
			if( retval!= null ){
			obj.value = retval;
	        }
}
...
<input type="hidden" name="targetValue" value="18">
  ...
  <table width="82%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="text"><table width="82%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          <tr  onClick="changeTRBgColor(this)">
            <td width="103" align="right" class="td2">班级名称：</td>
            <td colspan="7" class="td1" width="">
            <html:text maxlength="25" property="Class/ClassName" attributesText='class="input" size="45" ValidateType="notempty" Msg="班级名称不能为空"'/>
		   ...
		   <tr  onClick="changeTRBgColor(this)">
            ...
            <html:text property="Class/ClassShortName" maxlength="25" attributesText='class="input" size="35" ValidateType="notempty" Msg="班级简称不能为空"'/>
           <span class="text_red">*</span></td>            
            ...
            <html:select property="Class/ClassTypeID" onkeydown="catch_keydown(this);" onkeypress="catch_press(this);">
                      <html:option value="-1">--选择班级类型--</html:option> <html:options property="list[@type='ClassType']/ClassType/ClassTypeID" labelProperty="list[@type='ClassType']/ClassType/ClassType"/> 
           </html:select>
            <span class="text_red">*</span></td>            
          </tr>
		   <tr  onClick="changeTRBgColor(this)">
            ...
            <html:text maxlength="20" property="Class/ClassCode" attributesText='class="input" size="30" '/>
            </td>     
            <td nowrap align="right" class="td2">人事局系统编号： </td>
            <td width="337" class="td1" colspan="3"> 
           <html:text maxlength="20" property="Class/renShiNo" attributesText='class="input" size="30" '/>  </td>       
          </tr>
           ...
           <tr  onClick="changeTRBgColor(this)">
            ...
            <td width="337" class="td1" colspan="3"> 
            <html:radio property="Class/IsUnitEva" value="1"/> 是
            <html:radio property="Class/IsUnitEva" value="0"/>否     </td>       
          </tr>
          ...
          <html:select property="Class/Commission" onkeydown="catch_keydown(this);" onkeypress="catch_press(this);">
                 ...
                 <html:option value="-1">--选择调训单位--</html:option> <html:options property="list[@type='entity']/entity/commission" labelProperty="list[@type='entity']/entity/commission"/> 
            
          </html:select> <span class="text_red">*</span>
         提示：选中内容时可以直接编辑；按回车键添加新的调训单位
            ...
            <td class="td1" width="100" colspan="4">  
                <html:text property="Class/RecruitNum" maxlength="4" attributesText='class="input" size="8" ValidateType="notempty" Msg="计划招生人数不能为空" onfocus="textValidate()" onlytype="int"'/>
          
            <span class="text_red">*</span></td>          
                      
            <td align="right" colspan="2" class="td2" nowrap>实际招生人数：</td>        
            <td class="td1" width="105">
             <html:text property="Class/factNum" maxlength="4"  onblur='check(this,"实际招生人数")' attributesText='class="input" size="4"'/>
           </td>        
          </tr>
        <tr  onClick="changeTRBgColor(this)">
            ...
            <html:select property="Class/XueZhi" onkeydown="catch_keydown(this);" onkeypress="catch_press(this);">
                      <html:option value="-1">--选择学制--</html:option> <html:options property="list[@type='xueZhi']/xueZhi/xuezhi" labelProperty="list[@type='entity']/xueZhi/xuezhi"/> 
           </html:select>
           <span class="text_red">*</span></td>                      
            <td align="right" class="td2" >学&nbsp;习&nbsp;日： </td>
            <td class="td1" nowrap>
            <html:text property="Class/XueRi"  onblur='check(this,"学习日")' attributesText='class="input" maxlength="3" size="8" ValidateType="notempty" Msg="学习日不能为空"'/>
              天              <span class="text_red">*</span></td>    
               <td class="td2" width="100" align="right">班级级别：</td>
               <td class="td1" width="100">
               <select name="Class/levelId">
                 <OPTION value="-1">请选择</OPTION>
                  ...
                  <logic:notEqual property="isAdd" value="1">
                     ...
                     <logic:notEqual value="ClassLevl/levelId" valueType="variable" valueId="classLevlList" property="Class/levelId">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1" width="326" colspan="3">       
             <html:text property="Class/EducatStand" maxlength="25" attributesText='class="input" size="25"'/>
            元</td>
            <td align="right" class="td2" >考&nbsp;察&nbsp;费： </td>
            <td class="td1" width="87" > 
             <html:text property="Class/KaoChaStand" maxlength="25" attributesText='class="input" size="8"'/>元</td> 
            <td align="right" class="td2" width="98">其&nbsp;他&nbsp;费：</td>        
            <td class="td1" width="105" nowrap>
            <html:text property="Class/otherMoney" maxlength="10" attributesText='class="input" size="10"'/>元
            </td>        
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2" width="103">注册时间： </td>
            <td class="td1" width="326" colspan="3">    
          <html:text property="Class/regTime[@pattern='yyyy-MM-dd  HH:mm:ss']"  attributesText='class="input" id="reg" size="30"' readonly=""/>
          <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick='dayPopUpCalendarDlg("reg")'>
           ...
           <html:text property="Class/reachTime[@pattern='yyyy-MM-dd HH:mm:ss']" attributesText='class="input" id="reachDate" size="30"' readonly=""/>
           <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick='dayPopUpCalendarDlg("reachDate")'>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1" width="326" colspan="3">
     <html:text property="Class/BeginTime[@pattern='yyyy-MM-dd']" attributesText='class="input" size="30"' readonly="true"/>
        
            <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["Class/BeginTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")></td>
                      
            </td>
            <td align="right" class="td2" >毕(结)业时间： </td>
            <td class="td1" colspan="3" width="337">           
            <html:text property="Class/EndTime[@pattern='yyyy-MM-dd']" attributesText='class="input" size="30"' readonly="true"/>
         <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["Class/EndTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <input name="classRoom" type="text" value='<bean:write property="Class/classRoomName"/>' class="input" readonly="true" size="30">
              <a href="javascript:selectRoom('1','0')" >  
            <img src="/internet/image/house.gif" width="18" border="0" height="15" align="absmiddle"></a><span class="text_2"></span></td>
            <td align="right" class="td2" >住宿地点：</td>
            <td class="td1" colspan="3" width="337">           
            <html:hidden property="Class/BuildingID"/>
            <input name="liveBuilding" value="<bean:write property="Class/buildingName"/>" type="text" class="input" size="30">
              <a href="javascript:selectRoom('2','1')">  
            <img src="/internet/image/house.gif" width="18" height="15" border="0" align="absmiddle"></a><span class="text_2">（可多选）</span>            </td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td class="td1" width="109">
            <select name="Class/RepastCard" style="width: 71; height: 23" size="1">
            ...
            <td class="td1" width="109">
            <select name="Class/RepastTypeID" style="width: 71; height: 23" size="1">
             ...
             <logic:equal property="isAdd" value="1">
               <logic:iterate id="rePastTypeList" property="list[@type='RepastType']">            
                  ...
                  <bean:write id="rePastTypeList" property="RepastType/RepastType"/></option>
               </logic:iterate>
             </logic:equal>
             
             <logic:notEqual property="isAdd" value="1">
              <logic:iterate id="rePastTypeList" property="list[@type='RepastType']"> 
                <logic:equal value="RepastType/RepastTypeID" valueType="variable" valueId="rePastTypeList" property="Class/RepastTypeID">
                    <option value="<bean:write id="rePastTypeList" property="RepastType/RepastTypeID"/>" selected>
                  <bean:write id="rePastTypeList" property="RepastType/RepastType"/></option>
                </logic:equal>
                <logic:notEqual  value="RepastType/RepastTypeID" valueType="variable" valueId="rePastTypeList" property="Class/RepastTypeID">
                  <option value="<bean:write id="rePastTypeList" property="RepastType/RepastTypeID"/>">
                  <bean:write id="rePastTypeList" property="RepastType/RepastType"/></option>
                </logic:notEqual>
               </logic:iterate>
            ...
            <td class="td1" colspan="3" width="337">
            <html:text property="Class/Deposit" onblur="checkMoney(this)" maxlength="4" attributesText='class="input" size="8"'/>
            元</td>
          </tr>
          <tr>
            <td align="right" class="td2" width="103">班&nbsp;主&nbsp;任：</td>
            <td class="td1" width="326" colspan="3">
           <input name="HeadTeacher" readonly="true" value="<bean:write property="Class/headTeacher"/>" type="text" class="input" size="15">
           <html:hidden property="Class/HeadTeacherID"/>
         <input name="Button" type="button" class="button_02" value="选 择" elname="Class/HeadTeacherID,HeadTeacher" onClick="selectHead('yes')"> 
            <span class="text_2">（单选）</span></td>
            <td align="right" class="td2" >副班主任：</td>           
            <td class="td1" colspan="3" width="337" nowrap>
             <input name="TeacherString" readonly="true" value="<bean:write property="Class/teacherAssistant"/>" type="text" class="input" size="25">
            <html:hidden property="Class/TeacherString"/>
               <input name="Button" type="button" class="button_02" value="选 择" elname="Class/TeacherString,TeacherString" onClick="selectHead()">
              <span class="text_2">（可多选）</span></td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2" width="103" nowrap>制作通讯录：</td>
            <td class="td1" width="326" colspan="3">
        <html:radio property="Class/makeLinkBook" value="1"/> 是
               <html:radio property="Class/makeLinkBook" value="0"/>否  </td>
            <td align="right" class="td2" >制作学员名册：</td>
            <td class="td1" width="320" colspan="3">
          <html:radio property="Class/makeStuBook" value="1"/> 是
               <html:radio property="Class/makeStuBook" value="0"/>否  
</td>
          </tr>
            ...
            <td class="td1" width="326" colspan="3">
             <html:radio property="Class/buyNewspaper" value="1"/> 是
               <html:radio property="Class/buyNewspaper" value="0"/>否   </td>
       
            <td align="right" class="td2" >拍集体照：</td>
            <td class="td1" width="320" colspan="3">
               <html:radio property="Class/takePhoto" value="1"/> 是
               <html:radio property="Class/takePhoto" value="0"/>否   
               </td>
          </tr>
           <tr  onClick="changeTRBgColor(this)">
            ...
            <html:hidden property="Class/regRoom"/>
             <input name="regRoom" readonly="true" value="<bean:write property="regRoom"/>" type="text" class="input" size="25">
         <a href="javascript:selectRoom('1','1')" >  
            <img src="/internet/image/house.gif" width="18" border="0" height="15" align="absmiddle"></a></td>            
          </tr>
          <!--          <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2" width="103">外网接受报名开始时间：</td>
            <td class="td1" width="326" colspan="3">
     <html:text property="subjectNews/startTime[@pattern='yyyy-MM-dd']" attributesText='class="input" ValidateType="notempty" Msg="报名开始时间" size="30"'  readonly="true"/>
        <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["subjectNews/startTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")>
         <span class="text_red">*</span>  
                      ...
                      <td align="right" class="td2" width="109">外网接受报名结束时间： </td>
            <td class="td1" colspan="3" width="337">           
            <html:text property="subjectNews/endTime[@pattern='yyyy-MM-dd']" attributesText='class="input" ValidateType="notempty" Msg="报名结束时间" size="30"'  readonly="true"/>
         <img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["subjectNews/endTime[@pattern='yyyy-MM-dd']"],"yyyy-MM-dd")>
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <td colspan="7" class="td1" width="780">   
            <TEXTAREA maxlength="100" name="Class/Remark" cols="86" rows="6"><bean:write property="Class/Remark"/></TEXTAREA>        
           </td>
          </tr>
        </table>
          <table width="100%" height="30"  border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <input name="Submit2" onClick="history.go(-1)" type="button" class="button_02" value="返 回"></td>
            </tr>
          </table></td>
    </tr>
    <tr>
...
<script language="javascript">
  ...
  var frm=document.addUpdateForm;
    ...
    if(frm.elements["Class/Commission"].value==""){
       alert("实际招生人数不能为空！");
       return;
    }
     if(frm.elements["Class/Commission"].value！=""&&isNaN(frm.elements["Class/RecruitNum"].value)){
       alert("实际招生人数必须是数字！");
       return;
    }
