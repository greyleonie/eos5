...
<form method="post"  action="teachWorkManage.prWorkLoad.collectAddDo.do" name="opeForm">
<div style="display:none" id="statisPane"></div>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;教师工作量录入—&gt;工作量新增</td>
          </tr>
        </table></td>
    </tr>
    <tr>
  ...
  <table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0"  class="table">
    ...
    <tr>
      ...
      <tr> 
          ...
          <td  class="td1" width="20%">&nbsp;<bean:write property="WorkLoadCollect/TeachingGroupName"  /> </td>
           <td align="right"  class="td2" width="10%">教&nbsp;&nbsp;&nbsp;&nbsp;师： </td>
          <td class="td1" width="20%">&nbsp;<bean:write property="WorkLoadCollect/TeacherName"  /></td>
        </tr></table>
    ...
    <tr>
	  ...
	  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
              ...
              <tr class="<%=trClass%>" onClick="changeTRBgColor(this)">
                ...
                <tr class="td1"><td  nowrap align="right">备&nbsp;&nbsp;&nbsp;&nbsp;注：</td><td colspan="4" nowrap ><html:textarea  property="WorkLoadCollect/Remark"  style="width:100%;" attributesText='class="input" rows="3" cols="80" '/></td></tr>
	...
	frm.submit()};
  	...
  	function changeTeacher() {
		...
		if(Period_value==""){
			...
			Yearth_value = Number(Yearth_value)+1
 ...
 function changeSum(diff) {
	...
	function statisWorkLoad(){
	 var frm=document.forms["opeForm"];
	 	frm.elements["NumField/field1"].value = <bean:write property="WorkLoadCollect/model0"/>;
	 frm.elements["ClassField/field1"].value = <bean:write property="WorkLoadCollect/model0Num"/>;
	 	 frm.elements["NumField/field2"].value = <bean:write property="WorkLoadCollect/model1"/>;
	 frm.elements["ClassField/field2"].value = <bean:write property="WorkLoadCollect/model1Num"/>;
	 	 frm.elements["NumField/field3"].value = <bean:write property="WorkLoadCollect/model2"/>;
	 frm.elements["ClassField/field3"].value = <bean:write property="WorkLoadCollect/model2Num"/>;
	 	 frm.elements["NumField/field4"].value = <bean:write property="WorkLoadCollect/model3"/>;
	 frm.elements["ClassField/field4"].value = <bean:write property="WorkLoadCollect/model3Num"/>;
