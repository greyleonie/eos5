  ...
  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <logic:present property="QueryTeachingCase/ExamOpinion">
           <tr  onClick="changeTRBgColor(this)">
            <td align="right" class="td2">审核意见：</td>
            <td colspan="3" class="td1">
            &nbsp;
           		<bean:write property="QueryTeachingCase/ExamOpinion"/>
            </td>
          </tr>
          </logic:present>    
              <tr>
            <td class="td1" colspan="4">  <table width="96%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="attachment">
				...
				<iframe src='/iWebOffice/teachCase/DocumentEdit.jsp?RecordID=<bean:write property="QueryTeachingCase/RecordID"/>&SendArchive/archiveTitle=&Purview=edit&FileType=.doc&Template=' frameborder="0" width="100%" name="sendText" style=" height: 100%" scrolling="no"></iframe>
				</td></tr>
        	  </table></td>
          </tr>
        </table>
