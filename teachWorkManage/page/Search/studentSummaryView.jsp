...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            ...
            <td class="text_wirte">首页 -&gt; 教务管理 -&gt; 查询统计
              -&gt; <span id="printTable">学员文章与评语表</span></td>
          </tr>
        </table></td>
    </tr>
    <tr>
 ...
 <form method="post" enctype="multipart/form-data" action="teachWorkManage.prSearch.studentSummaryView.do">
...
function domToDoc(){
    	var frm =document.forms[0];
    		frm.action = "teachWorkManage.prSearch.studentSummaryView.do";
			frm.target = "_blank";
			frm.submit();		 	
}
</script>
