    ...
    <tr>
      <td height="24" background="image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0" id="printTable">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">首页—&gt;教务管理—&gt;查询统计—&gt;教学计划执行表</td>
          </tr>
      </table></td>
    </tr>
  </table>
      ...
      <td class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" id="listdetail" bgcolor="#A2C4DC">
         ...
         <logic:iterate id="eachCourse" property="list[@type='Course']">
          ...
          <tr class="td1">
            <td ><bean:write id="eachCourse" property="Course/unit"/><br>
            ...
            <td ><bean:write id="eachCourse" property="Course/ClassDate" formatClass="com.primeton.eos.webtag.bean.BeanWriteDateFormatImpl" formatType="MM-dd"/>，<br><dict:write businTypeId="BNDICT_classMoon" property="Course/ClassNoon" id="eachCourse"/></td>
            ...
            <td ><bean:write id="eachCourse" property="Course/ClassModelID"/>&nbsp;</td>
...
<script>
 function selectClasses(){
   ...
   if(returnArray!=undefined){     
      ...
      frm.action="teachWorkManage.prSearch.teachPlanList.do";
      frm.submit();
    }  
 }
