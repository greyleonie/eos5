...
<body>
<form method="post" action="teachWorkManage.prSearch.studentSummaryList.do" name="opeForm">
  ...
  <tr>
    <td><table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
		  ...
		  <tr>
            <td class="td2" align="right">入学时间：</td> 
			<td class="td1"  colspan="3">从<html:text property="QueryStudent/Birthdate/cirteria/value" attributesText='class="input" size="20"' readonly="true"/>
             	<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["QueryStudent/Birthdate/cirteria/value"],"yyyy-MM-dd")>
             	到<html:text property="QueryStudent/Birthdate/cirteria/value" attributesText='class="input" size="20"' readonly="true"/>
             	<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["QueryStudent/Birthdate/cirteria/value"],"yyyy-MM-dd")>  
                <html:hidden property="QueryStudent/Birthdate/criteria/operator" value="=" />
			    <html:hidden property="QueryStudent/Birthdate/criteria/criteriaPattern" value="yyyy-MM-dd" />
             	</td>
			  <td class="td2" align="right">结业时间：</td> 
			<td class="td1"  colspan="3">从<html:text property="QueryStudent/Birthdate/cirteria/value" attributesText='class="input" size="20"' readonly="true"/>
             	<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["QueryStudent/Birthdate/cirteria/value"],"yyyy-MM-dd")>
             	到<html:text property="QueryStudent/Birthdate/cirteria/value" attributesText='class="input" size="20"' readonly="true"/>
             	<img src="/internet/image/date.gif" width="13" height="20" align="absmiddle" onClick=calendar(document.forms[0].elements["QueryStudent/Birthdate/cirteria/value"],"yyyy-MM-dd")>  
