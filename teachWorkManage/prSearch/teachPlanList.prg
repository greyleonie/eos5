...
<autoGraphics>
    <graphic name="teachPlanList" type="prg" router="0">
        <states>
            <state color="16777215" id="27" typeName="useCase" height="48" width="48" x="186" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="24" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">executedPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>executedPlan</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Feb 07 14:37:09 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="28" typeName="setField" height="48" width="48" x="345" y="178" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">Course/IsAdopted/criteria/value</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="25" typeName="End" height="48" width="48" x="782" y="67" lookAndFeel="classic">
            ...
            <state color="16777215" id="30" typeName="useCase" height="48" width="48" x="181" y="178" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>被选的教学模式</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.executedEducationModal</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="26" typeName="view" height="48" width="48" x="603" y="67" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>executePlan.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/executePlan.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="32" typeName="removeEntity" height="48" width="48" x="479" y="178" lookAndFeel="classic">
            ...
            <state color="16777215" id="29" typeName="useCase" height="48" width="48" x="603" y="178" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>courseWithSqlCondition</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.courseWithSqlCondition</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">field</column>
                            <column num="2" name="value" type="0">sqlCondition</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
            ...
            <state color="16777215" id="33" typeName="annotate" height="100" width="197" x="377" y="258" lookAndFeel="classic">
        ...
        <connectors>
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">countClass</column>
                            <column num="1" name="compType">GT</column>
                            <column num="2" name="rightValue">0</column>
                        </row>
                    </property>
                    <property name="expression" type="0">
                        <value>($[isFirst]=="1")&amp;&amp;($[Course/ClassID]!="")||(($[isFirst]=="0")&amp;&amp;($[Course/ClassID]!=""))</value>
                    </property>
                </propertyList>
                <bendpoints/>
            </connector>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.32</from>
