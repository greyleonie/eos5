...
<autoGraphics>
    <graphic name="classInfoList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/Search/classInfoList.jsp</column>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSearch.selectClassType</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSearch.classInfoList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="336" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="582" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-3-19 下午4:21</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 办班统计数据来源于班级管理，统计的结果可以表明在指定的时间内，开设班级的情况。统计可以按班级的注册时间、开班时间、班级类型关键字进行操作</value>
                    </property>
                </propertyList>
                <description/>
            </state>
