...
<autoGraphics>
    <graphic name="studentInfoInput" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询条件输入页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/Search/studentInfoInput.jsp</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="73" y="157" lookAndFeel="classic">
