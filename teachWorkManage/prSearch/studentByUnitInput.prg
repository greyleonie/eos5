...
<autoGraphics>
    <graphic name="studentByUnitInput" type="prg" router="0">
        <states>
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询统计输入页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/Search/studentByUnitInput.jsp</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="422" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 查询学员信息按照工作单位</value>
                    </property>
                </propertyList>
                <description/>
            </state>
