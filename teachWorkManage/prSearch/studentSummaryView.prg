...
<autoGraphics>
    <graphic name="studentSummaryView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="542" y="230" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/Search/studentSummaryToDOC.jsp</column>
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSearch.summaryView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="17" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查看页面</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/Search/studentSummaryView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
