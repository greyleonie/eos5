...
<autoGraphics>
    <graphic name="statisOvertimeDetail" type="prg" router="0">
        <states>
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="662" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 网络中心加班情况统计明细</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            ...
            <state color="16777215" id="19" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/statisOvertimeDetail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="21" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.statisOvertimeDetail</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
