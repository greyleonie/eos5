...
<autoGraphics>
    <graphic name="remoteTeachView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="203" x="419" y="190" lookAndFeel="classic">
...
@description 对远程教育进行查看</value>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.remoteTeachView</column>
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/remoteTeachView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
