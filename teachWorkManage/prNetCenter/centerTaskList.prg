...
<autoGraphics>
    <graphic name="centerTaskList" type="prg" router="0">
        <states>
            <state color="16777215" id="19" typeName="annotate" height="100" width="197" x="405" y="201" lookAndFeel="classic">
...
合班上课合并为一条记录</value>
            ...
            <state color="16777215" id="30" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">assintTeaching</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>assintTeaching</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Feb 12 09:49:06 CST 2007</value>
                    </property>
...
合班上课合并为一条记录</value>
            ...
            <state color="16777215" id="31" typeName="End" height="48" width="48" x="496" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="36" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.centerTaskList</column>
            ...
            <state color="16777215" id="39" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/centerTaskList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="40" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/centerTaskExport.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
