...
<autoGraphics>
    <graphic name="workPlanAdd" type="prg" router="0">
        <states>
...
@description 显示工作计划新增页面</value>
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/workPlanAdd.jsp</column>
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
