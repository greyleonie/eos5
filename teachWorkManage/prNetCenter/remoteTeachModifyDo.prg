...
<autoGraphics>
    <graphic name="remoteTeachModifyDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="26" typeName="annotate" height="100" width="191" x="425" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 远程教育修改完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="36" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.remoteTeachModifyDo</column>
            ...
            <state color="16777215" id="37" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prNetCenter.remoteTeachList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="38" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
