...
<autoGraphics>
    <graphic name="statisMediaTotal" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="14" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">statisView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>statisView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 30 16:16:33 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/statisMediaTotal.jsp</column>
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.statisMediaTotal</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="197" x="482" y="180" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 网络中心多媒体使用情况统计汇总</value>
                    </property>
                </propertyList>
                <description/>
            </state>
