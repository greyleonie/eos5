...
<autoGraphics>
    <graphic name="workArrangeDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">workArrangeDelete</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>workArrangeDelete</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed May 30 09:51:34 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="removeEntity" height="48" width="48" x="336" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/voFail.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="6" typeName="sub" height="48" width="48" x="456" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prNetCenter.workArrangeList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.workArrangeDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="197" x="432" y="366" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金正祥	07-7-19 下午2:12</value>
                    </property>
                    <property name="text" type="0">
                        <value>工作安排删除，返回到工作安排列表页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.3</from>
                <to>Shape.sub.6</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
