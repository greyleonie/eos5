...
<autoGraphics>
    <graphic name="selectPeople" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="616" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/selectPeople.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="19" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.selectTaskType</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="542" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-25 下午2:08</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 显示设置工作安排默认值的选人页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
