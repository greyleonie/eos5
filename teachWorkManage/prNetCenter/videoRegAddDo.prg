...
<autoGraphics>
    <graphic name="videoRegAddDo" type="prg" router="0">
        <states>
...
@description 录象登记完成</value>
            ...
            <state color="16777215" id="37" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.videoRegAddDo</column>
            ...
            <state color="16777215" id="38" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prNetCenter.videoUnRegList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
