...
<autoGraphics>
    <graphic name="workPlanModify" type="prg" router="0">
        <states>
            <state color="16777215" id="24" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.workPlanModify</column>
            ...
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="616" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="26" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>选人</value>
            ...
            <state color="16777215" id="25" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/workPlanModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="15" typeName="annotate" height="100" width="191" x="545" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-2-8 下午4:51</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 显示工作计划修改页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
