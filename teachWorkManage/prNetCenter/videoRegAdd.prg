...
<autoGraphics>
    <graphic name="videoRegAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="244" y="173" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 显示录象资料登记页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/videoRegAdd.jsp</column>
