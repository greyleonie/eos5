...
@description 选择班级可以多选</value>
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/selectClass.jsp</column>
            ...
            <state color="16777215" id="14" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.selectClass</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
