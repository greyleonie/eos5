...
<autoGraphics>
    <graphic name="remoteTeachModify" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="496" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="annotate" height="100" width="191" x="297" y="172" lookAndFeel="classic">
...
@description 显示远程教学修改页面</value>
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.remoteTeachModify</column>
            ...
            <state color="16777215" id="23" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/remoteTeachModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
