...
<autoGraphics>
    <graphic name="videoRegModifyDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="26" typeName="annotate" height="100" width="191" x="425" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 录象资料修改完成</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="39" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.videoRegModifyDo</column>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">VideoRegister</column>
            ...
            <state color="16777215" id="40" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="41" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
