...
<autoGraphics>
    <graphic name="remoteTeachAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useradd</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Tue Dec 26 14:13:45 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="286" y="177" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-2-8 上午11:23</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 显示远程教学新增页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/remoteTeachAdd.jsp</column>
            ...
            <state color="16777215" id="14" typeName="setField" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">DistanceTeaching/IsRecord</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">DistanceTeaching/IsLive</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="4">
                            <column num="0" name="passing" type="1">in</column>
                        ...
                        <row num="5">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">DistanceTeaching/IsPlay</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
