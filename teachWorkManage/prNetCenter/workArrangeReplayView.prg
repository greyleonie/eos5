...
<autoGraphics>
    <graphic name="workArrangeReplayView" type="prg" router="0">
        <states>
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>工作安排回复查看页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/workArrangeReplayView.jsp</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.workArrangeView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.workArrangeReplayView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">WorkArrangeReplay/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">workArrangeReplayView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>workArrangeReplayView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed May 30 18:24:09 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="197" x="611" y="321" lookAndFeel="classic">
