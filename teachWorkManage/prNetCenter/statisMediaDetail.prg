...
<autoGraphics>
    <graphic name="statisMediaDetail" type="prg" router="0">
        <states>
            <state color="16777215" id="15" typeName="End" height="48" width="48" x="736" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="24" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/statisMediaDetail.jsp</column>
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.statisMediaDetail</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="662" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 网络中心多媒体使用情况统计明细</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="25" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>选择负责人</value>
            ...
            <state color="16777215" id="17" typeName="setField" height="48" width="48" x="176" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
