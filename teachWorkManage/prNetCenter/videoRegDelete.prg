...
<autoGraphics>
    <graphic name="videoRegDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="25" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.videoRegDelete</column>
            ...
            <state color="16777215" id="28" typeName="setField" height="48" width="48" x="176" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="616" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="annotate" height="100" width="191" x="414" y="232" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-2-8 下午5:43</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description  删除录象资料登记</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="26" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="27" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prNetCenter.videoRegList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
