...
<autoGraphics>
    <graphic name="selectPeople2" type="prg" router="0">
        <states>
            <state color="16777215" id="20" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/selectPeople2.jsp</column>
