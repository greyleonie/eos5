...
<autoGraphics>
    <graphic name="workPlanAddDo" type="prg" router="0">
        <states>
...
@description 工作计划录入完成</value>
            ...
            <state color="16777215" id="37" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.workPlanAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
