...
<autoGraphics>
    <graphic name="statisAssistantTotal" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/NetCenter/statisAssistantTotal.jsp</column>
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizNetCenter.statisAssistantTotal</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="22" typeName="annotate" height="100" width="197" x="542" y="190" lookAndFeel="classic">
