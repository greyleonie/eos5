...
<autoGraphics>
    <graphic name="ssAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SocialSurvey/ssAdd.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="98" width="203" x="360" y="235" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	06-12-21 下午1:10</value>
                    </property>
                    <property name="text" type="0">
                        <value>新增社会调查页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
