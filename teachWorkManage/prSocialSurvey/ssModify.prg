...
<autoGraphics>
    <graphic name="ssModify" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="736" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SocialSurvey/ssModify.jsp</column>
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSocialSurvey.selectTeachGroup</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSocialSurvey.ssModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="6" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">xjmodify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>xjmodify</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Nov 17 09:29:24 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSocialSurvey.selectClass</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="203" x="442" y="162" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	06-12-21 下午1:16</value>
                    </property>
