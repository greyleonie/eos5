...
<autoGraphics>
    <graphic name="ssView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/SocialSurvey/ssView.jsp</column>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizSocialSurvey.ssView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="203" x="286" y="187" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>金刚	06-12-21 下午1:19</value>
                    </property>
