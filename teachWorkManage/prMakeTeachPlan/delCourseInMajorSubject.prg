...
<autoGraphics>
    <graphic name="delCourseInMajorSubject" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">delCourseInMajorSubject</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>delCourseInMajorSubject</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 02 15:32:41 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>refreshSubjectPage.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/refreshSubjectPage.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="191" x="211" y="267" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-2 下午3:33</value>
                    </property>
                    <property name="text" type="0">
                        <value>计划阶段删除课程</value>
                    </property>
                </propertyList>
                <description/>
            </state>
