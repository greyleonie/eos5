...
<autoGraphics>
    <graphic name="addFinalSubjectCourse" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">addSpecialSubjectCourse</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>addSpecialSubjectCourse</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 07 18:17:44 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="1106" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="191" x="170" y="187" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="906" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="186" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="306" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="426" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="546" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="4">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">className</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="5">
                            <column num="0" name="passing" type="1">out</column>
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">Class/ClassName</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="11" typeName="setField" height="48" width="48" x="666" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="786" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询教学模式</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.educatingMode</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
