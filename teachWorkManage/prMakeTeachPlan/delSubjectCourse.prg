...
<autoGraphics>
    <graphic name="delSubjectCourse" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">delSubjectCourse</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>delSubjectCourse</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 09 10:23:45 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="127" y="197" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-9 上午10:23</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.delSubjectCourse</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
