...
<autoGraphics>
    <graphic name="selectOrgs" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">selectOrgs</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>selectOrgs</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 10 11:19:06 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>selectOrgs.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/selectOrgs.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="178" x="130" y="250" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-10 上午11:20</value>
                    </property>
