...
<autoGraphics>
    <graphic name="selectClasses" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">selectClasses</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>selectClasses</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Feb 01 17:45:20 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>slectClasses.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/slectClasses.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="191" x="305" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-2-1 下午5:45</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询班级，在教学计划总表选班级中使用</value>
                    </property>
                </propertyList>
                <description/>
            </state>
