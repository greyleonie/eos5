...
<autoGraphics>
    <graphic name="leaderSetOpinion4Plan" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">leaderSetOpinion4Plan</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 18 16:54:18 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>showLeaderAllOpinion.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/showLeaderAllOpinion.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="172" x="194" y="358" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添 	07-1-18 下午4:54</value>
                    </property>
                    <property name="text" type="0">
                        <value>领导添加审批意见</value>
                    </property>
                </propertyList>
                <description/>
            </state>
