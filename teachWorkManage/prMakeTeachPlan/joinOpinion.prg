...
<autoGraphics>
    <graphic name="joinOpinion" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">joinOpinion</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>joinOpinion</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Apr 25 11:36:58 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>joinOpinion.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/joinOpinion.jsp</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="178" x="115" y="180" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-4-25 上午11:38</value>
                    </property>
                    <property name="text" type="0">
                        <value>筛选阶段查看审核审批意见</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.queryOpinionsOfLeader</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
