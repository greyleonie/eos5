...
<autoGraphics>
    <graphic name="updateTeachPlan" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>teachPlanDetail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/teachPlanDetail.jsp</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>addUpdateTeachPlan.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/addUpdateTeachPlan.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.selectClass</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">updateTeachPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>updateTeachPlan</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 09 15:06:23 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="166" x="120" y="251" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-9 下午3:26</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询一条教学计划框架的记录</value>
                    </property>
                </propertyList>
                <description/>
            </state>
