...
<autoGraphics>
    <graphic name="setStatusOfPlan" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setStatusOfPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>setStatusOfPlan</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 23 14:04:44 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="172" x="213" y="268" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-23 下午2:06</value>
                    </property>
                    <property name="text" type="0">
                        <value>设置为初稿或者终稿</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.setStatus</column>
