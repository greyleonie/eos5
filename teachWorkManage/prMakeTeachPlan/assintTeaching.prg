...
<autoGraphics>
    <graphic name="assintTeaching" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>newExportServiceTeach.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/newExportServiceTeach.jsp</column>
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>newService4Teaching.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/newService4Teaching.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="176" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="172" x="202" y="332" lookAndFeel="classic">
