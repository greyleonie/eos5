...
<autoGraphics>
    <graphic name="subject4HeadChecked" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">subject4HeadChecked</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>subject4HeadChecked</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 02 17:22:34 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>subject4HeadChecked.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/subject4HeadChecked.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="191" x="425" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-2 下午5:22</value>
                    </property>
                    <property name="text" type="0">
                        <value>选择专题的审批人</value>
                    </property>
                </propertyList>
                <description/>
            </state>
