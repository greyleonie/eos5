...
<autoGraphics>
    <graphic name="queryTeacherByOrgIds" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>queryTeacherByOrgIds.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/queryTeacherByOrgIds.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">queryTeacherByOrgIds</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>queryTeacherByOrgIds</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri May 25 13:52:51 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="annotate" height="100" width="172" x="156" y="181" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添 07-7-20 上午9:37</value>
                    </property>
                    <property name="text" type="0">
                        <value>通过部门id查询教师</value>
                    </property>
                </propertyList>
                <description/>
            </state>
