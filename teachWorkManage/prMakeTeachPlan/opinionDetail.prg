...
<autoGraphics>
    <graphic name="opinionDetail" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">opinionDetail</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>opinionDetail</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Apr 25 10:47:34 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>opinionDetail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/opinionDetail.jsp</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="172" x="170" y="269" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-20 上午9:32</value>
                    </property>
