...
<autoGraphics>
    <graphic name="addCourse4FinalSpecialSubject" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">addCourse4FinalSpecialSubject</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>addCourse4FinalSpecialSubject</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Oct 11 10:47:38 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="649" y="168" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询教学模式</value>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询教学研究部</value>
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="38" y="163" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="4">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">unitID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="5">
                            <column num="0" name="passing" type="1">out</column>
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="158" y="163" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="409" y="168" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="278" y="163" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="529" y="168" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="184" x="444" y="428" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-10-11 上午11:17</value>
                    </property>
                    <property name="text" type="0">
                        <value>终稿中添加专题的课程</value>
                    </property>
                </propertyList>
                <description/>
            </state>
