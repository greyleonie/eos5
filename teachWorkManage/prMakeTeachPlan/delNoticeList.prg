...
<autoGraphics>
    <graphic name="delNoticeList" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">delNoticeList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>delNoticeList</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed May 30 18:31:01 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>rereshPageInNotice.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/rereshPageInNotice.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.delCourseAdjust</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="172" x="434" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 下午1:55</value>
                    </property>
