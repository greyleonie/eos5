...
<autoGraphics>
    <graphic name="filterSubject" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="1016" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="207" y="143" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="447" y="143" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="687" y="143" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="896" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="327" y="143" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>检查冲突</value>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="510" y="246" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>joinSql</value>
            ...
            <state color="16777215" id="14" typeName="useCase" height="48" width="48" x="167" y="55" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>专题的教学计划</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.planOfSubject</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="569" y="142" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询专题的课程</value>
            ...
            <state color="16777215" id="16" typeName="annotate" height="100" width="172" x="300" y="273" lookAndFeel="classic">
