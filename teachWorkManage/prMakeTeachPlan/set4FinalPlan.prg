...
<autoGraphics>
    <graphic name="set4FinalPlan" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">set4FinalPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>set4FinalPlan</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jun 28 13:38:55 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.set4FinalPlan</column>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="178" x="256" y="284" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添 07-7-20 上午10:04</value>
                    </property>
