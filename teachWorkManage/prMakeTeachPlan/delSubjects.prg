...
<autoGraphics>
    <graphic name="delSubjects" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">delSubjects</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>delSubjects</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Mar 15 16:04:12 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="499" y="105" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="161" y="214" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-15 下午4:04</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.delSubjects</column>
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="280" y="55" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="setField" height="48" width="48" x="271" y="135" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="396" y="105" lookAndFeel="classic">
