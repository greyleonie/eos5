...
<autoGraphics>
    <graphic name="addCourse" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">addCourse</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>addCourse</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 02 16:09:40 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="6" typeName="setField" height="48" width="48" x="656" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="191" x="1025" y="190" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="776" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="896" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>addCourse.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/addCourse.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询课堂模式</value>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="172" x="252" y="277" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">annotate</name>
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-7-19 下午1:43</value>
                    </property>
                    <property name="text" type="0">
                        <value>保存课程</value>
                    </property>
