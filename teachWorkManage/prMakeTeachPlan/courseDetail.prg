...
<autoGraphics>
    <graphic name="courseDetail" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="84" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">courseDetail</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Fri Mar 16 14:42:27 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="720" y="55" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="782" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添 07-3-16 下午2:42</value>
                    </property>
                    <property name="text" type="0">
                        <value>在课题库查看一个课程信息</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="643" y="55" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>courseView.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/courseView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="172" x="206" y="239" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">annotate</name>
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添07-7-19 下午1:51</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询一个课程的信息</value>
                    </property>
                </propertyList>
                <description/>
            </state>
