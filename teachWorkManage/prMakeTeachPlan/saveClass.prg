...
<autoGraphics>
    <graphic name="saveClass" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">saveClass</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>saveClass</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 07 15:23:14 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="936" y="216" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="191" x="865" y="350" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="376" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="616" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="setField" height="48" width="48" x="616" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="736" y="216" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>addClass.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/addClass.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="376" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.updateSpecialSubject</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="376" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>更新课程</value>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.updateCourse</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="11" typeName="transaction_begin" height="48" width="48" x="256" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="transaction_rollback" height="48" width="48" x="496" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="transaction_commit" height="48" width="48" x="496" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="303" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>把专题报名增加到动态信息</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <to>Shape.transaction_commit.13</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.transaction_commit.13</from>
