...
<autoGraphics>
    <graphic name="printFinalPlan" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">printFinalPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>printFinalPlan</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 31 11:18:28 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>printFinalPlan.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/printFinalPlan.jsp</column>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="203" x="315" y="191" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-31 上午11:27</value>
                    </property>
                    <property name="text" type="0">
                        <value>把定稿导出到doc</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.queryUnits</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="3">
                            ...
                            <column num="2" name="value" type="0">list[@type='TeachingPlanUnitTemp']</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
