...
<autoGraphics>
    <graphic name="executedPlan" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="917" y="59" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="335" y="172" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="593" y="168" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询课程</value>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="179" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>被选的教学模式</value>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="191" x="1025" y="190" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="removeEntity" height="48" width="48" x="469" y="165" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="annotate" height="100" width="172" x="652" y="268" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">annotate</name>
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添07-7-19 下午2:00</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询执行的教学计划</value>
                    </property>
                </propertyList>
                <description/>
            </state>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.removeEntity.12</from>
