...
<autoGraphics>
    <graphic name="leaderSetStateOfPlan" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">leaderSetStateOfPlan</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>leaderSetStateOfPlan</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jan 19 11:06:52 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>leaderSetOpinion4Plan</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.leaderSetOpinion4Plan</column>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>afterSetState4Plan.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/afterSetState4Plan.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="178" x="283" y="276" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-19 上午11:08</value>
                    </property>
                    <property name="text" type="0">
                        <value>领导审批（是否通过）</value>
                    </property>
                </propertyList>
                <description/>
            </state>
