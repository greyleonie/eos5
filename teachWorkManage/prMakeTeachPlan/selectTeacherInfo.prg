...
<autoGraphics>
    <graphic name="selectTeacherInfo" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="96" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">selectTeacherInfo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>selectTeacherInfo</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Feb 01 12:43:35 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="158" y="266" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-2-1 下午12:43</value>
                    </property>
                    <property name="text" type="0">
                        <value>查询老师的相关信息</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.selectTeacherInfo</column>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>manselect.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/common/page/manselect/manselect.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
