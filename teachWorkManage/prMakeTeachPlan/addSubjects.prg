...
<autoGraphics>
    <graphic name="addSubjects" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">addSubjects</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>addSubjects</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Mar 15 13:49:52 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="171" y="258" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-15 下午1:50</value>
                    </property>
                    <property name="text" type="0">
                        <value>进入新增课题库页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="293" y="57" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">Subjects/IsOuter</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">Subjects/ClassNoon</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="4">
                            <column num="0" name="passing" type="1">in</column>
