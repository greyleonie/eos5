...
<autoGraphics>
    <graphic name="sendPage2WebSite" type="prg" router="0">
        <states>
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="456" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>sendPageResult.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/sendPageResult.jsp</column>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="203" x="579" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-3-28 上午11:30</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.sendPage2WebSite</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">fileSource</column>
                        ...
                        <row num="1">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">field</column>
                            <column num="2" name="value" type="0">fileName</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">field</column>
                            <column num="2" name="value" type="0">dir</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="189" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>addSubjectDyNews</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.addSubjectDyNews</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">subjectNews</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="9" typeName="setField" height="48" width="48" x="189" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">fileName</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="656" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sendPage2WebSite</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>sendPage2WebSite</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 28 10:34:22 CST 2007</value>
                    </property>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">addNews</column>
                            <column num="1" name="compType">EQ</column>
                            <column num="2" name="rightValue">no</column>
                        </row>
                    </property>
                    <property name="expression" type="0">
                        <value/>
