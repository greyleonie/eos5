...
<autoGraphics>
    <graphic name="sendSubject2NetWork" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="86" y="67" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">sendSubject2NetWork</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>sendSubject2NetWork</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Mar 21 18:03:44 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="881" y="67" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="197" x="-17" y="489" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>把专题发布到外网	07-3-21 下午6:03</value>
                    </property>
            ...
            <state color="16777215" id="19" typeName="useCase" height="48" width="48" x="217" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="337" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>检查冲突</value>
            ...
            <state color="16777215" id="21" typeName="useCase" height="48" width="48" x="457" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="520" y="256" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>连接sql语句</value>
            ...
            <state color="16777215" id="23" typeName="useCase" height="48" width="48" x="577" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>专题的课程</value>
            ...
            <state color="16777215" id="24" typeName="useCase" height="48" width="48" x="697" y="153" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="25" typeName="view" height="48" width="48" x="779" y="66" lookAndFeel="classic">
