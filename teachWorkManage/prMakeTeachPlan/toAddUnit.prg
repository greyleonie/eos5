...
<autoGraphics>
    <graphic name="toAddUnit" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">toAddUnit</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>toAddUnit</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Jan 10 09:18:15 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="172" x="307" y="182" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添	07-1-10 上午9:32</value>
                    </property>
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.latestUnitEndTime</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
