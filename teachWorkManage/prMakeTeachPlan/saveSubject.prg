...
<autoGraphics>
    <graphic name="saveSubject" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">saveSubject</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>saveSubject</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Mar 01 09:28:25 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="517" y="109" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="annotate" height="100" width="191" x="545" y="190" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="176" y="136" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.saveSubject</column>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="413" y="110" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="setField" height="48" width="48" x="296" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置 -1</value>
