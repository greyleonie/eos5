...
<autoGraphics>
    <graphic name="showAllOrgView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>showAllOrgView.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/showAllOrgView.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizMakeTeachPlan.showAllOrgView</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">showAllOrgView</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>showAllOrgView</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jun 21 13:48:02 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="178" x="183" y="227" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>杨帮添 07-7-20 上午10:08</value>
                    </property>
