...
<autoGraphics>
    <graphic name="expSubjectCourse" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">expSubjectCourse</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>expSubjectCourse</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Jun 29 18:08:39 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="696" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>expSubjectCourse.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/makeTeachPlan/expSubjectCourse.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>数据设置</value>
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="576" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="576" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>查询专题的课程</value>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="172" x="834" y="190" lookAndFeel="classic">
