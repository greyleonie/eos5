...
<autoGraphics>
    <graphic name="inventoryAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/inventoryAdd.jsp</column>
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.inventoryAdd</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="336" y="207" lookAndFeel="classic">
