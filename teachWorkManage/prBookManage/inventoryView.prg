...
<autoGraphics>
    <graphic name="inventoryView" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="6" typeName="annotate" height="100" width="203" x="330" y="156" lookAndFeel="classic">
...
@description 查看盘点信息</value>
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.inventoryView</column>
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/inventoryView.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
