...
<autoGraphics>
    <graphic name="selectClassAndDepart" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="448" y="166" lookAndFeel="classic">
...
@description 选择班级和部门可以多选</value>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/selectClassAndDepart.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
