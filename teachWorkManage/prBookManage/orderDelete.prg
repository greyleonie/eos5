...
<autoGraphics>
    <graphic name="orderDelete" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="416" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.orderDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="23" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prBookManage.orderList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="24" typeName="setField" height="48" width="48" x="176" y="96" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="203" x="487" y="239" lookAndFeel="classic">
