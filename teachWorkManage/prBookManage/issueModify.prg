...
<autoGraphics>
    <graphic name="issueModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="11" typeName="annotate" height="100" width="197" x="229" y="221" lookAndFeel="classic">
...
@description  修改书本发放单明细表</value>
            ...
            <state color="16777215" id="14" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.issueModify</column>
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/issueModify.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
