...
<autoGraphics>
    <graphic name="orderAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/orderAdd.jsp</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="203" x="289" y="194" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 上午11:47</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 显示订购增加页面</value>
                    </property>
                </propertyList>
                <description/>
            </state>
