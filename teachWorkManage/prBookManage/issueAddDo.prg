...
<autoGraphics>
    <graphic name="issueAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="25" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.issueAddDo</column>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="value" type="0">TextbookIssue</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="27" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="28" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
