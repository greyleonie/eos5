...
<autoGraphics>
    <graphic name="buyDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="19" typeName="useCase" height="48" width="48" x="296" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.buyDelete</column>
            ...
            <state color="16777215" id="22" typeName="setField" height="48" width="48" x="176" y="96" lookAndFeel="classic">
...
@description 删除购买采购单</value>
            ...
            <state color="16777215" id="20" typeName="sub" height="48" width="48" x="416" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prBookManage.buyList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
