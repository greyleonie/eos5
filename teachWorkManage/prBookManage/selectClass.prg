...
<autoGraphics>
    <graphic name="selectClass" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="496" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="422" y="190" lookAndFeel="classic">
...
@description 选择班级可以多选</value>
            ...
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/selectClass.jsp</column>
