...
<autoGraphics>
    <graphic name="inventoryList" type="prg" router="0">
        <states>
            <state color="16777215" id="14" typeName="End" height="48" width="48" x="616" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="22" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/inventoryList.jsp</column>
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.inventoryList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">TextbookInventoryDetail</column>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="3">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">TextbookInventoryDetail/fcc</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="17" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">dingGouDetail</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>dingGouDetail</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Jan 11 13:47:22 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="21" typeName="annotate" height="100" width="197" x="542" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 下午2:10</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 盘点列表</value>
                    </property>
                </propertyList>
                <description/>
            </state>
