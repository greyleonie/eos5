...
<autoGraphics>
    <graphic name="inventoryModifyDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="203" x="419" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 修改书本盘点信息</value>
                    </property>
                </propertyList>
                <description/>
            </state>
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.inventoryModifyDo</column>
            ...
            <state color="16777215" id="17" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
