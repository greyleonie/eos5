...
<autoGraphics>
    <graphic name="textbookVerify" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="End" height="48" width="48" x="456" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="14" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>textbookFail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/textbookFail.jsp</column>
            ...
            <state color="16777215" id="13" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>textbookSuccess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/textbookSuccess.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="8" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">已经存在此教材订购单，请修改订购名称。</column>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.textbookVerify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">booklist</column>
            ...
            <state color="16777215" id="3" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prYW_MEDSTOCKINLISTInsertVerify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prYW_MEDSTOCKINLISTInsertVerify</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Aug 22 20:15:42 CST 2005</value>
                    </property>
            ...
            <state color="16777215" id="15" typeName="annotate" height="100" width="197" x="252" y="266" lookAndFeel="classic">
