...
<autoGraphics>
    <graphic name="destroyModify" type="prg" router="0">
        <states>
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/destroyModify.jsp</column>
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.destroyModify</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="annotate" height="100" width="197" x="422" y="190" lookAndFeel="classic">
