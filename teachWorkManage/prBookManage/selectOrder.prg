...
<autoGraphics>
    <graphic name="selectOrder" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="17" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/selectOrder.jsp</column>
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="197" x="381" y="151" lookAndFeel="classic">
