...
<autoGraphics>
    <graphic name="buyAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="16" typeName="view" height="48" width="48" x="336" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>buyAdd.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/BookManage/buyAdd.jsp</column>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="197" x="462" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	07-1-19 下午3:32</value>
                    </property>
                    <property name="text" type="0">
                        <value>@author 金刚&#13;
@description 采购增加</value>
                    </property>
                </propertyList>
                <description/>
            </state>
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <propertyList>
                    ...
                    <property name="refPath" type="3">
                        <row num="0">
                            <column num="0" name="leftValue">fid</column>
