...
<autoGraphics>
    <graphic name="inventoryAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="24" typeName="annotate" height="100" width="197" x="422" y="230" lookAndFeel="classic">
            ...
            <state color="16777215" id="25" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizBookManage.inventoryAddDo</column>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="value" type="0">TextbookInventory</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="26" typeName="view" height="48" width="48" x="296" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="28" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prBookManage.inventoryList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
