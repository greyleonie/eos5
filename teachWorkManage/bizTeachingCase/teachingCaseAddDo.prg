...
<autoGraphics>
    <graphic name="teachingCaseAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>VO_success.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachingCase/VO_success.jsp</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachingCase.teachingCaseAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="9" typeName="annotate" height="98" width="178" x="471" y="231" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>Administrator	06-12-31 下午3:05</value>
                    </property>
...
@概要　执行教学案例录入</value>
            ...
            <state color="16777215" id="10" typeName="removeEntity" height="48" width="48" x="216" y="176" lookAndFeel="classic">
