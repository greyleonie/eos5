...
<autoGraphics>
    <graphic name="prAddExtraLev" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prTeachEvaluate.prExtraEvlModify</column>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachEvaluate.bizAddEvlLev</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
