...
<autoGraphics>
    <graphic name="prClassRankReport" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>主体班排名汇总导出页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/finalEvl/finalRankReport.jsp</column>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="227" x="647" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-19 下午3:01</value>
                    </property>
