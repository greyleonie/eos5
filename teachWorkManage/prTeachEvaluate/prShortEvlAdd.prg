...
<autoGraphics>
    <graphic name="prShortEvlAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>进入短班评估设置页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/shortEvl/shortEvlTable_add.jsp</column>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="227" x="767" y="190" lookAndFeel="classic">
