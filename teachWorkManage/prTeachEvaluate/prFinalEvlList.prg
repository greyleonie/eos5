...
<autoGraphics>
    <graphic name="prFinalEvlList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/finalEvl/FinalEvlTable.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
