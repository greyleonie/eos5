...
<autoGraphics>
    <graphic name="prWeekDetailReport" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="1016" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/weekEvl/weekEvlReport.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="15" typeName="useCase" height="48" width="48" x="896" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>互动课回收率统计</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="14" typeName="annotate" height="100" width="227" x="1127" y="190" lookAndFeel="classic">
