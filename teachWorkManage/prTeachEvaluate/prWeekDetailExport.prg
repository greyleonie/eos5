...
<autoGraphics>
    <graphic name="prWeekDetailExport" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="656" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="776" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>导出主体班明细汇总</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/weekEvl/weekEvlExport.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="12" typeName="annotate" height="100" width="227" x="887" y="190" lookAndFeel="classic">
