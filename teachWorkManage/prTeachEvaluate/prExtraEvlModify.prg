...
<autoGraphics>
    <graphic name="prExtraEvlModify" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachEvaluate.bizGetEvlById</column>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">EvaluationID</column>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="227" x="647" y="190" lookAndFeel="classic">
