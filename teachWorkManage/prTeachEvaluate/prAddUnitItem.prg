...
<autoGraphics>
    <graphic name="prAddUnitItem" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.prTeachEvaluate.prUnitEvlModify</column>
            ...
            <state color="16777215" id="7" typeName="annotate" height="100" width="227" x="199" y="207" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>范志竞	07-7-19 下午1:54</value>
                    </property>
