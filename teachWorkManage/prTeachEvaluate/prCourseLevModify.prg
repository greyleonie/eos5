...
<autoGraphics>
    <graphic name="prCourseLevModify" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prCourseLevModify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prCourseLevModify</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Feb 08 15:12:56 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/shortEvl/shortModifylev_popup.jsp</column>
