...
<autoGraphics>
    <graphic name="prEvlLevDel" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prEvlItemDel</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prEvlItemDel</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Feb 06 09:35:37 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">teachWorkManage.bizTeachEvaluate.bizDelEvlLev</column>
