...
<autoGraphics>
    <graphic name="prWeekEvlList" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>进入主体班每周评估表设置首面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/teachWorkManage/page/teachEvaluate/weekEvl/WeekEvlTable.jsp</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Jan 29 18:26:24 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="8" typeName="annotate" height="100" width="227" x="527" y="190" lookAndFeel="classic">
