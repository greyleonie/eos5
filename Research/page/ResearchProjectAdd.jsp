...
%>
<body>
	<form method="post" name="myform" action="Research.pr.prResearchProjectAddDo.do">		
		<html:hidden property="WFWorkItem/submitType" />		
		<html:hidden property="id" />
		<input type="hidden" name="WCMMetaTablePaperBuild/WCMMetaTablePaperBuildID" value='<bean:write property="id"/>' />
...
<script language="javascript">
	...
	function save() {
		...
		frm.action = "Research.pr.prResearchProjectAddDo.do";
