...
%>
<body>
	<form method="post" name="myform" action="Research.pr.prResearchProvinceAddDo.do">		
		<html:hidden property="WFWorkItem/submitType" />		
		<html:hidden property="id" />
		<input type="hidden" name="WCMMetaTableProvincePaperApp/WCMMetaTableProvincePaperAppID" value='<bean:write property="id"/>' />
...
<script language="javascript">
	...
	function save() {
		...
		frm.action = "Research.pr.prResearchProvinceAddDo.do";
