...
<body>
	<form method="post" name="myform" action="Research.pr.prResearchFundingProcessDo.do" enctype="multipart/form-data">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr>
				<td height="5">
					...
					<html:hidden property="WCMMetaTableAccountExpense/WCMMetaTableAccountExpenseID" />
					<html:hidden property="WCMMetaTableAccountExpense/participant" />
					<html:hidden property="WCMMetaTableAccountExpense/passParticipant" />
...
function returnNode(){
	...
	if(isSure==true){
		...
		try{
		document.getElementById('WCMMetaTableAccountExpense/nextParticipantName').value='<bean:write property="ExtendData/PassedNode/UserID"/>';
		}catch(e){
		
		}
		document.getElementById('WCMMetaTableAccountExpense/nextParticipantId').value='<bean:write property="ExtendData/PassedNode/UserID"/>';
