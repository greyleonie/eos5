...
<autoGraphics>
    <graphic name="prResearchOtherAddDO" type="prg" router="0">
        <states>
            <state color="16777215" id="16" typeName="End" height="48" width="48" x="516" y="156" lookAndFeel="classic">
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="406" y="196" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="276" y="316" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>执行流程流转处理</value>
                    </property>
            ...
            <state color="16777215" id="17" typeName="setField" height="48" width="48" x="276" y="196" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>判断执行保存或是发送操作</value>
                    </property>
                    <property name="parameter" type="5"/>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="18" typeName="view" height="48" width="48" x="396" y="76" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>sendFail.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="277" y="74" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchOtherAddDO</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchOtherAddDO</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="21" typeName="Start" height="48" width="48" x="156" y="76" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prResearchCountryAddDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prResearchCountryAddDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Wed Aug 03 14:51:35 CST 2011</value>
                    </property>
