...
<autoGraphics>
    <graphic name="prResearchOtherProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="18" typeName="End" height="48" width="48" x="795" y="85" lookAndFeel="classic">
            ...
            <state color="16777215" id="21" typeName="view" height="48" width="48" x="793" y="203" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchOtherProcess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchOtherProcess.jsp</column>
            ...
            <state color="16777215" id="15" typeName="view" height="48" width="48" x="606" y="86" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="16" typeName="useCase" height="48" width="48" x="486" y="206" lookAndFeel="classic">
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="487" y="94" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchOtherProcess</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchOtherProcess</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="19" typeName="Start" height="48" width="48" x="86" y="86" lookAndFeel="classic">
