...
<autoGraphics>
    <graphic name="prResearchCountryProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="15" typeName="End" height="48" width="48" x="775" y="65" lookAndFeel="classic">
            ...
            <state color="16777215" id="16" typeName="Start" height="48" width="48" x="66" y="66" lookAndFeel="classic">
            ...
            <state color="16777215" id="23" typeName="view" height="48" width="48" x="775" y="186" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchCountryProcess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchCountryProcess.jsp</column>
            ...
            <state color="16777215" id="17" typeName="view" height="48" width="48" x="586" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="20" typeName="useCase" height="48" width="48" x="466" y="186" lookAndFeel="classic">
            ...
            <state color="16777215" id="22" typeName="useCase" height="48" width="48" x="467" y="66" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchCountryProcess</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchCountryProcess</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
