...
<autoGraphics>
    <graphic name="prResearchCityAddDo" type="prg" router="0">
        <states>
            <state color="16777215" id="11" typeName="view" height="48" width="48" x="400" y="201" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="280" y="86" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchCityAddDo</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchCityAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
