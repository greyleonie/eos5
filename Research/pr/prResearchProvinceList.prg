...
<autoGraphics>
    <graphic name="prResearchProvinceList" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="End" height="48" width="48" x="776" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchProvinceList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchProvinceList.jsp</column>
            ...
            <state color="16777215" id="10" typeName="setField" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="useCase" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchProvinceList</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchProvinceList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="6" typeName="setField" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">setField</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="11" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="7" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
