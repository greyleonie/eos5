...
<autoGraphics>
    <graphic name="prResearchDXSystemProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="7" typeName="End" height="48" width="48" x="795" y="85" lookAndFeel="classic">
            ...
            <state color="16777215" id="12" typeName="view" height="48" width="48" x="796" y="211" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchDXSystemProcess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchDXSystemProcess.jsp</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="606" y="86" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="486" y="206" lookAndFeel="classic">
            ...
            <state color="16777215" id="13" typeName="useCase" height="48" width="48" x="492" y="90" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchDXSystemProcess</value>
                    </property>
                    <property name="unitName" type="0">
                        <value>Product</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchDXSystemProcess</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
