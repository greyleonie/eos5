...
<autoGraphics>
    <graphic name="prResearchProjectProcess" type="prg" router="0">
        <states>
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="476" y="76" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchProjectProcess</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchProjectProcess</column>
            ...
            <state color="16777215" id="10" typeName="view" height="48" width="48" x="790" y="213" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchProjectProcess.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchProjectProcess.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
