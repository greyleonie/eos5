...
<autoGraphics>
    <graphic name="prResearchCountryAdd" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizResearchCountryStart</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">Research.biz.bizResearchCountryStart</column>
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">WCMMetaTablecountryPaperApp</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
                        ...
                        <row num="2">
                            ...
                            <column num="1" name="type" type="1">constant</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">WCMMetaTablecountryPaperAppID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="3">
                            <column num="0" name="passing" type="1">out</column>
            ...
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>ResearchCountryAdd.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/Research/page/ResearchCountryAdd.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
