...
<autoGraphics>
    <graphic name="prDelKnowledgeById" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prDelKnowledgeById</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prDelKnowledgeById</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 26 02:12:59 GMT 2010</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizDelKnowledgeBaseById</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizKownledgeBase.bizDelKnowledgeBaseById</column>
            ...
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.prKnowledgeBase.prGetKnowledgeBaseList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
