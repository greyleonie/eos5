...
<autoGraphics>
    <graphic name="prUpdateKnowledgeById" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prUpdateKnowledgeById</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prUpdateKnowledgeById</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Tue Jan 26 02:11:35 GMT 2010</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizUpdateKnowledgeBaseById</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizKownledgeBase.bizUpdateKnowledgeBaseById</column>
