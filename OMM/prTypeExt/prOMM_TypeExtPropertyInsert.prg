...
<autoGraphics>
    <graphic name="prOMM_TypeExtPropertyInsert" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="96" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>给OMM_TypeExtProperty)增加记录(OMM.bizTypeExt.bizOMM_TypeExtPropertyInsert)</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizTypeExt.bizOMM_TypeExtPropertyInsert</column>
            ...
            <state color="16777215" id="12" typeName="sub" height="48" width="48" x="296" y="176" lookAndFeel="classic">
