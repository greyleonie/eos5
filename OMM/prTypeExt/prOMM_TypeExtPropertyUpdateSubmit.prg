...
<autoGraphics>
    <graphic name="prOMM_TypeExtPropertyUpdateSubmit" type="prg" router="0">
        <states>
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="656" y="136" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="sub" height="48" width="48" x="536" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="536" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="8" typeName="transaction_rollback" height="48" width="48" x="416" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="transaction_commit" height="48" width="48" x="416" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="296" y="136" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>修改OMM_TypeExtProperty信息</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizTypeExt.bizOMM_TypeExtPropertyUpdate</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="6" typeName="transaction_begin" height="48" width="48" x="176" y="136" lookAndFeel="classic">
        ...
        <connectors>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.transaction_rollback.8</from>
                <to>Shape.view.4</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.transaction_commit.7</from>
                <to>Shape.sub.10</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <to>Shape.transaction_commit.7</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.useCase.3</from>
                <to>Shape.transaction_rollback.8</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
            ...
            <connector color="0" description="" id="-2" type="connection">
                <from>Shape.transaction_begin.6</from>
            ...
            <connector color="0" description="" id="-2" type="connection">
                ...
                <to>Shape.transaction_begin.6</to>
                <propertyList>
                    <property name="isSimpleExpression" type="0">
                        <value>true</value>
                    </property>
