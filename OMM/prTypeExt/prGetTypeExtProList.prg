...
<autoGraphics>
    <graphic name="prGetTypeExtProList" type="prg" router="0">
        <states>
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="474" y="72" lookAndFeel="classic">
            ...
            <state color="16777215" id="5" typeName="view" height="48" width="48" x="356" y="69" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>OMM_TypeExtPropertyList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/OMM/pageTypeExt/OMM_TypeExtPropertyList.jsp</column>
            ...
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="123" y="61" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">OMM_TypeExtProperty/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="27" y="62" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prGetTypeExtProList</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Mon Aug 03 08:13:33 CST 2009</value>
                    </property>
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="226" y="131" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizOMM_TypeExtPropertyQuery</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizTypeExt.bizOMM_TypeExtPropertyQuery</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">OMM_TypeExtProperty</column>
