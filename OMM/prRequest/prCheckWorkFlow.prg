...
<autoGraphics>
    <graphic name="prCheckWorkFlow" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>checkWorkFlow.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/OMM/pageRequest/checkWorkFlow.jsp</column>
            ...
            <state color="16777215" id="6" typeName="useCase" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.biz.bizCheckWorkFlow</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prCheckWorkFlow</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prCheckWorkFlow</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Nov 30 06:53:50 GMT 2009</value>
                    </property>
