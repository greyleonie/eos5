...
<wizardContent version="1.0">
    <content>
        <formAction value="OMM.prTypeExt.prOMM_TypeExtPropertyUpdateSubmit.do" type="String"/>
        <cols value="3" type="Integer"/>
        <title value="修改(OMM_TypeExtProperty)信息" type="String"/>
 ...
 --%>
<form action="OMM.prTypeExt.prOMM_TypeExtPropertyUpdateSubmit.do" target="_top" name="inputForm" method="post">	
<TABLE width="80%" border="0" align="center" cellPadding="0" cellSpacing="0" class="pg_add">
	<TR><TD class="pg_add_title" colspan="6">修改(OMM_TypeExtProperty)信息</TD></TR>
