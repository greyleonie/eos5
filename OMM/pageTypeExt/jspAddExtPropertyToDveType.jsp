...
<body>
	<form method="post" action="OMM.prTypeExt.prOMM_TypeExtPropertyInsert.do">
			...
			<tr>
				<td height="24" background="/internet/image/lz_bg.gif">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="15"></td>
							<td class="text_wirte">运维管理—&gt;IT设备管理—&gt;设备类型—&gt;扩展属性—&gt;新增扩展属性</td>
						</tr>
					</table>
				</td>
			</tr>
					...
					<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
						<tr>
							...
							<td width="70%" class="td1">
								<html:text name="OMM_TypeExtProperty/TypeExtPropertyID" property="OMM_DevType/TypeID" readonly="true"/>
...
<script>
	 function save() {
		...
		var value=frm.elements["OMM_TypeExtProperty/TypeExtPropertyID"].value;
		//alert(value);
		if (value== -1) {
			alert("请选择类型标识号!");
			frm.elements["OMM_TypeExtProperty/TypeExtPropertyID"].focus();
			return;
		}
		value = null;
