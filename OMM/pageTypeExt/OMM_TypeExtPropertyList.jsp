	...
	<form method="post" action="OMM.prTypeExt.prOMM_TypeExtPropertyQuery.do">
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				...
				<input type="hidden" name="addaction" value="OMM.prTypeExt.prOMM_TypeExtPropertyInsert.do"> 
									 ...
									 <logic:iterate id="resultset" property="list[@type='OMM_TypeExtProperty']">
									 	<%
									 	 ...
									 	 <tr class="<%=trClass%>" onClick="changeTRBgColor(this)"
									 	 	onDblClick="talentviewf('<bean:write id="resultset" property="OMM_TypeExtProperty/ExtPropertyID"/>','false')">
											<td align="center">
												<logic:present id="resultset" property="OMM_TypeExtProperty/TypeID">
													<html:checkbox id="resultset" name="list[@name='update']/OMM_TypeExtProperty/TypeExtPropertyID" 
													property="OMM_TypeExtProperty/TypeExtPropertyID" indexed="true"/>
												</logic:present>
											</td><!--
											...
											<td nowrap align="center">
												<logic:equal id="resultset" property="OMM_TypeExtProperty/ExtPropertyMode" value="1">文本</logic:equal>
												<logic:notEqual id="resultset" property="OMM_TypeExtProperty/ExtPropertyMode" value="1">下拉框</logic:notEqual>
											...
											<td nowrap align="center">
												<logic:equal property="OMM_TypeExtProperty/ExtPropertyMode" value="1">
													<html:hidden name="OMM_TypeExtProperty/ExtPropertyOptions" property="OMM_TypeExtProperty/ExtPropertyOptions"/>
													<html:select  property="OMM_TypeExtProperty/ExtPropertyOptions" >
														<script language="Javascript">
															//sel_type();
														</script>
          												<!--<html:option  value="-1">选择类型标号</html:option> property="OMM_TypeExtProperty/TypeID" -->
					                   					<html:options property="list[@type='OMM_DevType']/OMM_DevType/TypeID" labelProperty="list[@type='OMM_DevType']/OMM_DevType/TypeID"/>
					           						</html:select>
												</logic:equal>
...
<script>
	...
	function extPropertyAdd(){
		window.location.href="OMM.prTypeExt.prOMM_ExtPropertyAdd.do";
	}
