		    ...
		    <tr>
		    	<td class="text">
		    		<table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
						...
						<tr>
           					<td align="right" class="td2" nowrap>维修员列表： </td>
				            <td class="td1">
				            	<select size="10" style="width:150"   name="userid" onclick="Confirm()"></select>
				            	<font color="red">提示：单击选取维修员标识号</font>
...
<script language="JavaScript">
	...
	function selectOrg(){
		...
		frm.action="OMM.prOMM_MaintenanceMapping.prManOfOrg.do";
	...
	//	mobilenumsObj=window.opener.messageForm.mobilenums;
		...
		//pObject.addOptionBtn1(mobile.innerText,mobile.value);
        this.parent.window.opener.addOptionBtn1(mobile.innerText,mobile.value);
