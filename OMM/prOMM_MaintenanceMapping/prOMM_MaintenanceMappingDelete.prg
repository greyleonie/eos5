...
<autoGraphics>
    <graphic name="prOMM_MaintenanceMappingDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Tue Aug 25 09:40:28 GMT 2009</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>删除(OMM_MaintenanceMapping)记录</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizOMM_MaintenanceMapping.bizOMM_MaintenanceMappingDelete</column>
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="296" y="56" lookAndFeel="classic">
