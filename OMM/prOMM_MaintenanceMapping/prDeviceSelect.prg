...
<autoGraphics>
    <graphic name="prDeviceSelect" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prDeviceSelect</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prDeviceSelect</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Aug 20 08:35:20 GMT 2009</value>
                    </property>
