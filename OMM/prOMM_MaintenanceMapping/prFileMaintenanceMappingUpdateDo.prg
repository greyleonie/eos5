...
<autoGraphics>
    <graphic name="prFileMaintenanceMappingUpdateDo" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="100" y="150" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prFileMaintenanceMappingUpdateDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prFileMaintenanceMappingUpdateDo</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Aug 28 07:28:49 GMT 2009</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="sub" height="48" width="48" x="341" y="76" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.prOMM_MaintenanceMapping.prMaintenanceMappingList</column>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="222" y="148" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizMaintenanceMappingUpdateDo</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizOMM_MaintenanceMapping.bizMaintenanceMappingUpdateDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">MaintenanceMappingTemp</column>
