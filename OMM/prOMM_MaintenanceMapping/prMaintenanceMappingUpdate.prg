...
<autoGraphics>
    <graphic name="prMaintenanceMappingUpdate" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prMaintenanceMappingUpdate</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prMaintenanceMappingUpdate</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Fri Aug 28 01:40:44 GMT 2009</value>
                    </property>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="659" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="339" y="64" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizMaitenanceMappingUpdate</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizOMM_MaintenanceMapping.bizMaitenanceMappingUpdate</column>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="522" y="58" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>jspMaintenanceMappingUpdate.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/OMM/pageOMM_MaintenanceMapping/jspMaintenanceMappingUpdate.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
            ...
            <state color="16777215" id="5" typeName="setField" height="48" width="48" x="200" y="70" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">list[@name='update']/OMM_MaintenanceMappingTemp2/MaintenanceMappingID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">query/OMM_MaintenanceMapping/MaintenanceMappingID</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
