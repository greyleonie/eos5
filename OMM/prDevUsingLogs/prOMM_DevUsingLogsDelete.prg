...
<autoGraphics>
    <graphic name="prOMM_DevUsingLogsDelete" type="prg" router="0">
        <states>
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="542" y="185" lookAndFeel="classic">
            ...
            <state color="16777215" id="6" typeName="sub" height="48" width="48" x="422" y="185" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>删除(OMM_DevUsingLogs)记录(OMM.bizDevUsingLogs.bizOMM_DevUsingLogsDelete)</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizDevUsingLogs.bizOMM_DevUsingLogsDelete</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="7" typeName="removeEntity" height="48" width="48" x="300" y="136" lookAndFeel="classic">
