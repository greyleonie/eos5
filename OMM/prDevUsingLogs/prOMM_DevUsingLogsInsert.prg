...
<autoGraphics>
    <graphic name="prOMM_DevUsingLogsInsert" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>给OMM_DevUsingLogs)增加记录</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizDevUsingLogs.bizOMM_DevUsingLogsInsert</column>
