...
<autoGraphics>
    <graphic name="prOMM_DveUsingLogsModify" type="prg" router="0">
        <states>
            <state color="16777215" id="4" typeName="sub" height="48" width="48" x="371" y="86" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>prOMM_DevUsingLogsList</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.prDevUsingLogs.prOMM_DevUsingLogsList</column>
            ...
            <state color="16777215" id="6" typeName="removeEntity" height="48" width="48" x="290" y="69" lookAndFeel="classic">
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="514" y="114" lookAndFeel="classic">
            ...
            <state color="16777215" id="3" typeName="useCase" height="48" width="48" x="184" y="115" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizOMM_DevUsingLogsUpdate</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizDevUsingLogs.bizOMM_DevUsingLogsUpdate</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">OMM_DevUsingLogs</column>
                        ...
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
                            <column num="1" name="type" type="1">EOSEntity</column>
                            <column num="2" name="value" type="0">OMM_DevUsingLogs2</column>
                            <column num="3" name="inPath" type="0">/</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="38" y="118" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prOMM_DveUsingLogsModify</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prOMM_DveUsingLogsModify</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Aug 09 06:29:53 GMT 2009</value>
                    </property>
