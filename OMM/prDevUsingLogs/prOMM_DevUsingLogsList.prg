...
<autoGraphics>
    <graphic name="prOMM_DevUsingLogsList" type="prg" router="0">
        <states>
            <state color="16777215" id="3" typeName="setField" height="48" width="48" x="180" y="58" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        ...
                        <row num="1">
                            ...
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">OMM_DevUsingLogs/init</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                        <row num="2">
                            <column num="0" name="passing" type="1">in</column>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="548" y="59" lookAndFeel="classic">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prOMM_DevUsingLogsList</name>
                <propertyList>
                    ...
                    <property name="date" type="0">
                        <value>Wed Aug 05 10:47:22 CST 2009</value>
                    </property>
            ...
            <state color="16777215" id="5" typeName="useCase" height="48" width="48" x="308" y="59" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>bizGetDevUsingLogsList</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">OMM.bizDevUsingLogs.bizGetDevUsingLogsList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="4" typeName="view" height="48" width="48" x="428" y="59" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>DevUsingLogsQueryList.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/OMM/pageDevUsingLogs/DevUsingLogsQueryList.jsp</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="description" type="0">
