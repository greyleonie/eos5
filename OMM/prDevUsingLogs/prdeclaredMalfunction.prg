...
<autoGraphics>
    <graphic name="prdeclaredMalfunction" type="prg" router="0">
        <states>
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="100" y="150" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">prdeclaredMalfunction</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>prdeclaredMalfunction</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Aug 13 01:13:29 GMT 2009</value>
                    </property>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="249" y="158" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>declaredMalfunction.jsp</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/OMM/pageDevUsingLogs/declaredMalfunction.jsp</column>
