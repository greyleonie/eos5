			...
			<tr>
				<td height="24" background="image/lz_bg.gif">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="printTable">
						<tr>
							<td width="15"></td>
							<td class="text_wirte">运维管理—&gt;IT设备管理—&gt;设备类型
			...
			<tr>
				<td>
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td height="30" class="text"><a title='关键字可以是"类型名称"' id="keytitle">类型名称</a>：
								...
								<input name="query" type="button" class="button_02" value="查 询" onClick="talentquery()"> <input name="add"
									...
									class="button_02" value="删 除" onClick="talentdelete()"> <input name="modifyandsave" type="button"
									class="button_02" value="修改保存" onClick="modifySave('listdetail')"> 
        ...
        %>
										<tr class="<%=trClass%>" onClick="changeTRBgColor(this)"
											...
											<td nowrap align="center">&nbsp; <A
													href='OMM.prTypeExt.prGetTypeExtProListById.do?OMM_DevType/TypeID=<bean:write id="resultset" property="OMM_DevType/TypeID" />'>配置</A></td>
										</tr>
									</logic:iterate>
								</table>
