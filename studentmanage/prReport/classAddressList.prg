...
<autoGraphics>
    <graphic name="classAddressList" type="prg" router="0">
        <states>
            <state color="16777215" id="6" typeName="view" height="48" width="48" x="656" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/report/classAddressList.jsp</column>
            ...
            <state color="16777215" id="2" typeName="End" height="48" width="48" x="771" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="10" typeName="useCase" height="48" width="48" x="536" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.bizReport.teacherList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="9" typeName="useCase" height="48" width="48" x="416" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.bizReport.queryStudentList</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">classAddressList</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>classAddressList</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Mon Feb 12 15:09:15 CST 2007</value>
                    </property>
            ...
            <state color="16777215" id="4" typeName="setField" height="48" width="48" x="296" y="56" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="annotate" height="91" width="197" x="580" y="184" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-2-12 下午3:11</value>
                    </property>
