...
<autoGraphics>
    <graphic name="classSubjectAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="12" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.bizScore.classSubjectAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
            ...
            <state color="16777215" id="16" typeName="annotate" height="64" width="197" x="265" y="299" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-1-10 下午4:47</value>
                    </property>
