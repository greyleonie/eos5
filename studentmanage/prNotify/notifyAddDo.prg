...
<autoGraphics>
    <graphic name="notifyAddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="20" typeName="view" height="48" width="48" x="336" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/notify/notifyReturn.jsp</column>
            ...
            <state color="16777215" id="15" typeName="setField" height="48" width="48" x="216" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="3" name="value" type="0">ClassNotify/ClassID</column>
                        ...
                        <row num="1">
                            ...
                            <column num="1" name="type" type="1">variable</column>
                            <column num="2" name="paraType" type="1">appArea</column>
                            <column num="3" name="value" type="0">QueryClassNotify/ClassID/criteria/value</column>
                            <column num="4" name="name" type="0"/>
                        </row>
                    </property>
                    <property name="action" type="2">
            ...
            <state color="16777215" id="17" typeName="useCase" height="48" width="48" x="216" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>执行班级通知新增</value>
                    </property>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.bizNotify.notifyAddDo</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    ...
                    <property name="parameter" type="5">
                        <row num="0">
                            ...
                            <column num="2" name="value" type="0">ClassNotify</column>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="96" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">teachingCaseAddDo</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>teachingCaseAddDo</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Sun Dec 31 09:37:56 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="19" typeName="annotate" height="100" width="197" x="462" y="230" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-2-26 下午2:08</value>
                    </property>
