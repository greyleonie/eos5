...
<autoGraphics>
    <graphic name="notifyAdd" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/notify/notifyAdd.jsp</column>
            ...
            <state color="16777215" id="9" typeName="annotate" height="100" width="197" x="226" y="226" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-2-26 下午1:55</value>
                    </property>
