...
<autoGraphics>
    <graphic name="classInfoManage" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="1" typeName="Start" height="48" width="48" x="56" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">classInfoManage</name>
                <propertyList>
                    <property name="id" type="0">
                        <value>classInfoManage</value>
                    </property>
                    <property name="display_text" type="0">
                        <value>开始</value>
                    </property>
                    ...
                    <property name="date" type="0">
                        <value>Thu Dec 21 09:36:55 CST 2006</value>
                    </property>
            ...
            <state color="16777215" id="20" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>班级信息管理页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/classInfo/classInfoManage.jsp</column>
            ...
            <state color="16777215" id="21" typeName="annotate" height="100" width="197" x="302" y="190" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-7-19 下午3:47</value>
                    </property>
