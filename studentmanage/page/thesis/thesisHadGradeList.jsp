...
<body>
<form method="post" action="studentmanage.prThesis.thesisHadGradeList.do" target="" >
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr> 
	  ...
	  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr> 
            <td width="15"> </td>
            <td class="text_wirte">学员管理—&gt;学员文章管理—&gt;学员文章批改—&gt;已批改文章</td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td height="5">
		<input type="hidden" name="queryaction" value="studentmanage.prThesis.thesisHadGradeList.do">
...
<table width="96%"  border="0" align="center" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	    ...
	    <qx:talentButton property="view" type="button" styleClass="button_02" value="重 批" onclick="talentmodify()" operation="DX_STUDENT_MANAGE_ARTICLE_GRADE_YP.DX_STUDENT_MANAGE_ARTICLE_GRADE_YP_CP"/>
      ...
      <tr>
		...
		<table width="100%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC" id="listdetail">
                <tr class="td_title"> 
                  ...
                  <td width="7%" align="center" nowrap id="QueryThesis.Score" onclick="talentsort()">成绩</td>
                ...
                <tr class="<%=trClass%>" onclick="changeTRBgColor(this)" onDblClick="talentviewf('<bean:write id="resultset" property="QueryThesis/ThesisID"/>','true')"> 
                  ...
                  <td align="center" nowrap>
                    ...
                    <bean:write id="resultset" property="QueryThesis/Score" />
