...
<form method="post" enctype="multipart/form-data" action="studentmanage.prNotify.notifyModifyDo.do">
  <html:hidden property="ClassNotify/ClassNotifyID"/>
  <html:hidden property="QueryClassNotify/ClassID/criteria/value"/>
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">学员管理—&gt;班级通知—&gt;通知修改</td>
          </tr>
      </table></td>
    </tr>
  </table>
