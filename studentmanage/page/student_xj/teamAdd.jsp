...
<form method="post" enctype="multipart/form-data" action="studentmanage.student_xj.teamAddDo.do">
  <html:hidden name="Team/ClassID" property="QueryTeam/ClassID/criteria/value"/>
    ...
    <tr>
      <td height="24" background="/internet/image/lz_bg.gif">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15"> </td>
            <td class="text_wirte">学员管理—&gt;学籍管理—&gt;班组新增</td>
          </tr>
      </table></td>
    </tr>
  </table>
    ...
    <tr>
      <td class="text"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#A2C4DC">
          ...
          <tr  onClick="changeTRBgColor(this)">
            ...
            <bean:write property="Team/ClassName"/>
			</td>
          </tr>
          <tr  onClick="changeTRBgColor(this)">
