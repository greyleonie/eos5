		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="5"><input type="hidden" name="queryaction" value="studentmanage.student_xj.xjlist.do"> <input
						...
						value="studentmanage.student_xj.xjImport.do">
			...
			<tr>
				<td>
					<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td class="text">班 级：
								<html:select property="QueryStudent/ClassID/criteria/value" onchange="talentquery3()"
									attributesText='id="printTable"'>
									<html:option value="-1">--请选择班级--</html:option>
									<html:options property="list[@type='studentclass']/Class/ClassID"
										labelProperty="list[@type='studentclass']/Class/ClassName" />
								</html:select>
								&nbsp; <%String check = "";
		%>
