...
<autoGraphics>
    <graphic name="xjImport" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="3" typeName="view" height="48" width="48" x="176" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="display_text" type="0">
                        <value>导入学生信息页面</value>
                    </property>
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/student_xj/xjImport.jsp</column>
            ...
            <state color="16777215" id="4" typeName="annotate" height="103" width="197" x="302" y="189" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-1-17 下午4:48</value>
                    </property>
