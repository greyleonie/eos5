...
<autoGraphics>
    <graphic name="xjTuixue" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="7" typeName="view" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">/studentmanage/page/student_xj/xjTuixue.jsp</column>
            ...
            <state color="16777215" id="6" typeName="annotate" height="125" width="197" x="422" y="178" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	07-1-15 下午5:11</value>
                    </property>
