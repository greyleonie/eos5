...
<autoGraphics>
    <graphic name="xjaddDo" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="8" typeName="view" height="48" width="48" x="376" y="176" lookAndFeel="classic">
            ...
            <state color="16777215" id="9" typeName="view" height="48" width="48" x="376" y="56" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">view</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>学员重复页面</value>
            ...
            <state color="16777215" id="4" typeName="useCase" height="48" width="48" x="256" y="176" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.bstudent_xj.studentaddDO</column>
                            <column num="1" name="type">constant</column>
                        </row>
                    </property>
                    <property name="unitId" type="2">
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="376" y="296" lookAndFeel="classic">
            ...
            <state color="16777215" id="7" typeName="useCase" height="48" width="48" x="256" y="296" lookAndFeel="classic">
                <name fontName="System" fontSize="12" fontWidth="550" foreColor="0" isItalic="0" isUnderline="0" textHeight="60">useCase</name>
                <propertyList>
                    <property name="display_text" type="0">
                        <value>保存学员相片</value>
            ...
            <state color="16777215" id="10" typeName="annotate" height="100" width="213" x="317" y="439" lookAndFeel="classic">
                ...
                <propertyList>
                    <property name="title" type="0">
                        <value>陈绍栋	06-11-17 上午9:33</value>
                    </property>
