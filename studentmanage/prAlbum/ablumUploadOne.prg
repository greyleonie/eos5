...
<autoGraphics>
    <graphic name="ablumUploadOne" type="prg" router="0">
        <states>
            ...
            <state color="16777215" id="5" typeName="sub" height="48" width="48" x="296" y="56" lookAndFeel="classic">
                ...
                <propertyList>
                    ...
                    <property name="action" type="2">
                        <row num="0">
                            <column num="0" name="action">studentmanage.prAlbum.ablumUpload</column>
            ...
            <state color="16777215" id="3" typeName="annotate" height="104" width="191" x="425" y="188" lookAndFeel="classic">
